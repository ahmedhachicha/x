<?php 
   ...
   <?php
                                        ...
                                        <div class="row content">
                                            ...
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                ...
                                                <div class="col-lg-4">';
                                                    ...
                                                    <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="infofurniture.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                    echo </form>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="infofurniture.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        echo '<div class="col-lg-9 col-md-12 col-xs-12">';
                            ...
                            <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infofurniture.php?do=Update&userid=' . $blog . '" >Favorite</a>
                            </span>
    ...
    elseif($do == 'Update'){
        ...
        $check = checkItem('Id', 'classifieds', $userid);
        if($check > 0){
             $stmtmembersactivate = $con->prepare("UPDATE classifieds SET favorite = 1 WHERE Id = ?");
             $stmtmembersactivate->execute(array($userid));
             echo "<div class='alert alert-success'>" . $stmtmembersactivate->rowCount() . ' Record Activate. </div>';
