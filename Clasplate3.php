                                    ...
                                    <div class="row">
                                        <div class="row1 col-lg-4">
                                            <form class="form-horizontal needs-validation" action="?do=Inserted" method="POST" enctype="multipart/form-data" novalidate>
                                                ...
                                                <a href="sharjahplate.php" class="linkfrom">Sharjah plate > Classic car</a>
                                                ...
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="plate3two" name="typenpl" class="forminput form-select-lg" autocomplete="off" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-lg formmarginad"> 
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="Sharjah plate > Classic car" name="categoryy" class="forminput form-select-lg" autocomplete="off" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php echo locate(); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class=" formmargina">
                                                            <div class="radio_content radio_1">
                                                                <img src="layout/images/Sharjah_Classic.png" alt="" style="width: 360px;"><h3 class="live-title"></h3>
                                                            </div>
                                                        </div>
