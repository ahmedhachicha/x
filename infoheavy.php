    ...
    if($do == 'Add'){
                    if(isset($_GET['pageid']) && is_numeric($_GET['pageid'])){
                        $blog = intval($_GET['pageid']);                                 
                                $allItems = getAllFrom("*", "heavyvzhicles", "where Id = {$blog}", "AND Approve = 1", "Id", "");
                                        ...
                                        <div class="row content">
                                            ...
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                ...
                                                <div class="col-lg-4">';
                                                    ...
                                                    <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="infoheavy.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="infoheavy.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        ...
                        <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infoheavy.php?do=Update&userid=' . $blog . '" >Favorite</a>
                        </span>
                                      ...
                                      $i = '';
                                        ...
                                        for($i = 0; $i<$count; ++$i)
                                            {    
                                                ...
                                                <img style="height: 620px;" src="admin/Update_Imageheavry/uploads/avatars/' . $res[$i] .'" class="d-block w-100 " alt="...">
                                                ';
                                                echo wathmark_img();
                                                echo '</div>';
                                            }
                                            ...
                                            <div class="carousel clearfix">
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageheavry/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:165px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageheavry/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view clearfix">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageheavry/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:110px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageheavry/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageheavry/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:140px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageheavry/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                            ...
                            echo '<div class="row content">';
                                echo '<div class="col-lg-2">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> MAKE </p>';   
                                        echo '<div class="itemdiv">' . $item["Make"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                                echo '<div class="col-lg-2">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> MODEL </p>';                    
                                        echo '<div class="itemdiv">' . $item["Model"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                                echo '<div class="col-lg-2">';
                                    echo '<div class="card cardstyl  initial">';
                                ...
                                echo '<div class="card cardstyl  initial">';
                                    ...
                                    echo '<div class="itemdiv">' . $item["warrantyheavy"] . '</div>';                           
                                echo '</div>';
                            echo '</div>';
                            echo '<div class="col-lg-2">';
                            echo '<div class="card cardstyl  initial">';
                ...
                echo '<div class="container d-block d-sm-none">';
                    echo '<div class="row content  divitemover">';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Make </span>';                        
                                echo '<span class="itemsql">' . $item['Make'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Model </span>';                        
                                echo '<span class="itemsql">' . $item['Model'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> KILOMETERS </span>';                        
                                echo '<span class="itemsql">' . $item['k_mi'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Warranty </span>';                        
                                echo '<span class="itemsql">' . $item['warrantyheavy'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Year </span>';                        
                                echo '<span class="itemsql">' . $item['Year'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Body condition </span>';                        
                                echo '<span class="itemsql">' . $item['bodytypeheavy'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Mechanical condition </span>';                       
                                echo '<span class="itemsql">' . $item['mechanicalheavy'] . '</span>';                          
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Seller type </span>';                       
                                echo '<span class="itemsql">' . $item['sellertypeheavy'] . '</span>';                          
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> No. of Cylinders </span>';                       
                                echo '<span class="itemsql">' . $item['cylindersheavy'] . '</span>';                          
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Horsepower </span>';                       
                                echo '<span class="itemsql">' . $item['horsepower'] . '</span>';                          
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Fuel Type </span>';                       
                                echo '<span class="itemsql">' . $item['fueltype'] . '</span>';                          
                            echo '</div>';
                        echo '</div>';                    
                echo '</div>';
                            ...
                            echo '<div class="col-lg-12">';
                                echo '<div class="card  initial">';
                                    echo '<div class="row content">';
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['bodytypeheavy'] . '</div>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Mechanical condition </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['mechanicalheavy'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Seller type </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['sellertypeheavy'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> No. of Cylinders </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['cylindersheavy'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Horsepower </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['horsepower'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Fuel Type </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['fueltype'] . '</div>';                          
                                        echo '</div>';
                                    echo '</div>';
    ...
    elseif($do == 'Update'){
        ...
        if(isset($_SESSION['uid']))
        {
          ...
          $useridd = $infoId['user_id'];
            ...
            $stmtitemadd = $con->prepare("INSERT INTO favorite(iditem, userid, favorite, nameitem) VALUES(:ziditem, :zuserid, 1, 'heavyvzhicles')");
