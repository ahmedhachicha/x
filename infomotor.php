    ...
    if($do == 'Add'){
                    if(isset($_GET['pageid']) && is_numeric($_GET['pageid'])){
                        $blog = intval($_GET['pageid']);                                 
                                $allItems = getAllFrom("*", "motorcycles", "where Id = {$blog}", "AND Approve = 1", "Id", "");
                                        ...
                                        <div class="row content">
                                            ...
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                ...
                                                <div class="col-lg-4">';
                                                    ...
                                                    <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="infomotor.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="infomotor.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        echo '<div class="col-lg-9 col-md-12 col-xs-12">';
                            ...
                            <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infomotor.php?do=Update&userid=' . $blog . '" >Favorite</a>
                            </span>
                                      ...
                                      $i = '';
                                        ...
                                        for($i = 0; $i<$count; ++$i)
                                            {    
                                                ...
                                                <img style="height: 620px;" src="admin/Update_Imagemotor/uploads/avatars/' . $res[$i] .'" class="d-block w-100 " alt="...">
                                                ';
                                                echo wathmark_img();
                                                echo '</div>';
                                            }
                                            ...
                                            <div class="carousel clearfix">
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imagemotor/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:165px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imagemotor/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view clearfix">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imagemotor/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:110px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imagemotor/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imagemotor/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:140px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imagemotor/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                        ...
                        echo '<div class="row content">';
                            echo '<div class="col-lg-2 ">';
                                echo '<div class="card cardstyl  initial">';
                                    ...
                                    echo '<div class="itemdiv">' . $item["usagemotor"] . '</div>';                           
                                echo '</div>';
                            echo '</div>';
                            echo '<div class="col-lg-2 ">';
                                echo '<div class="card cardstyl  initial">';
                            ...
                            echo '<div class="col-lg-2 ">';
                                echo '<div class="card cardstyl  initial">';
                                    ...
                                    echo '<div class="itemdiv">' . $item["warranty"] . '</div>';                           
                                echo '</div>';
                            echo '</div>';
                            echo '<div class="col-lg-2 ">';
                                echo '<div class="card cardstyl  initial">';
                            ...
                            echo '<div class="col-lg-2">';
                                echo '<div class="card cardstyl  initial">';
                                    echo '<p class="stylp"> FINAL DRIVE SYSTEM </p>';
                                    echo '<div class="itemdiv">' . $item["finaldrivesystem"] . '</div>';                           
                                echo '</div>';
                            echo '</div>';
                        echo '</div>';
                    echo '</div>';
                ...
                echo '<div class="container d-block d-sm-none">';
                    echo '<div class="row content  divitemover">';
                            echo '<div class="col-lg-12">';
                                ...
                                echo '<span class="itemsql">' . $item['usagemotor'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                            ...
                            echo '<div class="col-lg-12">';
                                ...
                                echo '<span class="itemsql">' . $item['warranty'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                            ...
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> FINAL DRIVE SYSTEM </span>';                        
                                echo '<span class="itemsql">' . $item['finaldrivesystem'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Wheels </span>';                        
                                echo '<span class="itemsql">' . $item['wheels'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Manufacturer </span>';                       
                                echo '<span class="itemsql">' . $item['manufacturer'] . '</span>';                          
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Seller type </span>';                       
                                echo '<span class="itemsql">' . $item['sellertype'] . '</span>';                          
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Engine Size </span>';                       
                                echo '<span class="itemsql">' . $item['Engine'] . '</span>';                          
                            echo '</div>';
                        echo '</div>';                    
                echo '</div>';
                ...
                echo '<div class="container d-none d-md-block d-lg-none">';
                    echo '<div class="row content  divitemover">';
                                ...
                                echo '</div>';
                                echo '<div class="col-lg-12">';
                                    echo '<span class="itemall"> FINAL DRIVE SYSTEM Final Drive System </span>';                        
                                    echo '<span class="itemsql">' . $item['finaldrivesystem'] . '</span>';                           
                                echo '</div>';
                                echo '<div class="col-lg-12">';
                                    echo '<span class="itemall"> Wheels </span>';                        
                                ...
                                echo '<div class="card  initial">';
                                    echo '<div class="row content">';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemall"> Wheels </div>';                        
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['wheels'] . '</div>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Manufacturer </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['manufacturer'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Seller type </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['sellertype'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Engine Size </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['Engine'] . '</div>';                          
                                        echo '</div>';
                                    echo '</div>';
                                echo '</div>';
                            echo '</div>';
    ...
    elseif($do == 'Update'){
        ...
        if(isset($_SESSION['uid']))
        {
          ...
          $useridd = $infoId['user_id'];
            ...
            $stmtitemadd = $con->prepare("INSERT INTO favorite(iditem, userid, favorite, nameitem) VALUES(:ziditem, :zuserid, 1, 'motorcycles')");
