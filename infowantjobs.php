    ...
    if($do == 'Add'){
                    if(isset($_GET['pageid']) && is_numeric($_GET['pageid'])){
                        $blog = intval($_GET['pageid']);                                 
                                $allItems = getAllFrom("*", "jobs", "where Id = {$blog}", "AND Approve = 1", "Id", "");
                                        ...
                                        <div class="row content">
                                            ...
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                ...
                                                <div class="col-lg-4">';
                                                    ...
                                                    <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="infowantjobs.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="infowantjobs.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        ...
                        <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infowantjobs.php?do=Update&userid=' . $blog . '" >Favorite</a>
                        </span>
                        ...
                        echo '<a href="admin/Update_Image/uploads/avatars/' . $item['file'] .'" download>Click To Download CV</a>';
                        echo '</div>';
                ...
                echo '<div class="row content  divitemover">';
                                    echo '<div class="row content">';
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Current Location </span>';                        
                                            echo '<span class="itemsqll">' . $item['currentlocation'] . '</span>'; 
                                            echo '<hr>';                             
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Current Company </span>';                        
                                            echo '<span class="itemsqll">' . $item['currentcompany'] . '</span>';  
                                            echo '<hr>';                            
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Current Position </span>';                        
                                            echo '<span class="itemsqll">' . $item['currentposition'] . '</span>';  
                                            echo '<hr>';                            
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Notice Period </span>';                        
                                            echo '<span class="itemsqll">' . $item['noticeperiodjobs'] . '</span>';   
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Visa Status </span>';                       
                                            echo '<span class="itemsqll">' . $item['visastatusjobs'] . '</span>'; 
                                            echo '<hr>';                            
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                        ...
                                        echo '<div class="col-lg-12">';
                                            ...
                                            echo '<span class="itemsqll">' . $item['commitmentjobs'] . '</span>';   
                                            echo '<hr>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                            ...
                            echo '<div class="col-lg-12">';
                                echo '<div class="card  initial">';
                                    echo '<div class="row content">';
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Current Location </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['currentlocation'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Current Company </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['currentcompany'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Current Position </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['currentposition'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Notice Period </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['noticeperiodjobs'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Visa Status </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['visastatusjobs'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['commitmentjobs'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
    ...
    elseif($do == 'Update'){
        ...
        if(isset($_SESSION['uid']))
        {
          ...
          $useridd = $infoId['user_id'];
            ...
            $stmtitemadd = $con->prepare("INSERT INTO favorite(iditem, userid, favorite, nameitem) VALUES(:ziditem, :zuserid, 1, 'jobs')");
