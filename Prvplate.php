                                    ...
                                    <div class="row">
                                        <div class="row1 col-lg-4">
                                            <form class="form-horizontal needs-validation" action="?do=Inserted" method="POST" enctype="multipart/form-data" novalidate>
                                                ...
                                                <a href="dubaiplate.php" class="linkfrom">Dubai plate > Private car</a>
                                                <div class="form-group form-group-lg formmarginad"> 
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="plate1" name="category" class="forminput form-select-lg" autocomplete="off" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-lg formmarginad"> 
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="plateone" name="typenpl" class="forminput form-select-lg" autocomplete="off" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-lg formmarginad"> 
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="Dubai plate > Private car" name="categoryy" class="forminput form-select-lg" autocomplete="off" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php echo locate(); ?>
                                                ...
                                                <div class="form-group form-group-lg formmarginad"> 
                                                    <div class="radiocard">
                                                        <label for="ads-yes" class="choix" data-radio="radio_1">
                                                            <input id="ads-yes" type="radio" name="design[]" value="0" checked/>
                                                            <span>Classic Design</span>
                                                        </label> |
                                                        <label for="ads-no" class="choix" data-radio="radio_2">
                                                            <input id="ads-no" type="radio" name="design[]" value="1"/>
                                                        ...
                                                        <div class="content formmargina">
                                                            <div class="radio_content radio_1">
                                                                <img src="layout/images/Dubai.png" alt="" style="width: 360px;"><h3 class="live-title"></h3>
                                                            </div>
                                                            <div class="radio_content radio_2">
                                                                <img src="layout/images/Dubai_New.png" alt="" style="width: 360px;"><h3 class="live-title"></h3>
                                                            </div>
                                                        </div>
