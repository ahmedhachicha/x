<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Other Services online';
    include 'init.php';
?>
            <style>
        ...
        <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
            <div class="container-fluid">
                <div class="row" style="padding-left:15px;">
                                    <center>
                                        <h1 class="h1-pagecat">Buy & sell any Other Services </h1>
                                        <h2 class="div-pagecat"> Other Services on Oh Yamal</h2>                    
                                    </center>
                    <div class="col-lg-2">
                                            ...
                                            <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                ...
                                                <div id="search-content">
                                                            ...
                                                            <div class="widget-dropdown" id="search-content-site">
                                                                <div class="search-dropdown">
                                                                    <select id="site:swfield" name="typecommunity">
                                                                        ...
                                                                        <option value="Other Services" selected>Other Services</option>
                                                        ...
                                                        <input type="hidden" name="is_search" value="1">
                                                            <center><a href='otherserscomlink.php?do=clear'>Clear Input</a></center>  
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="container" style="padding: 10px;">
                                <div class="row">
                                    <div class="col-lg-10">
                                        Browse results in: <a href="allcommunity.php">.. > Community > </a> <strong style="color: #626465;">Other Services</strong>            
                                    </div>
                                    <div class="col-lg-2">
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                                    if($do == 'one'){
                                                        ...
                                                        $start = ($page - 1) * $limit;
                                                        $result1 = $con->prepare("SELECT count(Id) AS Id FROM community where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typecommunity like '%Other Services%' ");
                                                        $result1->execute();
                                                        ...
                                                        $allItems = getAllFrom('*', 'community', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typecommunity like '%Other Services%'", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                    ...
                                                    elseif($do == 'clear'){
                                                        header('Location:otherserscomlink.php');
                                                        exit();                                                
                                                    }     
                                                    // location
                                                    elseif($do == 'searchlocationcars1'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM community where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typecommunity like '%Other Services%' AND locationcars like '%$locatecars%'"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row)
                                    ...
                                    ?>
                                                        <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                            ...
                                                                            Other Services in Ajman</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                            ...
                                                                            Other Services in Dubai</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                            ...
                                                                            Other Services in Abu Dhabi</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                            ...
                                                                            Other Services in Ras al Khaimah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                            ...
                                                                            Other Services in Sharjah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                            ...
                                                                            Other Services in Fujairah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                            ...
                                                                            Other Services in Umm al Quwain</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                            ...
                                                                            Other Services in Al Ain</button>
                                                        </form>
                                </div>  
                            <!-- </div>   -->
                            <!-- </div>   -->
