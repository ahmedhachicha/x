<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Multiple For Sale online';
    include 'init.php';
?>
            ...
            <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                <div class="container-fluid">
                    <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Multiple For Sale </h1>
                                                <h2 class="div-pagecat"> Multiple For Sale on Oh Yamal</h2>                    
                                            </center>
                        <div class="col-lg-2">
                                                ...
                                                <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                    ...
                                                    <div id="search-content">
                                                                ...
                                                                <div class="widget-dropdown" id="search-content-site" style="margin-top: 15px;">
                                                                        ...
                                                                        <div class="widget-dropdown" id="search-content-site" style="margin-top: 15px;">
                                                                            <div class="search-dropdown">
                                                                                <select id="site:swfield" name="zonedfor">
                                                                                <option selected value="Commercial">Zoned for</option>
                                                                                <?php
                                                                        ...
                                                                        <div class="widget-dropdown no-arrow" id="search-content-c1" style="margin-top: 15px;">
                                                                            <div class="search-dropdown">
                                                                                <select id="site:swfield" name="extrasforsale">
                                                                                    <option value="Freehold" selected> Extras For Sale</option>
                                                            ...
                                                            <input type="hidden" name="is_search" value="1">
                                                                <center><a href='landffsale.php?do=clear'>Clear Input</a></center>  
                                        ...
                                        <div class="container">    
                                            <?php
                                                            if($do == 'one'){
                                                                ...
                                                                where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%muluu%'");
                                                                $result1->execute();
                                                                ...
                                                                $allItems = getAllFrom('*', 'forsale', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%muluu%'", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoffmul.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                            ...
                                                            elseif($do == 'orderprice1'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'forsale', 'where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like "%muluu%"', '', "price DESC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoffmul.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                            ...
                                                            elseif($do == 'orderprice2'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'forsale', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%muluu%'", '', "price ASC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoffmul.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                            ...
                                                            elseif($do == 'resultsearch'){
                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                {
                                                                    ...
                                                                    $stmt = $con->prepare("SELECT * FROM forsale where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%muluu%' AND locationcars = '$locatecars' AND (extras like '%$extrasforsale%' OR Location like '%$neighboarhood%'  OR listedby like '%$listedby%' OR zonedfor like '%$zonedfor%' AND (price BETWEEN '$pricegte' AND '$pricelte') OR (size BETWEEN '$sizegte' AND '$sizelte'))");
                                                                            $stmt->execute();
                                                                            $rows = $stmt->fetchAll(); 
                                                                            if(!empty($rows)){
                                                                                foreach($rows as $row)
                                                            ...
                                                            elseif($do == 'clear'){
                                                                header('Location:landffsale.php');
                                                                exit();                                                
                                                            }     
                                                            // location
                                                            elseif($do == 'searchlocationcars1'){
                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                {
                                                                    ...
                                                                    $stmt = $con->prepare("SELECT * FROM forsale where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%muluu%' AND locationcars like '%$locatecars%'"); 
                                                                    $stmt->execute();
                                                                    $rows = $stmt->fetchAll(); 
                                                                    if(!empty($rows)){
                                                                        foreach($rows as $row)
                                                            ...
                                                            elseif($do == 'searchlocationcars2'){
                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                {
                                                                    ...
                                                                    if(!empty($rows)){
                                                                        foreach($rows as $row)
                                                                        {                                           
                                                                            echo '<a href="infoffmul.php?pageid=' . $row["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><a href="infoffmul.php?pageid=' . $row["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                                                    echo '<div class="row">';
                                                                                        // echo '<div class="col-lg-2">Featured</div>';
                                                                                        // echo '<div class="col-lg-10">History Check</div>';
