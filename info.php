    ...
    if($do == 'Add'){
                                    ...
                                    <div class="container">
                                        <div class="row content">
                                            ...
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                ...
                                                <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="info.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="info.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container">';
                    echo '<div class="row">';
                        echo '<div class="col-lg-9 col-md-12 col-xs-12">';
                            ...
                            <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="info.php?do=Update&userid=' . $blog . '" >Favorite</a>
                            </span>
                                    ...
                                    <?php    $i = '';
                                        ...
                                        for($i = 0; $i<$count; ++$i)
                                            {    
                                                ...
                                                <img style="height: 620px;" src="admin/Update_Image/uploads/avatars/' . $res[$i] .'" class="d-block w-100 " alt="...">';
                                                echo wathmark_img();
                                                echo '</div>';
                                            }
                                        ?>          
                                            ...
                                            <div class="carousel clearfix">
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Image/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:165px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Image/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view clearfix">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Image/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:110px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Image/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Image/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:140px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Image/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                        ...
                        echo '<div class="col-lg-3 col-md-12 col-xs-12">';
                            ...
                            echo '<div class="modal fade" id="exampleModall" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                $infoo = $gettype->fetch();
                                $type = $infoo['FullName'];
                                echo '<div class="lighaloo">';
                                    echo '<p color="#4294ff">Copy This userName:</p>';
                                echo '</div>';
                                    ?>
                                    <button onclick="myFunctionchat()" class="btncopy">Copy Name Chat</button> 
                                    <button class="divaplll btn" style="background-color: red; cursor:pointer;"><a href="userss.php"><input type="text" value="<?php echo $type; ?>" id="myInputchat"></a></button><?php
                                    echo '<div class="lighalo">';
                                        echo '<p color="#4294ff" class="sc-1q498l3-0 sc-1q498l3-1 gsCoQc eoIXmr sc-62uu82-7 iBUXHx">Tips for a safer transaction:</p>';
                                        echo '<ul style="list-style: none;">';
                                        echo '<li>';
                            ...
                            echo '<div class="row content">';
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> HISTORY CHECK </p>';   
                                        echo '<img src="layout/images/car-history-check-icon.svg" alt="" class="imgoverview">';                             
                                    echo '</div>';
                                echo '</div>';
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> TRIM </p>';   
                                        echo '<img src="layout/images/Trim.png" alt="" class="imgoverview">';  
                                        echo '<div class="itemdiv">' . $item["trime"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> KILOMETERS </p>';                    
                                        echo '<img src="layout/images/Km.png" alt="" class="imgoverview">';     
                                        echo '<div class="itemdiv">' . $item["k_mi"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        ...
                                        echo '<div class="itemdiv">' . $item["warrantycars"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> COLOR </p>';    
                                        echo '<img src="layout/images/Color.png" alt="" class="imgoverview">';        
                                        echo '<div class="itemdiv">' . $item["Exteriorcolor"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                                echo '<div class="col-lg-2">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> YEAR </p>';
                                        echo '<img src="layout/images/Calendar.png" alt="" class="imgoverview">';
                                        echo '<div class="itemdiv">' . $item["Year"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                            echo '</div>';
                        echo '</div>';
                ...
                echo '<div class="row content  divitemover">';
                                    echo '<div class="row content">';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Make & Model </span>';                       
                                            echo '<span class="itemsqll">' . $item['Make'] . ' ' . $item['Model'] . '</span>';  
                                            echo '<hr>';   
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Trim </span>';                        
                                            echo '<span class="itemsqll">' . $item['trime'] . '</span>';
                                            echo '<hr>';                         
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> KILOMETERS </span>';                        
                                            echo '<span class="itemsqll">' . $item['k_mi'] . '</span>';  
                                            echo '<hr>';                            
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Warranty </span>';                        
                                            echo '<span class="itemsqll">' . $item['warrantycars'] . '</span>'; 
                                            echo '<hr>';                             
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Color </span>';                        
                                            echo '<span class="itemsqll">' . $item['Exteriorcolor'] . '</span>';  
                                            echo '<hr>';                            
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Year </span>';                        
                                            echo '<span class="itemsqll">' . $item['Year'] . '</span>';  
                                            echo '<hr>';                            
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Doors </span>';                        
                                            echo '<span class="itemsqll">' . $item['doors'] . '</span>';   
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Body condition </span>';                       
                                            echo '<span class="itemsqll">' . $item['bodycars'] . '</span>'; 
                                            echo '<hr>';                            
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<span class="itemalll"> Mechanical condition </span>';                       
                                            echo '<span class="itemsqll">' . $item['mechanicalcars'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<span class="itemalll"> Body Type </span>';                       
                                            echo '<span class="itemsqll">' . $item['bodytypecars'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> No. of Cylinders </span>';                       
                                            echo '<span class="itemsqll">' . $item['cylinders'] . '</span>';   
                                            echo '<hr>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Transmission Type </span>';                       
                                            echo '<span class="itemsql">' . $item['transmissiontype'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Regional Specs </span>';                       
                                            echo '<span class="itemsqll">' . $item['regionalspec'] . '</span>';   
                                            echo '<hr>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Horsepower </span>';                       
                                            echo '<span class="itemsqll">' . $item['horsepowercars'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Fuel Type </span>';                       
                                            echo '<span class="itemsqll">' . $item['fueltypecars'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Steering Side </span>';                       
                                            echo '<span class="itemsqll">' . $item['side'] . '</span>';    
                                            echo '<hr>';                         
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Insured </span>';                       
                                            echo '<span class="itemsqll">' . $item['insured'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Extras </span>';                       
                                            echo '<span class="itemsqll">' . $item['extrascars'] . '</span>';  
                                            echo '<hr>';   
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Extras </span>';                       
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Status </span>';                       
                                            echo '<span class="itemsqll">' . $item['Status'] . '</span>';    
                                            echo '<hr>'; 
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Car For </span>';                       
                                            echo '<span class="itemsqll">' . $item['typecars'] . '</span>'; 
                                        echo '</div>';
                                    echo '</div>';
                echo '</div>'; 
                echo '</div>';
                ...
                echo '<div class="row content  divitemover">';
                                    echo '<div class="row content">';
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<span class="itemalll"> For </span>';                       
                                            echo '<span class="itemsqll">' . $item['typecars'] . '</span>'; 
                                        echo '</div>';
                                    echo '</div>';
                echo '</div>'; 
                        ...
                        echo '<div class="row content">';
                            echo '<div class="col-lg-12">';
                                echo '<div class="card  initial">';
                                    echo '<div class="row content">';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemall"> Make & Model </div>';                        
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['Make'] . ' ' . $item['Model'] . '</div>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemall"> Trim </div>';                        
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['trime'] . '</div>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemall"> Doors </div>';                        
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['doors'] . '</div>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Body condition </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['bodycars'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Mechanical condition </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['mechanicalcars'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Body Type </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['bodytypecars'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> No. of Cylinders </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['cylinders'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Transmission Type </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['transmissiontype'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Regional Specs </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['regionalspec'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Horsepower </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['horsepowercars'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Fuel Type </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['fueltypecars'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Steering Side </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['side'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Insured </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['insured'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Extras </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['extrascars'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Status </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['Status'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> For </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['typecars'] . '</div>';                          
                                        echo '</div>';
                                    echo '</div>';
    ...
    elseif($do == 'Update'){
        ...
        if(isset($_SESSION['uid']))
        {
          ...
          $useridd = $infoId['user_id'];
            ...
            $stmtitemadd = $con->prepare("INSERT INTO favorite(iditem, userid, favorite, nameitem) VALUES(:ziditem, :zuserid, 1, 'products')");
