<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Used Cars For Sale online ';
    include 'init.php';
?>
            ...
            <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                <div class="container-fluid">
                    <div class="row" style="padding-left:15px;">
                            <center>
                                <h1 class="h1-pagecat">Buy & sell any Used Cars For Sale </h1>
                                <h2 class="div-pagecat"> Used Cars For Sale on Oh Yamal</h2>                    
                            </center>
                                ...
                                <div class="container" style="padding: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                        <?php if(empty(countItemscars('make', 'products', '%Audi%'))){
                                                        }
                                                        else{?>
                                                                <div class="col-lg-4">
                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Audi" name="searchmakecars1">Audi <span style="color: black;">(<?php echo countItemscars('make', 'products', '%Audi%'); ?>)</span> </button></a>
                                                                    </form>
                                                                </div>
                                                            <?php } ?>                                            

                                                <?php if(empty(countItemscars('make', 'products', '%Hummer%'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Hummer" name="searchmakecars1">Hummer<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Hummer%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                        <?php } ?>                                                     
                                                <?php if(empty(countItemscars('make', 'products', 'Maserati'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Maserati" name="searchmakecars1">Maserati<span style="color: black;">(<?php echo countItemscars('make', 'products', 'Maserati'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                        <?php } ?>  
                                                <?php if(empty(countItemscars('make', 'products', '%BMW%'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="BMW" name="searchmakecars1">BMW<span style="color: black;">(<?php echo countItemscars('make', 'products', '%BMW%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                        <?php } ?> 
                                                <?php if(empty(countItemscars('make', 'products', '%Hyunai%'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Hyunai" name="searchmakecars1">Hyunai<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Hyunai%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                        <?php } ?>   
                                                <?php if(empty(countItemscars('make', 'products', '%Mazda%'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Mazda" name="searchmakecars1">Mazda<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Mazda%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                        <?php } ?>
                                                <?php if(empty(countItemscars('make', 'products', '%Cadillac%'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Cadillac" name="searchmakecars1">Cadillac<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Cadillac%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                        <?php } ?>  
                                                <?php if(empty(countItemscars('make', 'products', '%Infiniti%'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Infiniti" name="searchmakecars1">Infiniti<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Infiniti%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                        <?php } ?>
                                                <?php if(empty(countItemscars('make', 'products', '%Mercedes-Benz%'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Mercedes-Benz" name="searchmakecars1">Mercedes-Benz<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Mercedes-Benz%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                        <?php } ?> 
                                                <?php if(empty(countItemscars('make', 'products', '%Chevrolet%'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Chevrolet" name="searchmakecars1">Chevrolet<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Chevrolet%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                        <?php } ?>

                                                <?php if(empty(countItemscars('make', 'products', '%Isuzu%'))){}
                                                    else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Isuzu" name="searchmakecars1">Isuzu<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Isuzu%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                    <?php } ?>
                                                <?php if(empty(countItemscars('make', 'products', '%Mitsubishi%'))){}
                                                    else{?> 
                                                            <div class="col-lg-4">
                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Mitsubishi" name="searchmakecars1">Mitsubishi<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Mitsubishi%'); ?>)</span> </button></a>
                                                                </form>
                                                            </div>
                                                <?php } ?>
                                                            <div class="container">
                                                                ...
                                                                <div class="row panel-bodyy pplll">
                                                                        <?php if(empty(countItemscars('make', 'products', '%Brilliance%'))){}
                                                                            else{?> 
                                                                                    <div class="col-lg-4">
                                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Brilliance" name="searchmakecars1">Brilliance<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Brilliance%'); ?>)</span> </button></a>
                                                                                        </form>
                                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Acura%'))){}
                                                                            else{?> 
                                                                                    <div class="col-lg-4">
                                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Acura" name="searchmakecars1">Acura<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Acura%'); ?>)</span> </button></a>
                                                                                        </form>
                                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Alfa Romeo%'))){}
                                                                            else{?> 
                                                                                    <div class="col-lg-4">
                                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Alfa Romeo" name="searchmakecars1">Alfa Romeo<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Alfa Romeo%'); ?>)</span> </button></a>
                                                                                        </form>
                                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Aston Martin%'))){}
                                                                            else{?> 
                                                                                    <div class="col-lg-4">
                                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Aston Martin" name="searchmakecars1">Aston Martin<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Aston Martin%'); ?>)</span> </button></a>
                                                                                        </form>
                                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Chrysler%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Chrysler" name="searchmakecars1">Chrysler<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Chrysler%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Jaguar%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Jaguar" name="searchmakecars1">Jaguar<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Jaguar%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Nissan%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Nissan" name="searchmakecars1">Nissan<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Nissan%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Daihatsu%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Daihatsu" name="searchmakecars1">Daihatsu<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Daihatsu%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Jeep%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Jeep" name="searchmakecars1">Jeep<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Jeep%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Peugeot%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Peugeot" name="searchmakecars1">Peugeot<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Peugeot%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Dogge%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Dogge" name="searchmakecars1">Dogge<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Dogge%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%kia%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Kia" name="searchmakecars1">Kia<span style="color: black;">(<?php echo countItemscars('make', 'products', '%kia%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Ford%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Ford" name="searchmakecars1">Ford<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Ford%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Prosche%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Prosche" name="searchmakecars1">Prosche<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Prosche%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Land Rover%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Land Rover" name="searchmakecars1">Land Rover<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Land Rover%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Renault%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Renault" name="searchmakecars1">Renault<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Renault%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%GMC%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="GMC" name="searchmakecars1">GMC<span style="color: black;">(<?php echo countItemscars('make', 'products', '%GMC%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Lexus%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Lexus" name="searchmakecars1">Lexus<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Lexus%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Toyota%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Toyota" name="searchmakecars1">Toyota<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Toyota%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Genesis%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Genesis" name="searchmakecars1">Genesis<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Genesis%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Mini%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="MINI" name="searchmakecars1">MINI<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Mini%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Volkswagen%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Volkswagen" name="searchmakecars1">Volkswagen<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Volkswagen%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                            <?php if(empty(countItemscars('make', 'products', '%Honda%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Honda" name="searchmakecars1">Honda<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Honda%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%BAC%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="BAC" name="searchmakecars1">BAC<span style="color: black;">(<?php echo countItemscars('make', 'products', '%BAC%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%BAIC%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="BAIC" name="searchmakecars1">BAIC<span style="color: black;">(<?php echo countItemscars('make', 'products', '%BAIC%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%BYD%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="BYD" name="searchmakecars1">BYD<span style="color: black;">(<?php echo countItemscars('make', 'products', '%BYD%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Bentley%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Bentley" name="searchmakecars1">Bentley<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Bentley%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Bizzarrini%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Bizzarrini" name="searchmakecars1">Bizzarrini<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Bizzarrini%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Borgward%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Borgward" name="searchmakecars1">Borgward<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Borgward%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Bugatti%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Bugatti" name="searchmakecars1">Bugatti<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Bugatti%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Buick%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Buick" name="searchmakecars1">Buick<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Buick%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%CMC%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="CMC" name="searchmakecars1">CMC<span style="color: black;">(<?php echo countItemscars('make', 'products', '%CMC%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Caterham%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Caterham" name="searchmakecars1">Caterham<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Caterham%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Changan%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Changan" name="searchmakecars1">Changan<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Changan%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Chery%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Chery" name="searchmakecars1">Chery<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Chery%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Citroen%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Citroen" name="searchmakecars1">Citroen<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Citroen%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%DFSK%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="DFSK" name="searchmakecars1">DFSK<span style="color: black;">(<?php echo countItemscars('make', 'products', '%DFSK%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <?php if(empty(countItemscars('make', 'products', '%Daewoo%'))){}
                                                                        else{?> 
                                                                                <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Daewoo" name="searchmakecars1">Daewoo<span style="color: black;">(<?php echo countItemscars('make', 'products', '%Daewoo%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                        <?php } ?>
                                                                </div>   
                                ...
                                <div class="container">    
                                    <?php
                                                    if($do == 'one'){
                                                        ...
                                                        where  Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND typecars = 'For Sale' ");
                                                        $result1->execute();
                                                        ...
                                                        $allItems = getAllFrom('*', 'products', "where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typecars = 'For Sale' ", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                        foreach($allItems as $item)
                                                        {                                           
                                                            echo '<a href="info.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                    ...
                                                    if($do == 'orderprice1'){
                                                        ...
                                                        $allItems = getAllFrom('*', 'products', "where  Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND typecars = 'For Sale'   ", '', " Price DESC", "LIMIT 20");
                                                        foreach($allItems as $item)
                                                        {                                           
                                                            echo '<a href="info.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-4 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                                    echo '<div class="row">';
                                                                        // echo '<div class="col-lg-2">Featured</div>';
                                                                        // echo '<div class="col-lg-10">History Check</div>';
                                                    ...
                                                    if($do == 'orderprice2'){
                                                        ...
                                                        $allItems = getAllFrom('*', 'products', "where  Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND typecars = 'For Sale'   ", '', " Price ASC", "LIMIT 20");
                                                        foreach($allItems as $item)
                                                        {                                           
                                                            echo '<a href="info.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-4 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                    ...
                                                    elseif($do == 'search'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $pricegte = $_POST['pricegte'];
                                                            $pricelte = $_POST['pricelte'];
                                                            $stmt = $con->prepare("SELECT * FROM products where (Name like '%$all%'  AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1) OR ( Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locatecars = '$locatecars' AND (make like '%$make%') AND ((Price BETWEEN '$pricegte' AND '$pricelte') OR (k_mi  BETWEEN '$kilometersgte' AND '$kilometerslte') OR (Year BETWEEN '$yeargte' AND '$yearlte') OR (Location like '%$all%') OR (bodytypecars like '%$all%') OR (doors like '%$all%') OR (cylinders like '%$all%') OR (extrascars like '%$all%') OR (horsepowercars like '%$all%') OR (Exteriorcolor like '%$Exteriorcolor%') OR (transmissiontype like '%$all%') OR (warrantycars like '%$all%') OR (fueltypecars like '%$all%') OR (regionalspec like '%$all%') OR (side like '%$all%'))) order by Id DESC");
                                                                    $stmt->execute();
                                                                    $rows = $stmt->fetchAll(); 
                                                                    if(!empty($rows)){
                                                                        foreach($rows as $row){
                                                    ...
                                                    elseif($do == 'searchlocationcars1'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM products where  Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND typecars = 'For Sale' AND   locatecars like '%$locatecars%'"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row){
                                                    ...
                                                    elseif($do == 'searchmakecars1'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM products where  Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND typecars = 'For Sale'   AND   make like '%$make%'"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row){
