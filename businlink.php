<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Business & Industrial online';
    include 'init.php';
?>
    ...
    <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
        <div class="container-fluid">
            <div class="row" style="padding-left:15px;">
                                <center>
                                    <h1 class="h1-pagecat">Buy & sell any Business & Industrial </h1>
                                    <h2 class="div-pagecat"> Business & Industrial on Oh Yamal</h2>                    
                                </center>
                <div class="col-lg-2">
                                        ...
                                        <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                            ...
                                            <div id="search-content">
                                                    ...
                                                    <input type="hidden" name="is_search" value="1">
                                                        <center><a href='businlink.php?do=clear'>Clear Input</a></center>  
                    ...
                    $sortt ='';
                            ...
                            <div class="card">
                                <div class="container" style="padding: 10px;">
                                    <div class="row">
                                        <div class="col-lg-10">
                                            Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Business & Industrial</strong>            
                                        </div>
                                        <div class="col-lg-2">
                                                <span class="toggle-info pull-right">
                                            ...
                                            <div class="row">
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Constructionn%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Constructionn" name="searchmakecars1">Construction<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Constructionn%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Foodd%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Foodd" name="searchmakecars1">Food & Beverage<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Foodd%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%suplbus%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="suplbus" name="searchmakecars1">Industrial Supplies<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%suplbus%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%officee%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-8">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="officee" name="searchmakecars1">Office Furniture & Equipment<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%officee%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%manbuclass%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="manbuclass" name="searchmakecars1">Manufacturing<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%manbuclass%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%eqbuclass%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="eqbuclass" name="searchmakecars1">Electrical Equipment<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%eqbuclass%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%retailbuclass%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="retailbuclass" name="searchmakecars1">Retail & Services<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%retailbuclass%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%heabuclass%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="heabuclass" name="searchmakecars1">Healthcare & Lab<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%heabuclass%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%copyy%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-8">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="copyy" name="searchmakecars1">Commercial Printing & Copy Machines<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%copyy%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%packingg%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="packingg" name="searchmakecars1">Packing & Shipping<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%packingg%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%agribuclass%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="agribuclass" name="searchmakecars1">Agriculture & Forestry<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%agribuclass%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%otherbuclass%');
                                                            if($var != 0){
                                                                ?> <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="otherbuclass" name="searchmakecars1">Other<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%otherbuclass%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                ...
                                <div class="container">    
                                    <?php
                                                    if($do == 'one'){
                                                        ...
                                                        where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%Businessess%' OR typeclassifieds like '%Constructionn%'  OR typeclassifieds like '%Foodd%' OR typeclassifieds like '%suplbus%' OR typeclassifieds like '%officee%' OR typeclassifieds like '%manbuclass%' OR typeclassifieds like '%eqbuclass%' OR typeclassifieds like '%retailbuclass%' OR typeclassifieds like '%heabuclass%' OR typeclassifieds like '%copyy%' OR typeclassifieds like '%packingg%' OR typeclassifieds like '%agribuclass%' OR typeclassifieds like '%otherbuclass%')");
                                                        $result1->execute();
                                                    ...
                                                    elseif($do == 'orderprice1'){
                                                        ...
                                                        $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND (typeclassifieds like '%Businessess%' OR typeclassifieds like '%Constructionn%'  OR typeclassifieds like '%Foodd%' OR typeclassifieds like '%suplbus%' OR typeclassifieds like '%officee%' OR typeclassifieds like '%manbuclass%' OR typeclassifieds like '%eqbuclass%' OR typeclassifieds like '%retailbuclass%' OR typeclassifieds like '%heabuclass%' OR typeclassifieds like '%copyy%' OR typeclassifieds like '%packingg%' OR typeclassifieds like '%agribuclass%' OR typeclassifieds like '%otherbuclass%')", '', "price DESC", "LIMIT 20");
                                                        foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                    ...
                                                    elseif($do == 'orderprice2'){
                                                        ...
                                                        $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%Businessess%' OR typeclassifieds like '%Constructionn%'  OR typeclassifieds like '%Foodd%' OR typeclassifieds like '%suplbus%' OR typeclassifieds like '%officee%' OR typeclassifieds like '%manbuclass%' OR typeclassifieds like '%eqbuclass%' OR typeclassifieds like '%retailbuclass%' OR typeclassifieds like '%heabuclass%' OR typeclassifieds like '%copyy%' OR typeclassifieds like '%packingg%' OR typeclassifieds like '%agribuclass%' OR typeclassifieds like '%otherbuclass%')", '', "price ASC", "LIMIT 20");
                                                        foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                    ...
                                                    elseif($do == 'resultsearch'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $typeclassifieds = $_POST['typeclassifieds'];
                                                                    ...
                                                                    $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds = '$typeclassifieds' AND locationcars = '$locatecars'  AND ((price BETWEEN '$pricegte' AND '$pricelte') OR location like '%$neighboarhood%' OR conditionclassifieds like '%$conditionclassifieds%' OR usageclassifieds like '%$usageclassifieds%')");
                                                    ...
                                                    elseif($do == 'searchlocationcars1'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%Businessess%' OR typeclassifieds like '%Constructionn%'  OR typeclassifieds like '%Foodd%' OR typeclassifieds like '%suplbus%' OR typeclassifieds like '%officee%' OR typeclassifieds like '%manbuclass%' OR typeclassifieds like '%eqbuclass%' OR typeclassifieds like '%retailbuclass%' OR typeclassifieds like '%heabuclass%' OR typeclassifieds like '%copyy%' OR typeclassifieds like '%packingg%' OR typeclassifieds like '%agribuclass%' OR typeclassifieds like '%otherbuclass%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-4 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                            echo '<div class="row">';
                                                                                // echo '<div class="col-lg-2">Featured</div>';
                                                                                // echo '<div class="col-lg-10">History Check</div>';
                                    ...
                                    ?>
                                                        <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                            ...
                                                                            Business & Industrial in Ajman</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                            ...
                                                                            Business & Industrial in Dubai</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                            ...
                                                                            Business & Industrial in Abu Dhabi</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                            ...
                                                                            Business & Industrial in Ras al Khaimah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                            ...
                                                                            Business & Industrial in Sharjah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                            ...
                                                                            Business & Industrial in Fujairah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                            ...
                                                                            Business & Industrial in Umm al Quwain</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                            ...
                                                                            Business & Industrial in Al Ain</button>
                                                        </form>
                                </div>  
                            </div>  
                </div>
    ...
    <div class="d-none d-md-block d-lg-none">
        <div class="container-fluid">
            <div class="row" style="padding-left:15px;">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <button style="background: none;
                                        border: none;" class="flame-button flame-button--tertiary flame-button--medium btnshar" data-bs-toggle="modal" data-bs-target="#exampleModalll1"><span class="price-taggg" style="cursor:pointer;">
                                        <ion-icon name="search-outline" class="searchbtn"></ion-icon>Search
                                        </span></button>
                                </div>
                                <?php
                                echo '<div class="modal fade" id="exampleModalll1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
