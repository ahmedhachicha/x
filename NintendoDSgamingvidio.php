                                    ...
                                    <div class="row">
                                        <div class="row1 col-lg-4">
                                            <form class="form-horizontal needs-validation" action="?do=Inserted" method="POST" enctype="multipart/form-data" novalidate>
                                                ...
                                                <a href="VideoGames.php" class="linkfrom">Video Games > Nintendo DS</a>
                                                ...
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="Nintendo DS gamingtwo" name="typeclassifieds" class="forminput form-select-lg" autocomplete="off" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-lg formmarginad"> 
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="Video Games > Nintendo DS" name="categoryy" class="forminput form-select-lg" autocomplete="off" required="required" placeholder="Model Of The cars">
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php echo locate(); ?>
                                                ...
                                                <div class="row">
                                                        <div class="col-lg-6 col-md-8 col-sm-12 col-xs-2">
                                                        <textarea class=" form input_contact" name="description" rows="4" cols="38" required="required" placeholder="Describe your game or accessory"></textarea>
                                                        <div class="invalid-feedback" style="text-align: initial;">
                                                            This field is required.
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row ">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                        <select class="form-select forminput" aria-label="Default select example" name="rating" required >
                                                            <option value="">rating</option>
                                                            <?php
                                                                $allUsers = getAllFrom("*", "rating", "", "", "Id");
                                                                foreach($allUsers as $user){
                                                                    echo "<option value='" . $user['Id'] . "'>" .$user['Name'] . "</option>";
                                                                }
                                                            ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Action, Adventure" id="a0" name="cars[]">
                                                        <label class="form-check-label" for="a0">
                                                        Action, Adventure
                                                            </label></div>
                                                        </div>
                                                        <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Music" id="a1" name="cars[]">
                                                        <label class="form-check-label" for="a1">
                                                        Music
                                                            </label></div>
                                                        </div>
                                                        <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Platformer" id="a2" name="cars[]">
                                                        <label class="form-check-label" for="a2">
                                                        Platformer
                                                        </label></div>
                                                        </div>
                                                        <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Puzzles, Brain Games" id="a3" name="cars[]">
                                                        <label class="form-check-label" for="a3">
                                                        Puzzles, Brain Games
                                                        </label></div>
                                                        </div>
                                                        <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Racing" id="a4" name="cars[]">
                                                        <label class="form-check-label" for="a4">
                                                        Racing
                                                        </label></div>
                                                        </div>
                                                        <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Role Playing" id="a5" name="cars[]">
                                                        <label class="form-check-label" for="a5">
                                                        Role Playing
                                                        </label></div>
                                                        </div>
                                                        <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Shooter" id="a6" name="cars[]">
                                                        <label class="form-check-label" for="a6">
                                                        Shooter
                                                        </label></div>
                                                       </div>
                                                       <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Simulation" id="a7" name="cars[]">
                                                        <label class="form-check-label" for="a7">
                                                        Simulation
                                                        </label></div>
                                                        </div>
                                                        <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Sports" id="a8" name="cars[]">
                                                        <label class="form-check-label" for="a8">
                                                        Sports
                                                        </label></div>
                                                        </div>
                                                        <div class="col-lg-6"><div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Strategy" id="a9" name="cars[]">
        ...
        elseif($do == 'Inserted'){
            ...
            <?php echo Safetyfirst(); ?> 
                                            ...
                                            <?php
                                                                    ...
                                                                    <?php
                                                                            $rating = $_POST['rating'];
                                                                            $getrating = $con->prepare("SELECT * FROM rating WHERE Id = $rating");
                                                                            $getrating->execute();
                                                                            $info = $getrating->fetch();
                                                                            $namerating = $info['Name'];
                                                                            ?>    
                                                                    <input id="title" type="hidden" name="rating" class="form-control form-select-lg" autocomplete="off" value="<?php echo $namerating ?>" />
                    ...
                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                    {
                        ...
                        $categoryy     = $_POST['categoryy'];
                                    $stmtitemadd = $con->prepare("INSERT INTO
                                                            classifieds(Name, locationcars, categoryy, categories, rating, usageclassifieds, conditionclassifieds, ageclassifieds, date, Image, user_Id, phone, price, typeclassifieds, description, location, extrasclassifieds, Approve)
                                                            VALUES(:zname, :zlocationcars, :zcategoryy, :zcategory, :zrating, :zusageclassifieds, :zconditionclassifieds, :zageclassifieds, now(), :zimage, :zuser, :zphone, :zprice, :zclassifieds, :zdescription, :zlocation, :zextrascars ,1)");
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch)); 
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [ 
                                "redirectUrl" =>  "https://ohyamal.com/MicrosoftXboxgamingvidio.php?do=Insertfin1"
                            ],
                            ];
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch)); 
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [ 
                                "redirectUrl" =>  "https://ohyamal.com/MicrosoftXboxgamingvidio.php?do=Insertfin2"
                            ],
                            ];
                            $outlet = "c7e71431-bdf4-49d0-a984-fd2ecd0267c3";
                            $json = json_encode($postData);
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch)); 
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [ 
                                "redirectUrl" =>  "https://ohyamal.com/MicrosoftXboxgamingvidio.php?do=Insertfin3"
                            ],
                            ];
                            $outlet = "c7e71431-bdf4-49d0-a984-fd2ecd0267c3";
                            $json = json_encode($postData);
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch)); 
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [ 
                                "redirectUrl" =>  "https://ohyamal.com/MicrosoftXboxgamingvidio.php?do=Insertfin4"
                            ],
                            ];
                            $outlet = "c7e71431-bdf4-49d0-a984-fd2ecd0267c3";
                            $json = json_encode($postData);
