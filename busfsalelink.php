<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Businesses for Sale online';
    include 'init.php';
?>
            <style>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    ...
                    <center>
                                            <h1 class="h1-pagecat">Buy & sell any Businesses for Sale </h1>
                                            <h2 class="div-pagecat"> Businesses for Sale on Oh Yamal</h2>                    
                                        </center>
                        <div class="col-lg-2">
                                                ...
                                                <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                    ...
                                                    <div id="search-content">
                                                            ...
                                                            <input type="hidden" name="is_search" value="1">
                                                                <center><a href='busfsalelink.php?do=clear'>Clear Input</a></center>  
                            ...
                            $sortt ='';
                                    ...
                                    <div class="card">
                                        <div class="container" style="padding: 10px;">
                                            <div class="row">
                                                <div class="col-lg-10">
                                                    Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Businesses for Sale</strong>            
                                                </div>
                                                <div class="col-lg-2">
                                                        <span class="toggle-info pull-right">
                                        ...
                                        <div class="container">    
                                            <?php
                                                            if($do == 'one'){
                                                                ...
                                                                where Approve = 1 AND typeclassifieds like '%Businessess%'");
                                                                $result1->execute();
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND typeclassifieds like '%Businessess%'", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                            ...
                                                            elseif($do == 'orderprice1'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND typeclassifieds like '%Businessess%'", '', "price DESC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                            ...
                                                            elseif($do == 'orderprice2'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND typeclassifieds like '%Businessess%'", '', "price ASC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                                ...
                                                                                {                                           
                                                                                    echo '<a href="infoclasselec.php?pageid=' . $row["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                                            ...
                                                                                            echo '</div>';
                                                                                            echo '<div class="row">';
                                                                                                echo '<div class="col-lg-10 col-md-10 col-sm-12 col-xs-120">';
                                                            ...
                                                            elseif($do == 'clear'){
                                                                header('Location:busfsalelink.php');
                                                                exit();                                                
                                                            }     
                                                            // location
                                                            elseif($do == 'searchlocationcars1'){
                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                {
                                                                    ...
                                                                    $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND typeclassifieds like '%Businessess%' AND locationcars like '%$locatecars%' order by Id DESC");
                                                                    $stmt->execute();
                                                                    $rows = $stmt->fetchAll(); 
                                                                    if(!empty($rows)){
                                                                        foreach($rows as $row)
                                            ...
                                            ?>
                                                                                    ...
                                                                                    Businesses for Sale in UAE</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                                    ...
                                                                                    Businesses for Sale in Dubai</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                    ...
                                                                                    Businesses for Sale in Abu Dhabi</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                    ...
                                                                                    Businesses for Sale in Ras al Khaimah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                    ...
                                                                                    Businesses for Sale in Sharjah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                    ...
                                                                                    Businesses for Sale in Fujairah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                    ...
                                                                                    Businesses for Sale in Umm al Quwain</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                    ...
                                                                                    Businesses for Sale in Al Ain</button>
                                                                </form>
                                        </div>  
                                    </div>  
                        </div>
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                                echo '<div class="row">';
                                                                                    // echo '<div class="col-lg-2">Featured</div>';
                                                                                    // echo '<div class="col-lg-10">History Check</div>';
        ...
        <footer class="site-footer">
                ...
                <div class="row content">
                    ...
                    <ul class="footer-links">
                        ...
                        <span>We are recognized for exceeding client expectations and delivering great results through dedication, ease of process, and extraordinary services to our worldwide clients.</span>
                        </div>
                        </li>
                        <div class="row">
                        <ul class="social-icons">
                            <li><div class="col-lg-2 col-md-3 col-sm-6 col-xs-12"><a class="afott" href="#"><ion-icon name="logo-twitter"></ion-icon></a></div></li>
                            <li><div class="col-lg-2 col-md-3 col-sm-6 col-xs-12"><a class="afott" href="#"><ion-icon name="logo-facebook"></ion-icon></a></div></li>
                            <li><div class="col-lg-2 col-md-3 col-sm-6 col-xs-12"><a class="afott"href="#"><ion-icon name="logo-instagram"></ion-icon></a></div></li>
                            <li><div class="col-lg-2 col-md-3 col-sm-6 col-xs-12"><a class="afott"href="#"><ion-icon name="logo-linkedin"></ion-icon></a></div></li>
                            <li><div class="col-lg-2 col-md-3 col-sm-6 col-xs-12"><a class="afott" href="#"><ion-icon name="logo-whatsapp"></ion-icon></a></div></li>
                        </ul>
                        </div>
                    ...
                    <ul class="footer-links">
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Home</a></li>
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">About</a></li>
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Features</a></li>
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Pricing</a></li>
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Faqs</a></li>
                    </ul>
                    </div>
                    ...
                    <ul class="footer-links">
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Motors</a></li>
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Property For Rent</a></li>
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Property For Sale</a></li>
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Mobiles & Tablets</a></li>
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Home Appliances</a></li>
                    </ul>
                    </div>
                    ...
                    <h5>Support</h5>
                        ...
                        <ul class="footer-links">
                        <li style="margin-bottom: 10px;"><a class="afott" href="#">Help</a></li>
                        <li style="margin-bottom: 10px;"><a class="afott" href="contact.php">Contact Us</a></li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    ...
                    <p class="copyright-text" style="text-align: center;">&copy; <?php echo date("Y"); ?> Company, Inc. All Rights Reserved.</p>
                    </div>
                </div>
                </div>
        </footer>          
