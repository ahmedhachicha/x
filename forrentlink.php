<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Residential for Rent online';
    include 'init.php';
?>
    ...
    <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
        <div class="container-fluid">
            <div class="row" style="padding-left:15px;">
                                <center>
                                    <h1 class="h1-pagecat">Buy & sell any Residential For Rent </h1>
                                    <h2 class="div-pagecat"> Residential For Rent on Oh Yamal</h2>                    
                                </center>
                <div class="col-lg-2">
                                        ...
                                        <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                            ...
                                            <div id="search-content">
                                                        <div class="widget-dropdown" id="search-content-site">
                                                            ...
                                                            <select id="site:swfield" name="locationcars">
                                                                ...
                                                                <div class="widget-dropdown no-arrow" id="search-content-c1">
                                                                    <div class="search-dropdown">
                                                                        <select id="site:swfield" name="categoryy">
                                                                            <option value="Residential Units for Rent" selected>Residential Units for Rent</option>
                                                                            <option value="Commercial for Rent">Commercial for Rent</option>
                                                                            <option value="Rooms for rent (flatmates)">Rooms for rent (flatmates)</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <input type="hidden" name="is_search" value="1">
                                                        <center><a href='forrentlink.php?do=clear'>Clear Input</a></center>  
                    ...
                    $sortt ='';
                            ...
                            <div class="card">
                                <div class="container" style="padding: 10px;">
                                    <div class="row">
                                                <div class="col-lg-10">
                                                    Browse results in: <a href="forrentlink.php">.. > Residential For Rent > </a> <strong style="color: #626465;">Properties For Rent</strong>            
                                                </div>
                                                <div class="col-lg-2">
                                                        <span class="toggle-info pull-right">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        <?php if(empty(countItemsmotforsale('categoryy', 'forrent', '%Residential Units for Rent%'))){}
                                                        
                                                        else{?>
                                                            <div class="col-lg-4">
                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Residential Units for Rent" name="searchmakecars1">Residential Units for Rent <span style="color: black;">(<?php echo countItemsmotforsale('categoryy', 'forrent', '%Residential Units for Rent%'); ?>)</span> </button></a>
                                                                </form>
                                                            </div>
                                                    <?php } ?>

                                                        <?php if(empty(countItemsmotforsale('categoryy', 'forrent', '%Commercial for Rent%'))){}
                                                        
                                                        else{?>
                                                            <div class="col-lg-4">
                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Commercial for Rent" name="searchmakecars1">Commercial for Rent<span style="color: black;">(<?php echo countItemsmotforsale('categoryy', 'forrent', '%Commercial for Rent%'); ?>)</span> </button></a>
                                                                </form>
                                                            </div>
                                                    <?php } ?>

                                                        <?php if(empty(countItemsmotforsale('categoryy', 'forrent', '%Rooms for rent (flatmates)%'))){}
                                                        
                                                        else{?>
                                                            <div class="col-lg-4">
                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Rooms for rent (flatmates)" name="searchmakecars1">Townhouse<span style="color: black;">(<?php echo countItemsmotforsale('categoryy', 'forrent', '%Rooms for rent (flatmates)%'); ?>)</span> </button></a>
                                                                </form>
                                                            </div>
                                                    <?php } ?>
                                                            </div>    
                                ...
                                <div class="container">    
                                    <?php
                                                    if($do == 'one'){
                                                        ...
                                                        $start = ($page - 1) * $limit;
                                                        $result1 = $con->prepare("SELECT count(Id) AS Id FROM forrent
                                                        where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)");
                                                        $result1->execute();
                                                        ...
                                                        $allItems = getAllFrom('*', 'forrent', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                        foreach($allItems as $item)
                                                        {                                           
                                                            echo '<a href="infoforrent.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E; margin-right: 15px;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                                    ...
                                                                    echo '<div class="row">';
                                                                        echo '<div class="col-lg-4">';
                                                                            ...
                                                                            for($i = 0; $i<$count; ++$i)
                                                                            {
                                                                                echo  "<img class='card-img-top imgindexcard' src='admin/Update_Imageforrent/uploads/avatars/" . $res[$i] ."' alt='image' />";
                                                    ...
                                                    elseif($do == 'orderprice1'){
                                                        ...
                                                        $allItems = getAllFrom('*', 'forrent', 'where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)', '', "price DESC", "LIMIT 20");
                                                        foreach($allItems as $item)
                                                        {                                           
                                                            echo '<a href="infoforrent.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E; margin-right: 15px;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                    ...
                                                    elseif($do == 'orderprice2'){
                                                        ...
                                                        $allItems = getAllFrom('*', 'forrent', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)", '', "price ASC", "LIMIT 20");
                                                        foreach($allItems as $item)
                                                        {                                           
                                                            echo '<a href="infoforrent.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E; margin-right: 15px;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                    ...
                                                    elseif($do == 'resultsearch'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM forrent where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars'  AND categoryy like '%$categoryy%' AND (location like '%$neighboarhood%' OR beds like '%$beds%' OR listedby like '%$listedby%' OR baths like '%$baths%' OR (price BETWEEN '$pricegte' AND '$pricelte') OR (size BETWEEN '$sizegte' AND '$sizelte'))");
                                                                    $stmt->execute();
                                                                    $rows = $stmt->fetchAll(); 
                                                                    if(!empty($rows)){
                                                                        foreach($rows as $row)
                                                                        {                                           
                                                                            echo '<a href="infoforrent.php?pageid=' . $row["Id"] .'" style="text-decoration: none; color:#2B2D2E; margin-right: 15px;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                                                    echo '<div class="row">';
                                                                                        // echo '<div class="col-lg-2">Featured</div>';
                                                                                        // echo '<div class="col-lg-10">History Check</div>';
                                                    ...
                                                    elseif($do == 'search'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            if($categories == "Residential Units for Rent")
                                                            {
                                                                $stmt = $con->prepare("SELECT * FROM forrent where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND  locationcars = '$locatecars' AND categoryy like '%Residential Units for Rent%' AND ( location like '%$all%' OR beds like '%$all%' OR listedby like '%$all%' OR baths like '%$all%' OR (price BETWEEN '$all' AND '$all') OR (size BETWEEN '$all' AND '$all'))) order by Id DESC");
                                                                    $stmt->execute();
                                                                    $rows = $stmt->fetchAll(); 
                                                                    if(!empty($rows)){
                                                                        foreach($rows as $row)
                                                            ...
                                                            elseif($categories == "Commercial for Rent"){
                                                                $stmt = $con->prepare("SELECT * FROM forrent where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND  locationcars = '$locatecars' AND categoryy like '%Commercial for Rent%' AND ( location like '%$all%' OR beds like '%$all%' OR listedby like '%$all%' OR baths like '%$all%' OR (price BETWEEN '$all' AND '$all') OR (size BETWEEN '$all' AND '$all'))) order by Id DESC");
                                                                $stmt->execute();
                                                                $rows = $stmt->fetchAll(); 
                                                                if(!empty($rows)){
                                                                    foreach($rows as $row)
                                                            ...
                                                            elseif($categories == "Rooms for rent (flatmates)"){
                                                                $stmt = $con->prepare("SELECT * FROM forrent where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND  locationcars = '$locatecars' AND categoryy like '%Rooms for rent (flatmates)%' AND ( location like '%$all%' OR beds like '%$all%' OR listedby like '%$all%' OR baths like '%$all%' OR (price BETWEEN '$all' AND '$all') OR (size BETWEEN '$all' AND '$all'))) order by Id DESC");
                                                                $stmt->execute();
                                                                $rows = $stmt->fetchAll(); 
                                                                if(!empty($rows)){
                                                                    foreach($rows as $row)
                                                                    {                                           
                                                                        echo '<a href="infoffland.php?pageid=' . $row["Id"] .'" style="text-decoration: none; color:#2B2D2E; margin-right: 15px;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                                echo '<div class="row">';
                                                                                    // echo '<div class="col-lg-2">Featured</div>';
                                                                                    // echo '<div class="col-lg-10">History Check</div>';
                                                    ...
                                                    elseif($do == 'clear'){
                                                        header('Location:forrentlink.php');
                                                        exit();                                                
                                                    }     
                                                    // location
                                                    elseif($do == 'searchlocationcars1'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM forrent where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars like '%$locatecars%'"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row)
                                                    ...
                                                    elseif($do == 'searchmakecars1'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM forrent where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND categoryy like '%$make%'"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row)
                                    ...
                                    ?>
                                                        ...
                                                        <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                            ...
                                                                            Properties for Rent in Ajman</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                            ...
                                                                            Properties for Rent in Dubai</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                            ...
                                                                            Properties for Rent in Abu Dhabi</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                            ...
                                                                            Properties for Rent in Ras al Khaimah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                            ...
                                                                            Properties for Rent in Sharjah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                            ...
                                                                            Properties for Rent in Fujairah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                            ...
                                                                            Properties for Rent in Umm al Quwain</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                            ...
                                                                            Properties for Rent in Al Ain</button>
                                                        </form>
                                </div>  
                            </div>  
                </div>
                                                                ...
                                                                <div class="fields">
                                                                    <div class="range-fields">
                                                                        <label class="heading">
                                                                            ...
                                                                            <div class="range-fields-inputs" style="padding-right: 15px;">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><input class="text-field-small" id="price_gte:swfield" name="sizegte" placeholder="Min" title="Min" type="text"></div>
                                                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><input class="text-field-small alt" id="price_gte:swfield" name="sizelte" placeholder="Max" title="Max" type="text"></div>
                                                                                </div>
                                                                            </div>
                                                                    </div>
                                                                </div>
