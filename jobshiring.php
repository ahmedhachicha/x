                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any All Jobs Hiring</h1>
                                                <h2 class="div-pagecat"> All Jobs Hiring on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        ...
                                                                        <select id="site:swfield" name="locatecars">
                                                                                    <?php
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                        <select id="site:swfield" name="typejobshiring">
                                                                    ...
                                                                    <option value="Legal Service">Legal Services</option>
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site" style="margin-top: 15px;">
                                                                            ...
                                                                            <div class="widget-dropdown" id="search-content-site">
                                                                                <div class="search-dropdown">
                                                                                    <select id="site:swfield" name="employmenttype">
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='jobshiring.php?do=clear'>Clear Input</a></center>  
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    $start = ($page - 1) * $limit;
                                                                    $result1 = $con->prepare("SELECT count(Id) AS Id FROM jobshiring
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'jobshiring', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)", '', "Id DESC", "LIMIT {$start},{$limit} ");
                                                                    foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infohiringjobs.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                ...
                                                                elseif($do == 'resultsearch'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $employmenttype = $_POST['employmenttype'];
                                                                                ...
                                                                                $stmt = $con->prepare("SELECT * FROM jobshiring where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typejobshiring like '%$typejobshiring%' AND locatecars = '$locatecars' AND (salaryexpectationjobs like '%$salaryexpectationjobs%' OR workexperiencejobs like '%$workexperiencejobs%' OR educationleveljobs like '%$educationleveljobs%' OR employmenttype like '%$employmenttype%')");
                                                                                $stmt->execute();
                                                                                $rows = $stmt->fetchAll(); 
                                                                                if(!empty($rows)){
                                                                                    foreach($rows as $row)
                                                                                {                                           
                                                                                    echo '<a href="infohiringjobs.php?pageid=' . $row["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                                            echo '<div class="row">';
                                                                                                // echo '<div class="col-lg-2">Featured</div>';
                                                                                                // echo '<div class="col-lg-10">History Check</div>';
                                                                ...
                                                                elseif($do == 'clear'){
                                                                    header('Location:jobshiring.php');
                                                                    exit();                                                
                                                                }     
                                                                // location
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM jobshiring where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locatecars like '%$locatecars%'");
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
