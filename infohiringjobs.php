    ...
    if($do == 'Add'){
                    if(isset($_GET['pageid']) && is_numeric($_GET['pageid'])){
                        $blog = intval($_GET['pageid']);                                 
                                $allItems = getAllFrom("*", "jobshiring", "where Id = {$blog}", "AND Approve = 1", "Id", "");
                                        ...
                                        <div class="row content">
                                            ...
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                <div class="row content">';
                                                    ...
                                                    <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="infohiringjobs.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="infohiringjobs.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container productdiv">';
                    echo '<div class="row content">';
                        echo '<div class="col-lg-10">';
                            ...
                            echo '<p class="datepostd">' . $item['categoryy'] .'</p>';
                        echo '</div>';    
                        echo '<div class="col-lg-2">';
                        echo '</div>'; 
                    echo '</div>';
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        ...
                        <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infohiringjobs.php?do=Update&userid=' . $blog . '" >Favorite</a>
                        </span>
                ...
                echo '<div class="row content  divitemover">';
                                    echo '<div class="row content">';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Gender </span>';                        
                                            echo '<span class="itemsqll">' . $item['genderjobs'] . '</span>';
                                            echo '<hr>';                         
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Nationality </span>';                        
                                            echo '<span class="itemsqll">' . $item['nationality'] . '</span>';  
                                            echo '<hr>';                            
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Career Level </span>';                       
                                            echo '<span class="itemsqll">' . $item['careerleveljobs'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Salary Expectations </span>';                       
                                            echo '<span class="itemsqll">' . $item['salaryexpectationjobs'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Work experience </span>';                       
                                            echo '<span class="itemsqll">' . $item['workexperiencejobs'] . '</span>';   
                                            echo '<hr>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Education level </span>';                       
                                            echo '<span class="itemsql">' . $item['educationleveljobs'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Commitment </span>';                       
                                            echo '<span class="itemsqll">' . $item['employmenttype'] . '</span>';   
                                            echo '<hr>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> you like to work in </span>';                       
                                            echo '<span class="itemsqll">' . $item['Location'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                        echo '<span class="itemalll"> Listed By </span>';                       
                                        echo '<span class="itemsqll">' . $item['listedbyhiring'] . '</span>';   
                                        echo '<hr>';                          
                                    echo '</div>';
                                    if($item['extrahidecompanyname'] != '-Null'){
                                                                            echo '<div class="col-lg-12">';
                                    echo '<span class="itemalll"> Company Name </span>';                       
                                    echo '<span class="itemsqll">' . $item['companyname'] . '</span>';   
                                    echo '<hr>';                          
                                echo '</div>';
                                    }
                                echo '<div class="col-lg-12">';
                                echo '<span class="itemalll"> CV Requierd </span>';                       
                                echo '<span class="itemsqll">' . $item['cvrequierd'] . '</span>';   
                                echo '<hr>';                          
                            echo '</div>';
                                    echo '<div class="col-lg-12">';
                                        echo '<span class="itemalll"> Company Size </span>';                       
                                        echo '<span class="itemsqll">' . $item['companysize'] . '</span>';  
                                        echo '<hr>';                           
                                    echo '</div>';
                                    echo '<div class="col-lg-12">';
                                    echo '<span class="itemalll"> Skill 1 </span>';                       
                                    echo '<span class="itemsqll">' . $item['skillone'] . '</span>';   
                                    echo '<hr>';                          
                                echo '</div>';
                                echo '<div class="col-lg-12">';
                                echo '<span class="itemalll"> Skill 2 </span>';                       
                                echo '<span class="itemsqll">' . $item['skilltwo'] . '</span>';   
                                echo '<hr>';                          
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                            echo '<span class="itemalll"> Skill 3 </span>';                       
                            echo '<span class="itemsqll">' . $item['skilltree'] . '</span>';   
                            echo '<hr>';                          
                        echo '</div>';
                        echo '<div class="col-lg-12">';
                        echo '<span class="itemalll"> Skill 4 </span>';                       
                        echo '<span class="itemsqll">' . $item['skillfoor'] . '</span>';   
                        echo '<hr>';                          
                    echo '</div>';
                    if($item['extralanguage'] != '-Null'){
                                            echo '<div class="col-lg-12">';
                    echo '<span class="itemalll"> Language </span>';                       
                    echo '<span class="itemsqll">' . $item['extralanguage'] . '</span>';   
                    echo '<hr>';                          
                echo '</div>';
                    }
                    if($item['extrabenefits'] != '-Null'){
                        echo '<div class="col-lg-12">';
echo '<span class="itemalll"> Benefits
</span>';                       
echo '<span class="itemsqll">' . $item['extrabenefits'] . '</span>';   
echo '<hr>';                          
echo '</div>';
}
if($item['extraremovejobs'] != '-Null'){
    echo '<div class="col-lg-12">';
echo '<span class="itemalll"> Remote Job
</span>';                       
echo '<span class="itemsqll">' . $item['extraremovejobs'] . '</span>';   
echo '<hr>';                          
echo '</div>';
}
if($item['extraremovejobs'] == '-Null'){
...
echo '<span class="itemsqll">Not a remote job</span>';   
echo '<hr>';                          
echo '</div>';
}
                                    echo '</div>';
                ...
                echo '<div class="row content  divitemover">';
                                    echo '<div class="row content">';
                                        ...
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Salary Expectations </span>';                       
                                            echo '<span class="itemsql">' . $item['salaryexpectationjobs'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Work experience </span>';                       
                                        ...
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Education Level </span>';                       
                                            echo '<span class="itemsqll">' . $item['educationleveljobs'] . '</span>';  
                                            echo '<hr>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Commitment </span>';                       
    ...
    echo '</div>';
        ...
        if($item['extrabenefits'] != '-Null'){
    echo '<div class="col-lg-12">';
    echo '<span class="itemalll"> Benefits </span>';                       
    echo '<span class="itemsqll">' . $item['extrabenefits'] . '</span>';    
    echo '<hr>';                         
echo '</div>';
        }
        if($item['extraremovejobs'] != '-Null'){
echo '<div class="col-lg-12">';
echo '<span class="itemalll"> Remote Job </span>';                       
echo '<span class="itemsqll">' . $item['extraremovejobs'] . '</span>';    
echo '<hr>';                         
echo '</div>';
    }
                                ...
                                echo '<div class="card  initial">';
                                    echo '<div class="row content">';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemall"> Gender </div>';                        
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['genderjobs'] . '</div>';                           
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Nationality </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['nationality'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Career Level </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['careerleveljobs'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Salary Expectations </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['salaryexpectationjobs'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Work experience </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['workexperiencejobs'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Education Level </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['educationleveljobs'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Commitment </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['employmenttype'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> you like to work in </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['Location'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Listed By  </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['listedbyhiring'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> CV Requierd </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['cvrequierd'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Company Name </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['companyname'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Company Size </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['companysize'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Skill 1 </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['skillone'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Skill 2 </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['skilltwo'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Skill 3 </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['skilltree'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Skill 4 </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['skillfoor'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Language </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['extralanguage'] . '</div>';                          
                                        echo '</div>';
                                        if($item['extrabenefits'] != '-Null'){
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Benefits </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['extrabenefits'] . '</div>';                          
                                        echo '</div>';
                                        }
                                        if($item['extraremovejobs'] != '-Null'){
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Remote Job </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['extraremovejobs'] . '</div>';                          
                                        echo '</div>';
                                        }
                                        if($item['extraremovejobs'] == '-Null'){
                                        echo '<div class="col-lg-6">';
    ...
    elseif($do == 'Update'){
        ...
        if(isset($_SESSION['uid']))
        {
          ...
          $useridd = $infoId['user_id'];
            ...
            $stmtitemadd = $con->prepare("INSERT INTO favorite(iditem, userid, favorite, nameitem) VALUES(:ziditem, :zuserid, 1, 'jobshiring')");
