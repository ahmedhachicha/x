<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any All Community online';
    include 'init.php';
?>
            <style>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Community </h1>
                                                <h2 class="div-pagecat"> Community on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                            <select id="site:swfield" name="typecommunity">
                                                                                ...
                                                                                <option value="homincom" selected>Home Maintenance</option>
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='allcommunity.php?do=clear'>Clear Input</a></center>  
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                    <div class="container" style="padding: 10px;">
                                        <div class="row">
                                            <div class="col-lg-10">
                                                Browse results in: <a href="allcommunity.php">.. > </a> <strong style="color: #626465;">Community</strong>            
                                            </div>
                                            <div class="col-lg-2">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php $var = countItemscomminity('typecommunity', 'community', '%healthiom%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                                                <div class="col-lg-4">
                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="healthiom" name="searchmakecars1">Health & Wellbeing<span style="color: black;">(<?php echo countItemscomminity('typecommunity', 'community', '%healthiom%'); ?>)</span> </button></a>
                                                        </form>
                                                    </div>
                                                                    <?php }
                                                                    ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <?php
                                                            if($do == 'one'){
                                                                ...
                                                                $start = ($page - 1) * $limit;
                                                                $result1 = $con->prepare("SELECT count(Id) AS Id FROM community where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typecommunity like '%auto%' OR typecommunity like '%conserv%' OR typecommunity like '%domcl%' OR typecommunity like '%evencat%' OR typecommunity like '%freelancers%' OR typecommunity like '%Other Services%' OR typecommunity like '%webgracom%' OR typecommunity like '%healthcom%' OR typecommunity like '%homincom%' OR typecommunity like '%movlscom%' OR typecommunity like '%tutorscom%' OR typecommunity like '%eltrcom%')");
                                                                $result1->execute();
                                                                ...
                                                                $allItems = getAllFrom('*', 'community', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typecommunity like '%auto%' OR typecommunity like '%conserv%' OR typecommunity like '%domcl%' OR typecommunity like '%evencat%' OR typecommunity like '%freelancers%' OR typecommunity like '%Other Services%' OR typecommunity like '%webgracom%' OR typecommunity like '%healthcom%' OR typecommunity like '%homincom%' OR typecommunity like '%movlscom%' OR typecommunity like '%tutorscom%' OR typecommunity like '%eltrcom%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                            ...
                                                            elseif($do =='search') {
                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                {
                                                                    ...
                                                                    if($categories == "Auto Services")
                                                                    {
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%auto%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Consultancy Services"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%conserv%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Domestic"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%domcl%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Event & Entertainment"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%evencat%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Freelancers"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%freelancers%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Health & Wellbeing Services"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%healthcom%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Home Maintenance"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%homincom%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Movers & Removals"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%movlscom%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Other Services"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%Other Services%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Restoration & Repairs"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%eltrcom%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Tutors & Classes"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%tutorscom%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                                    ...
                                                                    elseif($categories == "Web & Computer Services"){
                                                                        $stmt = $con->prepare("SELECT * FROM community where (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR ((Approve = 1) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars like '%$locatecars%') AND (typecommunity like '%webgracom%')) order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                            ...
                                                            elseif($do == 'clear'){
                                                                header('Location:allcommunity.php');
                                                                exit();                                                
                                                            }     
                                                            // location
                                                            elseif($do == 'searchlocationcars1'){
                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                {
                                                                    ...
                                                                    $stmt = $con->prepare("SELECT * FROM community where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typecommunity like '%auto%' OR typecommunity like '%conserv%' OR typecommunity like '%domcl%' OR typecommunity like '%evencat%' OR typecommunity like '%freelancers%' OR typecommunity like '%Other Services%' OR typecommunity like '%webgracom%' OR typecommunity like '%healthcom%' OR typecommunity like '%homincom%' OR typecommunity like '%movlscom%' OR typecommunity like '%tutorscom%' OR typecommunity like '%eltrcom%') AND locationcars like '%$locatecars%'"); 
                                                                    $stmt->execute();
                                                                    $rows = $stmt->fetchAll(); 
                                                                    if(!empty($rows)){
                                                                        foreach($rows as $row)
                                            ...
                                            ?>
                                                                ...
                                                                <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                    ...
                                                                                    All Community in Abu Dhabi</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                    ...
                                                                                    UAll Community in Ras al Khaimah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                    ...
                                                                                    All Community in Sharjah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                    ...
                                                                                    All Community in Fujairah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                    ...
                                                                                    All Community in Umm al Quwain</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                    ...
                                                                                    All Community in Al Ain</button>
                                                                </form>
                                        </div>  
                                    <!-- </div>   -->
                                    <!-- </div>  
