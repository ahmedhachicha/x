<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Cameras & Imaging online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                            <center>
                                <h1 class="h1-pagecat"> Buy & sell any Cameras & Imaging </h1>
                                <h2 class="div-pagecat"> Cameras & Imaging on Oh Yamal </h2>                    
                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                            <select id="site:swfield" name="typeclassifieds">
                                                                                <option value="mdcass" selected>Digital Cameras</option>
                                                                                <option value="lensefcass">Lenses, Filters & Lighting</option>
                                                                                <option value="audprcass">Professional Equipment</option>
                                                                                <option value="cmercass">Camera Accessories</option>
                                                                                <option value="tripcass">Tripods & Stands</option>
                                                                                <option value="camrsca">Camcorders</option>
                                                                                <option value="filmclss">Film Cameras</option>
                                                                                <option value="bintclss">Binoculars/Telescopes</option>
                                                                                <option value="camodlss">Camcorder Accessories</option>
                                                                                <option value="cmeslss">Camera Drones</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='cameralink.php?do=clear'>Clear Input</a></center>  
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Cameras & Imaging</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                            <span class="toggle-info pull-right">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%mdcass%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="mdcass" name="searchmakecars1">Digital Cameras<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%mdcass%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%lensefcass%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="lensefcass" name="searchmakecars1">Lenses, Filters & Lighting<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%lensefcass%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%audprcass%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="audprcass" name="searchmakecars1">Professional Equipment<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%audprcass%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%cmercass%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="cmercass" name="searchmakecars1">Camera Accessories<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%cmercass%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%tripcass%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="tripcass" name="searchmakecars1">Tripods & Stands<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%tripcass%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%camrsca%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="camrsca" name="searchmakecars1">Monitors, Printers & Other Peripherals<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%camrsca%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%filmclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="filmclss" name="searchmakecars1">Film Cameras<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%filmclss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%bintclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="bintclss" name="searchmakecars1">Binoculars/Telescopes<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%bintclss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%camodlss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="camodlss" name="searchmakecars1">Camcorder Accessories<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%camodlss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%cmeslss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="cmeslss" name="searchmakecars1">Camera Drones<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%cmeslss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%mdcass%' OR typeclassifieds like '%lensefcass%'  OR typeclassifieds like '%audprcass%' OR typeclassifieds like '%cmercass%' OR typeclassifieds like '%tripcass%' OR typeclassifieds like '%camrsca%' OR typeclassifieds like '%filmclss%' OR typeclassifieds like '%bintclss%' OR typeclassifieds like '%camodlss%' OR typeclassifieds like '%cmeslss%')");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%mdcass%' OR typeclassifieds like '%lensefcass%'  OR typeclassifieds like '%audprcass%' OR typeclassifieds like '%cmercass%' OR typeclassifieds like '%tripcass%' OR typeclassifieds like '%camrsca%' OR typeclassifieds like '%filmclss%' OR typeclassifieds like '%bintclss%' OR typeclassifieds like '%camodlss%' OR typeclassifieds like '%cmeslss%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%mdcass%' OR typeclassifieds like '%lensefcass%'  OR typeclassifieds like '%audprcass%' OR typeclassifieds like '%cmercass%' OR typeclassifieds like '%tripcass%' OR typeclassifieds like '%camrsca%' OR typeclassifieds like '%filmclss%' OR typeclassifieds like '%bintclss%' OR typeclassifieds like '%camodlss%' OR typeclassifieds like '%cmeslss%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%mdcass%' OR typeclassifieds like '%lensefcass%'  OR typeclassifieds like '%audprcass%' OR typeclassifieds like '%cmercass%' OR typeclassifieds like '%tripcass%' OR typeclassifieds like '%camrsca%' OR typeclassifieds like '%filmclss%' OR typeclassifieds like '%bintclss%' OR typeclassifieds like '%camodlss%' OR typeclassifieds like '%cmeslss%')", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
...
foreach($rows as $row)
                                                                ...
                                                                elseif($do == 'clear'){
                                                                    header('Location:cameralink.php');
                                                                    exit();                                                
                                                                }     
                                                                // location
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%mdcass%' OR typeclassifieds like '%lensefcass%'  OR typeclassifieds like '%audprcass%' OR typeclassifieds like '%cmercass%' OR typeclassifieds like '%tripcass%' OR typeclassifieds like '%camrsca%' OR typeclassifieds like '%filmclss%' OR typeclassifieds like '%bintclss%' OR typeclassifieds like '%camodlss%' OR typeclassifieds like '%cmeslss%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                                        ...
                                                                                        Cameras & Imaging in Ajman</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                                        ...
                                                                                        Cameras & Imaging in Dubai</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        Cameras & Imaging in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Cameras & Imaging in Ras al Khaimah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                        ...
                                                                                        Cameras & Imaging in Sharjah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        Cameras & Imaging in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        Cameras & Imaging in Umm al Quwain</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                        ...
                                                                                        Cameras & Imaging in Al Ain</button>
                                                                    </form>
                                            </div>  
                                        </div>  
                            </div>
