<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any All Furniture, Home & Garden online';
    include 'init.php';
?>
            <style>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any All Furniture, Home & Garden </h1>
                                                <h2 class="div-pagecat"> All Furniture, Home & Garden on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='allfurngar.php?do=clear'>Clear Input</a></center>  
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allfurngar.php">.. > classifieds </a> <strong style="color: #626465;"> > Furniture, Home & Garden</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                            <span class="toggle-info pull-right">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <?php if(empty(countItemsclassifieds('typeclassifieds', 'classifieds', '%furclss%'))){} 
                                                                else{?>
                                                                    <div class="col-lg-4">
                                                            ...
                                                            <?php if(empty(countItemsclassifieds('typeclassifieds', 'classifieds', '%homefurb%'))){} 
                                                                else{?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                            ...
                                                            <?php if(empty(countItemsclassifieds('typeclassifieds', 'classifieds', '%grdnfur%'))){} 
                                                                else{?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                            ...
                                                            <?php if(empty(countItemsclassifieds('typeclassifieds', 'classifieds', '%lightfur%'))){} 
                                                                else{?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                            ...
                                                            <?php if(empty(countItemsclassifieds('typeclassifieds', 'classifieds', '%absrtfur%'))){} 
                                                                else{?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                            ...
                                                            <?php if(empty(countItemsclassifieds('typeclassifieds', 'classifieds', '%currfur%'))){} 
                                                                else{?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                            ...
                                                            <?php if(empty(countItemsclassifieds('typeclassifieds', 'classifieds', '%tolsffur%'))){} 
                                                                else{?>
                                                                    <div class="col-lg-12">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%furclss%' OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%')");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%furclss%' OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                        ...
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                                ...
                                                                                echo '<div class="row">';
                                                                                    ...
                                                                                    echo '</div>';
                                                                                        echo '<div class="col-lg-2 col-md-12 col-sm-12 col-xs-12" style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                                                            </div>';
                                                                                echo '</div>';
                                                                            echo '</div>';
                                                                            echo '<hr>';
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%furclss%' OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%furclss%' OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%')", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                    ...
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $all = $_POST['all'];
                                                                            ...
                                                                            if($categories == "Furniture"){   
                                                                                ...
                                                                                where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND (typeclassifieds like '%furclss%') order by Id DESC");
                                                                            ...
                                                                            elseif($categories == "Home Accessories"){
                                                                                                                                                                                                                                  $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                                                                                                                                                                  where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND (typeclassifieds like '%homefurb%') order by Id DESC");
                                                                            ...
                                                                            elseif($categories == "Garden & Outdoor"){
                                                                                                                                                   // OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%'     
                                                                                                                                                   $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                                                                                   where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND (typeclassifieds like '%grdnfur%') order by Id DESC");
                                                                            ...
                                                                            elseif($categories == "Lighting & Fans"){
                                                                                                                                                                                                                                   // OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%'     
                                                                                                                                                                                                                                   $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                                                                                                                                                                   where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND (typeclassifieds like '%lightfur%') order by Id DESC");
                                                                            ...
                                                                            elseif($categories == "Rugs & Carpets"){
                                                                                                                                                                                                                                   // OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%'     
                                                                                                                                                                                                                                   $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                                                                                                                                                                   where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND (typeclassifieds like '%absrtfur%') order by Id DESC");
                                                                            ...
                                                                            elseif($categories == "Curtains & Blinds"){
                                                                                                                                                                                                                                   // OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%'     
                                                                                $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND (typeclassifieds like '%currfur%') order by Id DESC");
                                                                            ...
                                                                            elseif($categories == "Tools & Home Improvement"){
                                                                                                                                                                                                                                   // OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%'     
                                                                                $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND (typeclassifieds like '%tolsffur%') order by Id DESC");
                                                                ...
                                                                elseif($do == 'clear'){
                                                                    header('Location:allfurngar.php');
                                                                    exit();                                                
                                                                }     
                                                                // location
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%furclss%' OR typeclassifieds like '%homefurb%' OR typeclassifieds like '%grdnfur%' OR typeclassifieds like '%lightfur%' OR typeclassifieds like '%absrtfur%' OR typeclassifieds like '%currfur%' OR typeclassifieds like '%tolsffur%') AND locationcars like '%$locatecars%' order by Id DESC");
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                                        ...
                                                                                        All Furniture, Home & Garden in Ajman</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                                        ...
                                                                                        All Furniture, Home & Garden in Dubai</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        All Furniture, Home & Garden in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        All Furniture, Home & Garden in Ras al Khaimah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                        ...
                                                                                        All Furniture, Home & Garden in Sharjah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        All Furniture, Home & Garden in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        All Furniture, Home & Garden in Umm al Quwain</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                        ...
                                                                                        All Furniture, Home & Garden in Al Ain</button>
                                                                    </form>
                                            </div>  
                                        </div>  
                            </div>
