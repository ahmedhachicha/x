    ...
    if(isset($_SESSION['user']))
    {
                                    ...
                                    <div class="row">
                                        <div class="row1 col-lg-4">
                                            <form class="form-horizontal needs-validation" action="?do=Inserted" method="POST" enctype="multipart/form-data" novalidate>
                                                ...
                                                <a href="ResidentialforSale.php" class="linkfrom">Residential for Sale > Apartment for Sale</a>
                                                ...
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="Property For sale > Residential for Sale > Apartment for Sale" name="categoryy" class="forminput form-select-lg" autocomplete="off" required="required" placeholder="Model Of The cars">
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php echo locate(); ?>
                                                ...
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="Apartment for Sale reden" name="typeforsale" class="forminput form-select-lg" autocomplete="off" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-lg formmarginad">
                            ...
                            echo '<div class="col-lg-3"> <div class="card divcard">';
                                ...
                                ?>
                                    ...
                                    <?php
                                        ...
                                        $_SESSION['totalclosing']      = $_POST['totalclosing'];
                                        $_SESSION['readyby']      = $_POST['readyby'];
                                        $_SESSION['annualfee'] = $_POST['annualfee'];
                                        $_SESSION['propertyreference'] = $_POST['propertyreference'];
                                        $_SESSION['buyerfee']   = $_POST['buyerfee'];
                                        $_SESSION['sellerfee']   = $_POST['sellerfee'];
                                        $_SESSION['maintenancefee']   = $_POST['maintenancefee'];
                                        $_SESSION['typeforsale']     = $_POST['typeforsale'];
                                        $_SESSION['occupancystatus']       = $_POST['occupancystatus'];
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch));
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [
                                "redirectUrl" =>  "https://ohyamal.com/ApartmentforSale.php?do=Insertfin1"
                            ],
                            ];
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch));
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [
                                "redirectUrl" =>  "https://ohyamal.com/ApartmentforSale.php?do=Insertfin2"
                            ],
                            ];
                            $outlet = "c3cce49c-9824-4fc3-b237-f03f3c9c449f";
                            $json = json_encode($postData);
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch));
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [
                                "redirectUrl" =>  "https://ohyamal.com/ApartmentforSale.php?do=Insertfin3"
                            ],
                            ];
                            $outlet = "c3cce49c-9824-4fc3-b237-f03f3c9c449f";
                            $json = json_encode($postData);
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch));
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [
                                "redirectUrl" =>  "https://ohyamal.com/ApartmentforSale.php?do=Insertfin4"
                            ],
                            ];
                            $outlet = "c3cce49c-9824-4fc3-b237-f03f3c9c449f";
                            $json = json_encode($postData);
        ...
        elseif($do == 'Insertfin1'){
            ...
            'zuser'     => $_SESSION['uid']
                ...
                'ztypeforsale'=> $_SESSION['typeforsale'],
                'zlocation'=>    $_SESSION['location'],
                'zocuupancystatus'=>    $_SESSION['occupancystatus'],
                'zdescription'=>    $_SESSION['desc'],
                'zsize'=>    $_SESSION['size'],
                'ztotalclosing'=>    $_SESSION['totalclosing'],
                'zreadyby'=>    $_SESSION['readyby'],
                'zannualfee'=>    $_SESSION['annualfee'],
                'zpropertyreference'=>    $_SESSION['propertyreference'],
                'zbuyerfee'=>    $_SESSION['buyerfee'],
                'zsellerfee'=>    $_SESSION['sellerfee'],
                'zmaintenancefee'=>    $_SESSION['maintenancefee'],
                'zbuilding'=>    $_SESSION['building'],
