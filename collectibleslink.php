<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Collectibles online';
    include 'init.php';
?>
            <style>
            ...
            <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                <div class="container-fluid">
                    <div class="row" style="padding-left:15px;">
                                        <center>
                                            <h1 class="h1-pagecat">Buy & sell any Collectibles </h1>
                                            <h2 class="div-pagecat"> Collectibles on Oh Yamal</h2>                    
                                        </center>
                        <div class="col-lg-2">
                                                ...
                                                <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                    ...
                                                    <div id="search-content">
                                                                ...
                                                                <div class="widget-dropdown" id="search-content-site">
                                                                    <div class="search-dropdown">
                                                                        <select id="site:swfield" name="typeclassifieds">
                                                                            <option value="antcoll" selected>Antiquities</option>
                                                                            <option value="artcoll">Art</option>
                                                                            <option value="dmsticoll">Decorations</option>
                                                                            <option value="callicoll">Pens & Writing Instruments</option>
                                                                            <option value="cultrcoll">Memorabilia</option>
                                                                            <option value="artfcoll">Rocks/Fossils/Artifacts</option>
                                                                            <option value="ptherscoll">Other</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <input type="hidden" name="is_search" value="1">
                                                                <center><a href='collectibleslink.php?do=clear'>Clear Input</a></center>  
                            ...
                            $sortt ='';
                                    ...
                                    <div class="card">
                                        <div class="container" style="padding: 10px;">
                                            <div class="row">
                                                <div class="col-lg-10">
                                                    Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Collectibles</strong>            
                                                </div>
                                                <div class="col-lg-2">
                                                        <span class="toggle-info pull-right">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                                <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%antcoll%');
                                                                    if($var != 0){
                                                                        ?> <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="antcoll" name="searchmakecars1">Antiques<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%antcoll%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>

                                                                <?php }
                                                                ?>
                                                                <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%artcoll%');
                                                                    if($var != 0){
                                                                        ?> <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="artcoll" name="searchmakecars1">Art<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%artcoll%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>

                                                                <?php }
                                                                ?>
                                                                <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%dmsticoll%');
                                                                    if($var != 0){
                                                                        ?> <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="dmsticoll" name="searchmakecars1">Decorations<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%dmsticoll%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>

                                                                <?php }
                                                                ?>
                                                                <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%callicoll%');
                                                                    if($var != 0){
                                                                        ?> <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="callicoll" name="searchmakecars1">Pens & Writing Instruments<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%callicoll%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>

                                                                <?php }
                                                                ?>
                                                                <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%cultrcoll%');
                                                                    if($var != 0){
                                                                        ?> <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="cultrcoll" name="searchmakecars1">Memorabilia<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%cultrcoll%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>

                                                                <?php }
                                                                ?>
                                                                <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%artfcoll%');
                                                                    if($var != 0){
                                                                        ?> <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="artfcoll" name="searchmakecars1">Rocks/Fossils/Artifacts<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%artfcoll%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>

                                                                <?php }
                                                                ?>
                                                                <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%ptherscoll%');
                                                                    if($var != 0){
                                                                        ?> <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="ptherscoll" name="searchmakecars1">Other<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%ptherscoll%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                        ...
                                        <div class="container">    
                                            <?php
                                                            if($do == 'one'){
                                                                ...
                                                                where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%antcoll%' OR typeclassifieds like '%artcoll%'  OR typeclassifieds like '%dmsticoll%' OR typeclassifieds like '%callicoll%' OR typeclassifieds like '%cultrcoll%' OR typeclassifieds like '%artfcoll%' OR typeclassifieds like '%ptherscoll%')");
                                                                $result1->execute();
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%antcoll%' OR typeclassifieds like '%artcoll%'  OR typeclassifieds like '%dmsticoll%' OR typeclassifieds like '%callicoll%' OR typeclassifieds like '%cultrcoll%' OR typeclassifieds like '%artfcoll%' OR typeclassifieds like '%ptherscoll%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                            ...
                                                            elseif($do == 'orderprice1'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%antcoll%' OR typeclassifieds like '%artcoll%'  OR typeclassifieds like '%dmsticoll%' OR typeclassifieds like '%callicoll%' OR typeclassifieds like '%cultrcoll%' OR typeclassifieds like '%artfcoll%' OR typeclassifieds like '%ptherscoll%')", '', "price DESC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                            ...
                                                            elseif($do == 'orderprice2'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%antcoll%' OR typeclassifieds like '%artcoll%'  OR typeclassifieds like '%dmsticoll%' OR typeclassifieds like '%callicoll%' OR typeclassifieds like '%cultrcoll%' OR typeclassifieds like '%artfcoll%' OR typeclassifieds like '%ptherscoll%')", '', "price ASC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                            ...
                                                            elseif($do == 'clear'){
                                                                header('Location:collectibleslink.php');
                                                                exit();                                                
                                                            }     
                                                            // location
                                                            elseif($do == 'searchlocationcars1'){
                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                {
                                                                    ...
                                                                    $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%antcoll%' OR typeclassifieds like '%artcoll%'  OR typeclassifieds like '%dmsticoll%' OR typeclassifieds like '%callicoll%' OR typeclassifieds like '%cultrcoll%' OR typeclassifieds like '%artfcoll%' OR typeclassifieds like '%ptherscoll%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                                    $stmt->execute();
                                                                    $rows = $stmt->fetchAll(); 
                                                                    if(!empty($rows)){
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                            ...
                                            ?>
                                                                ...
                                                                <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                    ...
                                                                                    Collectibles in Abu Dhabi</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                    ...
                                                                                    Collectibles in Ras al Khaimah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                    ...
                                                                                    Collectibles in Sharjah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                    ...
                                                                                    Collectibles in Fujairah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                    ...
                                                                                    Collectibles in Umm al Quwain</button>
                                                                </form>
