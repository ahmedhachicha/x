                    ...
                    <div class="col-md-12 ">
                        <div class="hero">
                            <div class="container onehero">
                                <div class="row">
                                    <div class="col-lg-12"><h1 class="h1_mysearch">The UAE's leading marketplace to buy and sell For Sale</h1></div>
                                    <div class="col-lg-12">
        ...
        <div class="container">
                <div class="row content">
                    <div class="col-md-12 ">
                        ...
                        <div class="container"><h3 class="h1-memberindex">&nbsp; <p> Featured Listings For Sale :<ion-icon name="arrow-forward-outline" style="float: right;align-items: center;cursor:pointer;"></ion-icon></p></h3></div>
                        ...
                        <div class="container">
                            <div class="row">
                                        <div class="carousel clearfix">
                                            ...
                                            <?php
                                              $allItems = getAllFrom('*', 'forsale', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%reden%'", '', 'Id DESC', '');
                                              foreach($allItems as $item)
                                              {
                                                  echo '<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 stylewith" id="myList" >';
                                                      ...
                                                      for($i = 0; $i<$count; ++$i)
                                                      {
                                                          echo  "<a href='infoforsale.php?pageid=" . $item["Id"] ."' style='text-decoration: none; color:#2B2D2E;'><img class='card-img-top imgindexcard' src='admin/Update_Imageforsale/uploads/avatars/" . $res[$i] ."' alt='image' />";
                                                          echo wathmark_img();
                                                          echo "</a>";
                                                      }   
                                                      echo '<a href="infoforsale.php?pageid=' . $item['Id'] .'" style="text-decoration: none; color:#2B2D2E;"><div class="natitl">' . $item['Name'] . '</div></a>';
                                                      ...
                                                      echo '<hr>';                                              
                                                      echo '<a href="infoforsale.php?pageid=' . $item['Id'] .'" style="text-decoration: none; color:#2B2D2E;"><div class=" fw-bold mb-1 pricecardindex">' . number_format($item['Price']) . ' AED</div></a>';
                                                      echo '</div>';
                                                      echo '</div>';
                                                  echo '</div>';
                                              }
                                            ?>
                                            <?php
                                              $allItems = getAllFrom('*', 'forsale', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%comrl%'", '', 'Id DESC', '');
                                              foreach($allItems as $item)
                                              {
                                                  echo '<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 stylewith" id="myList" >';
                                                      echo '<div class="card h-100 stylecardindex">';
                                            ...
                                            ?>
                                            <?php
                                              $allItems = getAllFrom('*', 'forsale', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%lanns%'", '', 'Id DESC', '');
                                              foreach($allItems as $item)
                                              {
                                                  echo '<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 stylewith" id="myList" >';
                                                      echo '<div class="card h-100 stylecardindex">';
                                            ...
                                            ?>
                                            <?php
                                              $allItems = getAllFrom('*', 'forsale', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%muluu%'", '', 'Id DESC', '');
                                              foreach($allItems as $item)
                                              {
                                                  echo '<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 stylewith" id="myList" >';
                                                      echo '<div class="card h-100 stylecardindex">';
                            ...
                            <div class="row" style="margin-top: 40px;">
                                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 stylewith" style="margin-bottom:20px;">
                                    <div class="card h-100 stylecardindexx">
                                        <a href="resffsale.php"> <h3 class="h3all">Residential for Sale</h3></a>
                                        <strong class="strall"><a href="resffsale.php" style="color:black;"><?php echo countItemforsaleredn('typeforsale', 'forsale', '%reden%'); ?></a></strong>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 stylewith" style="margin-bottom:20px;">
                                    <div class="card h-100 stylecardindexx">
                                    <a href="comffsale.php"> <h3 class="h3all">Commercial for Sale</h3></a>
                                        <strong class="strall"><a href="comffsale.php" style="color:black;"><?php echo countItemforsalecomrs('typeforsale', 'forsale', '%comrl%'); ?></a></strong>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 stylewith" style="margin-bottom:20px;">
                                    <div class="card h-100 stylecardindexx">
                                    <a href="landffsale.php"> <h3 class="h3all">Land for Sale</h3></a>
                                        <strong class="strall"><a href="landffsale.php" style="color:black;"><?php echo countItemforsaleland('typeforsale', 'forsale', '%lanns%'); ?></a></strong>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 stylewith" style="margin-bottom:20px;">
                                    <div class="card h-100 stylecardindexx">
                                    <a href="multffsale.php"> <h3 class="h3all">Multiple Units for Sale</h3></a>
                                        <strong class="strall"><a href="multffsale.php" style="color:black;"><?php echo countItemforsalemult('typeforsale', 'forsale', '%muluu%'); ?></a></strong>
                                    </div>
                                </div>
                            </div>      
                        </div> 
