    ...
    if($do == 'Add'){
                    if(isset($_GET['pageid']) && is_numeric($_GET['pageid'])){
                        $blog = intval($_GET['pageid']);                                 
                                $allItems = getAllFrom("*", "classifieds", "where Id = {$blog}", "AND Approve = 1", "Id", "");
                                        ...
                                        <div class="row content">
                                            ...
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                ...
                                                <div class="col-lg-4">';
                                                    ...
                                                    <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="infoclasselec.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="infoclasselec.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        ...
                        <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infoclasselec.php?do=Update&userid=' . $blog . '" >Favorite</a>
                        </span>
                                    ...
                                    <?php    $i = '';
                                        ...
                                        for($i = 0; $i<$count; ++$i)
                                            {    
                                                ...
                                                <img style="height: 620px;" src="admin/Update_Imageclassifieds/uploads/avatars/' . $res[$i] .'" class="d-block w-100 " alt="...">
                                                ';
                                                echo wathmark_img();
                                                echo '</div>';
                                            }
                                            ...
                                            <div class="carousel clearfix">
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageclassifieds/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:165px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageclassifieds/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view clearfix">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageclassifieds/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:110px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageclassifieds/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageclassifieds/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:140px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageclassifieds/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                    ...
                    echo '<div class="col-lg-9">';
                        echo '<div class="row content">';
                            if(empty($item["brandclassifieds"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> BRAND </p>';   
                                        echo '<div class="itemdiv">' . $item["brandclassifieds"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            if(empty($item["ageclassifieds"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        ...
                                        echo '<div class="itemdiv">' . $item["ageclassifieds"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                            }

                            if(empty($item["usageclassifieds"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        ...
                                        echo '<div class="itemdiv">' . $item["usageclassifieds"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            if(empty($item["conditionclassifieds"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        ...
                                        echo '<div class="itemdiv">' . $item["conditionclassifieds"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }

                            if(empty($item["warrantyclassifieds"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        ...
                                        echo '<div class="itemdiv">' . $item["warrantyclassifieds"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            if(empty($item["colorclassifieds"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        ...
                                        echo '<div class="itemdiv">' . $item["colorclassifieds"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            ...
                            if(empty($item["memoryclassifieds"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> Memory </p>';    
                                        echo '<div class="itemdiv">' . $item["memoryclassifieds"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            if(empty($item["extrasclassifieds"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> Extras </p>';    
                                        echo '<div class="itemdiv">' . $item["extrasclassifieds"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            if(empty($item["package"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> Package </p>';    
                                        echo '<div class="itemdiv">' . $item["package"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            if(empty($item["rating"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> Rating </p>';    
                                        echo '<div class="itemdiv">' . $item["rating"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            if(empty($item["number"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> Number </p>';    
                                        echo '<div class="itemdiv">' . $item["number"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            if(empty($item["type"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> Type </p>';    
                                        echo '<div class="itemdiv">' . $item["type"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                            if(empty($item["duration"]))
                            {
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> Duration </p>';    
                                        echo '<div class="itemdiv">' . $item["duration"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';                                
                            }
                        echo '</div>';
                                    ...
                                    echo '<div class="row content">';
                                        if(empty($item["brandclassifieds"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> Brand </span>';                        
                                                echo '<span class="itemsqll">' . $item['brandclassifieds'] . '</span>';
                                                echo '<hr>';                         
                                            echo '</div>';
                                        }
                                        if(empty($item["ageclassifieds"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> Age </span>';                        
                                                echo '<span class="itemsqll">' . $item['ageclassifieds'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        ...
                                        if(empty($item["usageclassifieds"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> USAGE </span>';                        
                                                echo '<span class="itemsqll">' . $item['usageclassifieds'] . '</span>'; 
                                                echo '<hr>';                             
                                            echo '</div>';
                                        }
                                        ...
                                        if(empty($item["conditionclassifieds"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> CONDITION </span>';                        
                                                echo '<span class="itemsqll">' . $item['conditionclassifieds'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        ...
                                        if(empty($item["warrantyclassifieds"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                ...
                                                echo '<span class="itemsqll">' . $item['warrantyclassifieds'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        if(empty($item["colorclassifieds"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                ...
                                                echo '<span class="itemsqll">' . $item['colorclassifieds'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        if(empty($item["memoryclassifieds"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> Memory </span>';                        
                                                echo '<span class="itemsqll">' . $item['memoryclassifieds'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        if(empty($item["extrasclassifieds"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                ...
                                                echo '<span class="itemsqll">' . $item['extrasclassifieds'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        if(empty($item["package"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> Package </span>';                        
                                                echo '<span class="itemsqll">' . $item['package'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        if(empty($item["rating"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> Rating </span>';                        
                                                echo '<span class="itemsqll">' . $item['rating'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        if(empty($item["number"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> Number </span>';                        
                                                echo '<span class="itemsqll">' . $item['number'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        if(empty($item["type"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> Type </span>';                        
                                                echo '<span class="itemsqll">' . $item['type'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                        if(empty($item["duration"]))
                                        {
                                            ...
                                            echo '<div class="col-lg-12">';
                                                echo '<span class="itemalll"> Duration </span>';                        
                                                echo '<span class="itemsqll">' . $item['duration'] . '</span>';  
                                                echo '<hr>';                            
                                            echo '</div>';
                                        }
                                    echo '</div>';
    ...
    elseif($do == 'Update'){
        ...
        if(isset($_SESSION['uid']))
        {
          ...
          $useridd = $infoId['user_id'];
            ...
            $stmtitemadd = $con->prepare("INSERT INTO favorite(iditem, userid, favorite, nameitem) VALUES(:ziditem, :zuserid, 1, 'classifieds')");
