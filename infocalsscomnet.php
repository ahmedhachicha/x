                                    ...
                                    <div class="container">
                                        <div class="row content">
                                            ...
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                ...
                                                <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="infocalsscomnet.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="infocalsscomnet.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container productdiv">';
                    echo '<div class="row content">';
                        echo '<div class="col-lg-10">';
                            ...
                            echo '<p class="datepostd">' .  $item['date'] . '</p>';
                        echo '</div>';    
                            ...
                            for($i = 0; $i<$count; ++$i)
                                {
                                            ...
                                            <img title="click" style="width: 130px; height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageclassifieds/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                </a>';
                                }  
                        echo '</div>';
