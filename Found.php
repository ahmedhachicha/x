                ...
                <div id="tax-category-list">
                        ...
                        <ul class="category-breadcrumb " style="list-style: none;">
                                <li class="category-breadcrumb__item liitem">
                                            <a href="lostfound.php" class="category-breadcrumb__item-link linkitem">
                                                    ... > <?php echo $pageTitle ?> > Lost/Found > Found
                                            </a>
                                </li><hr>
                        </ul>
                    </div>
                    <div id="tax-categories">
                        <ul class="motors" style="list-style: none;">
                            <li class="liitem">
                                <a href="jewelryfound.php" class="linkitem">
                                    <span class="clickchoice">Jewelry, Watches & Sunglasses</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="keysfound.php" class="linkitem">
                                    <span class="clickchoice">Keys</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="mobilefound.php" class="linkitem">
                                    <span class="clickchoice">Mobile Phone</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="passportfound.php" class="linkitem">
                                    <span class="clickchoice">Passport & Documents</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="petsfound.php" class="linkitem">
                                    <span class="clickchoice">Pets</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="walletfound.php" class="linkitem">
