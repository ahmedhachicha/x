<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Accounting online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Accounting </h1>
                                                <h2 class="div-pagecat"> Accounting on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typejobs like '%cct%'");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'jobs', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typejobs like '%cct%'", '', "Id DESC", "LIMIT {$start},{$limit} ");
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                                ...
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM jobs where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typejobs like '%cct%' AND locationcars like '%$locatecars%'"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                ...
                                                ?>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        Accounting in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Accounting in Ras al Khaimah</button>
                                                                    </form>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        Accounting in Umm al Quwain</button>
                                                                    </form>
