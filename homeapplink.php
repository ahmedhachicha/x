<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Home Appliances online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                                            <center>
                                                                <h1 class="h1-pagecat"> Buy & sell any Home Appliances</h1>
                                                                <h2 class="div-pagecat"> Home Appliances on Oh Yamal </h2>                    
                                                            </center>
                            <div class="col-lg-2">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        ...
                                                                        <select id="site:swfield" name="typeclassifieds">
                                                                                ...
                                                                                <option value="vaccuhomcl">Vaccums & Floor Care</option>
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='homeapplink.php?do=clear'>Clear Input</a></center>  
                                                                ...
                                                                <div id="" class="panel-body ppll">
                                                                            ...
                                                                            <div class="widget-dropdown" id="search-content-site">
                                                                                <div class="search-dropdown">
                                                                                    ...
                                                                                    <option selected value="Yes">Brand</option>
                                                                                    <?php
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%vaccuhomcl%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="vaccuhomcl" name="searchmakecars1">Vaccums & Floor Care<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%vaccuhomcl%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%larhomcl%' OR typeclassifieds like '%smlkhcl%'  OR typeclassifieds like '%outhomcl%' OR typeclassifieds like '%smbrhomcl%' OR typeclassifieds like '%ironshomcl%' OR typeclassifieds like '%vaccuhomcl%' OR typeclassifieds like '%otherlhomcl%')");
                                                                    $result1->execute();
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%larhomcl%' OR typeclassifieds like '%smlkhcl%'  OR typeclassifieds like '%outhomcl%' OR typeclassifieds like '%smbrhomcl%' OR typeclassifieds like '%ironshomcl%' OR typeclassifieds like '%vaccuhomcl%' OR typeclassifieds like '%otherlhomcl%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%larhomcl%' OR typeclassifieds like '%smlkhcl%'  OR typeclassifieds like '%outhomcl%' OR typeclassifieds like '%smbrhomcl%' OR typeclassifieds like '%ironshomcl%' OR typeclassifieds like '%vaccuhomcl%' OR typeclassifieds like '%otherlhomcl%')", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'clear'){
                                                                    header('Location:homeapplink.php');
                                                                    exit();                                                
                                                                }     
                                                                // location
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%larhomcl%' OR typeclassifieds like '%smlkhcl%'  OR typeclassifieds like '%outhomcl%' OR typeclassifieds like '%smbrhomcl%' OR typeclassifieds like '%ironshomcl%' OR typeclassifieds like '%vaccuhomcl%' OR typeclassifieds like '%otherlhomcl%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                                        ...
                                                                                        Home Appliances in Ajman</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                                        ...
                                                                                        Home Appliances in Dubai</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        Home Appliances in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Home Appliances in Ras al Khaimah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                        ...
                                                                                        Home Appliances in Sharjah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        Home Appliances in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        Home Appliances in Umm al Quwain</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                        ...
                                                                                        Home Appliances in Al Ain</button>
                                                                    </form>
                                            </div>  
                                        </div>  
                            </div>
