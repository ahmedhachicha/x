                ...
                <div id="tax-category-list">
                        ...
                        <ul class="category-breadcrumb " style="list-style: none;">
                                <li class="category-breadcrumb__item liitem">
                                            <a href="clothingaccessories.php" class="category-breadcrumb__item-link linkitem">
                                                    ... > <?php echo $pageTitle ?> > Clothing & Accessories > Clothing
                                            </a>
                                </li><hr>
                        </ul>
                    </div>
                    <div id="tax-categories">
                        <ul class="motors" style="list-style: none;">
                            <li class="liitem">
                                <a href="Childrenclothing.php" class="linkitem">
                                    <span class="clickchoice">Children</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="Menclothing.php" class="linkitem">
                                    <span class="clickchoice">Men</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="Unisexclothing.php" class="linkitem">
                                    <span class="clickchoice">Unisex</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="Womenclothing.php" class="linkitem">
