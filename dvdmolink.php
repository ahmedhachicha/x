<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any DVDs & Movies online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any DVDs & Movies </h1>
                                                <h2 class="div-pagecat"> DVDs & Movies on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                ...
                                                <div id="search-widget">
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                            <select id="site:swfield" name="typeclassifieds">
                                                                                <option value="dvdone" selected>DVD</option>
                                                                                <option value="dvdtwo">Digital</option>
                                                                                <option value="dvdtree">VHS</option>
                                                                                <option value="dvdfoor">Other Formats</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>  
                                                                    ...
                                                                    <center><a href='dvdmolink.php?do=clear'>Clear Input</a></center>  
                            ...
                            <div class="col-lg-6">
                                <h1 class="h1-pagecat">DVDs & Movies</h1>
                                <?php   $sort = 'DESC';
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">DVDs & Movies</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%dvdone%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="dvdone" name="searchmakecars1">DVD<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%dvdone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%dvdtwo%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="dvdtwo" name="searchmakecars1">Digital<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%dvdtwo%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%dvdtree%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="dvdtree" name="searchmakecars1">VHS<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%dvdtree%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%dvdfoor%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="dvdfoor" name="searchmakecars1">Other Formats<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%dvdfoor%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%dvdone%' OR typeclassifieds like '%dvdtwo%' OR typeclassifieds like '%dvdtree%' OR typeclassifieds like '%dvdfoor%')");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%dvdone%' OR typeclassifieds like '%dvdtwo%' OR typeclassifieds like '%dvdtree%' OR typeclassifieds like '%dvdfoor%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%dvdone%' OR typeclassifieds like '%dvdtwo%' OR typeclassifieds like '%dvdtree%' OR typeclassifieds like '%dvdfoor%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%dvdone%' OR typeclassifieds like '%dvdtwo%' OR typeclassifieds like '%dvdtree%' OR typeclassifieds like '%dvdfoor%')", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
...
foreach($rows as $row)
                                                                ...
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%dvdone%' OR typeclassifieds like '%dvdtwo%' OR typeclassifieds like '%dvdtree%' OR typeclassifieds like '%dvdfoor%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        DVDs & Movies in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        DVDs & Movies in Ras al Khaimah</button>
                                                                    </form>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        DVDs & Movies in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        DVDs & Movies in Umm al Quwain</button>
                                                                    </form>
