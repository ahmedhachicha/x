<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Architecture/Eng online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Architecture/Eng </h1>
                                                <h2 class="div-pagecat"> Architecture/Eng on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        ...
                                                                        <select id="site:swfield" name="typejobs">
                                                                                ...
                                                                                <option value="cctt" selected>Architecture/Eng</option>
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='arenlink.php?do=clear'>Clear Input</a></center>  
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typejobs like '%cctt%'");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'jobs', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typejobs like '%cctt%'", '', "Id DESC", "LIMIT {$start},{$limit} ");
                                                                ...
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM jobs where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typejobs like '%cctt%' AND locationcars like '%$locatecars%'"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                                        ...
                                                                                        Architecture/Eng in Ajman</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                                        ...
                                                                                        Architecture/Eng in Dubai</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        Architecture/Eng in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Architecture/Eng in Ras al Khaimah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                        ...
                                                                                        Architecture/Eng in Sharjah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        Architecture/Eng in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        Architecture/Eng in Umm al Quwain</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                        ...
                                                                                        Architecture/Eng in Al Ain</button>
                                                                    </form>
                                            </div>  
                                        </div>  
                            </div>
