<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Music online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Music </h1>
                                                <h2 class="div-pagecat"> Music on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                ...
                                                <div id="search-widget">
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                            <select id="site:swfield" name="typeclassifieds">
                                                                                <option value="musiconee" selected>Vinyl</option>
                                                                                <option value="musictwoo">CDs</option>
                                                                                <option value="musictrees">Casettes</option>
                                                                                <option value="musicfoors">Digital</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>  
                                                                    ...
                                                                    <center><a href='musiclink.php?do=clear'>Clear Input</a></center>  
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Music</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%musiconee%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="musiconee" name="searchmakecars1">Vinyl<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%musiconee%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%musictwoo%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="musictwoo" name="searchmakecars1">CDs<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%musictwoo%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%musictrees%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="musictrees" name="searchmakecars1">Casettes<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%musictrees%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%musicfoors%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="musicfoors" name="searchmakecars1">Digital<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%musicfoors%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%musiconee%' OR typeclassifieds like '%musictwoo%' OR typeclassifieds like '%musictrees%' OR typeclassifieds like '%musicfoors%')");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%musiconee%' OR typeclassifieds like '%musictwoo%' OR typeclassifieds like '%musictrees%' OR typeclassifieds like '%musicfoors%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%musiconee%' OR typeclassifieds like '%musictwoo%' OR typeclassifieds like '%musictrees%' OR typeclassifieds like '%musicfoors%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%musiconee%' OR typeclassifieds like '%musictwoo%' OR typeclassifieds like '%musictrees%' OR typeclassifieds like '%musicfoors%')", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'resultsearch'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $typeclassifieds = $_POST['typeclassifieds'];
                                                                                ...
                                                                                $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%$typeclassifieds%' AND locationcars = '$locatecars' AND ((price BETWEEN '$pricegte' AND '$pricelte') OR location like '%$neighboarhood%' )");
                                                                ...
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%musiconee%' OR typeclassifieds like '%musictwoo%' OR typeclassifieds like '%musictrees%' OR typeclassifieds like '%musicfoors%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Music in Ras al Khaimah</button>
                                                                    </form>
