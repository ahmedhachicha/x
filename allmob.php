<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any All Mobile Phones online';
    include 'init.php';
?>
            <style>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any All Mobile Phones </h1>
                                                <h2 class="div-pagecat"> All Mobile Phones on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='allmob.php?do=clear'>Clear Input</a></center>  
                                            ...
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%MobPhone%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-6">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="MobPhone" name="searchmakecars1">Mobile Phones<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Tablls%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-6">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Tablls" name="searchmakecars1">Mobile Phone & Tablet Accessories<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Tablls%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%MPTAccess%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-6">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="MPTAccess" name="searchmakecars1">Tablets<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%MPTAccess%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%MPTfin%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-6">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="MPTfin" name="searchmakecars1">Other Mobile Phones & Tablets<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%MPTfin%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%MobPhone%' OR typeclassifieds like '%Tablls%' OR typeclassifieds like '%MPTfin%' OR typeclassifieds like '%MPTAccess%')");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND (typeclassifieds like '%MobPhone%' OR typeclassifieds like '%Tablls%' OR typeclassifieds like '%MPTfin%' OR typeclassifieds like '%MPTAccess%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND (typeclassifieds like '%MobPhone%' OR typeclassifieds like '%Tablls%' OR typeclassifieds like '%MPTfin%' OR typeclassifieds like '%MPTAccess%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND (typeclassifieds like '%MobPhone%' OR typeclassifieds like '%Tablls%' OR typeclassifieds like '%MPTfin%' OR typeclassifieds like '%MPTAccess%')", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'resultsearch'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $warrantyclassifieds = $_POST['warrantyclassifieds'];
                                                                                ...
                                                                                $stmt = $con->prepare("SELECT * FROM classifieds where  locationcars = '$locatecars' AND Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND ((price BETWEEN '$pricegte' AND '$pricelte') OR  location like '%$neighboarhood%' OR typeclassifieds like '%$typeclassifieds%' OR conditionclassifieds like '%$conditionclassifieds%' OR warrantyclassifieds like '%$warrantyclassifieds%')");
                                                                ...
                                                                elseif($do == 'search'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $all = $_POST['all'];
                                                                            ...
                                                                            if($categories == "Mobile Phones"){   

                                                                                $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND typeclassifieds like '%MobPhone%') order by Id DESC");
                                                                            ...
                                                                            elseif($categories == "Mobile Phone & Tablet"){
                                                                                $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND typeclassifieds like '%Tablls%') order by Id DESC");
                                                                            ...
                                                                            elseif($categories == "Tablets"){
                                                                                $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND typeclassifieds like '%MPTfin%') order by Id DESC");
                                                                            ...
                                                                            elseif($categories == "Other Mobile Phones & Tablets"){
                                                                                $stmt = $con->prepare("SELECT * FROM classifieds
                                                                                where  (Name like '%$all%' AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1 ) OR (Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND typeclassifieds like '%MPTAccess%') order by Id DESC");
                                                                ...
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH)  AND (typeclassifieds like '%MobPhone%' OR typeclassifieds like '%Tablls%' OR typeclassifieds like '%MPTfin%' OR typeclassifieds like '%MPTAccess%') AND locationcars like '%$locatecars%' order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                                        ...
                                                                                        All Mobile Phones in Ajman</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                                        ...
                                                                                        All Mobile Phones in Dubai</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        All Mobile Phones in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        All Mobile Phones in Ras al Khaimah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                        ...
                                                                                        All Mobile Phones in Sharjah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        All Mobile Phones in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        All Mobile Phones in Umm al Quwain</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                        ...
                                                                                        All Mobile Phones in Al Ain</button>
                                                                    </form>
                                            </div>  
                                        </div>  
                            </div>
