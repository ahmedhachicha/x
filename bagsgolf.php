                                    ...
                                    <div class="row">
                                        <div class="row1 col-lg-4">
                                            <form class="form-horizontal needs-validation" action="?do=Inserted" method="POST" enctype="multipart/form-data" novalidate>
                                                ...
                                                <a href="Golf.php" class="linkfrom">Sports Equipment > Golf > Bags</a>
                                                ...
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="Bags Golff" name="typeclassifieds" class="forminput form-select-lg" autocomplete="off" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-lg formmarginad">
                                                <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-2">
                                                            <input id="model" type="hidden" value="Classifieds > Golf > Bags" name="categoryy" class="forminput form-select-lg" autocomplete="off" required="required" placeholder="Model Of The cars">
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php echo locate(); ?>
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch));
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [
                                "redirectUrl" =>  "https://ohyamal.com/bagsgolf.php?do=Insertfin1"
                            ],
                            ];
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch));
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [
                                "redirectUrl" =>  "https://ohyamal.com/bagsgolf.php?do=Insertfin2"
                            ],
                            ];
                            $outlet = "c3cce49c-9824-4fc3-b237-f03f3c9c449f";
                            $json = json_encode($postData);
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch));
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [
                                "redirectUrl" =>  "https://ohyamal.com/bagsgolf.php?do=Insertfin3"
                            ],
                            ];
                            $outlet = "c3cce49c-9824-4fc3-b237-f03f3c9c449f";
                            $json = json_encode($postData);
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                $output = json_decode(curl_exec($ch));
                        ...
                        $postData = [
                            ...
                            "merchantAttributes" => [
                                "redirectUrl" =>  "https://ohyamal.com/bagsgolf.php?do=Insertfin4"
                            ],
                            ];
                            $outlet = "c3cce49c-9824-4fc3-b237-f03f3c9c449f";
                            $json = json_encode($postData);
