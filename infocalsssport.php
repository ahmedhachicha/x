    ...
    if($do == 'Add'){
                ...
                echo '<div class="container">';
                    ...
                    echo '<div class="col-lg-9 col-md-12 col-xs-12">';
                        ...
                        <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infocalsssport.php?do=Update&userid=' . $blog . '" >Favorite</a>
                        </span>
