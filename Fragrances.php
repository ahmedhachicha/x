                ...
                <div id="tax-category-list">
                        ...
                        <ul class="category-breadcrumb " style="list-style: none;">
                                <li class="category-breadcrumb__item liitem">
                                            <a href="clothingaccessories.php" class="category-breadcrumb__item-link linkitem">
                                                    ... > <?php echo $pageTitle ?> > Clothing & Accessories > Fragrances
                                            </a>
                                </li><hr>
                        </ul>
                    </div>
                    <div id="tax-categories">
                        <ul class="motors" style="list-style: none;">
                            <li class="liitem">
                                <a href="Menfragrances.php" class="linkitem">
                                    <span class="clickchoice">Men</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="Unisexfragrances.php" class="linkitem">
                                    <span class="clickchoice">Unisex</span>
                                </a>
                            </li><hr>
                            <li class="liitem">
                                <a href="Womenfragrances.php" class="linkitem">
