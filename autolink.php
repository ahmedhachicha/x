<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell Auto Accessories & Parts online ';
    include 'init.php';
?>
            <style>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat"> Buy & sell any Auto Accessories & Parts </h1>
                                                <h2 class="div-pagecat"> Auto Accessories & Parts on Oh Yamal </h2>                    
                                            </center>
                            <div class="col-lg-2">
                                            ...
                                            <div id="search-widget-wrapper">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site" style="margin-top: 15px;">
                                                                                <div class="search-dropdown">
                                                                                    <select id="site:swfield" name="sellertypeparts">
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='autolink.php?do=clear'>Clear Input</a></center>  
                                                ...
                                                <!-- <div class="panel-body"> -->
                                                                ...
                                                                <div id="" class="panel-body ppll">
                                                                            ...
                                                                            <div class="widget-dropdown" id="search-content-site">
                                                                                <div class="search-dropdown">
                                                                                    <select id="site:swfield" name="conditionparts">
                                                                            ...
                                                                            <div class="widget-dropdown" id="search-content-site">
                                                                                <div class="search-dropdown">
                                                                                    <select id="site:swfield" name="usageparts">
                                                                                    <option selected value="Still in original packaging">Usage</option>
                                                                                    <?php
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allmotors.php">.. > Motors > </a> <strong style="color: #626465;">Auto Accessories & Parts</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                            <span class="toggle-info pull-right">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="container"><hr></div>
                                                            <div class="row">
                                                                <?php if(empty(countItemsmotauto('typeparts', 'autoaccparts', '%crpas%'))){

                                                                }
                                                                else { ?>
                                                                    <div class="col-lg-4">
                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="crpas" name="searchmakecars1">Car/4x4 Parts <span style="color: black;">(<?php echo countItemsmotauto('typeparts', 'autoaccparts', '%crpas%'); ?>)</span> </button></a>
                                                                    </form>
                                                                </div>
                                                                <?php } ?>
                                                                
                                                                <?php if(empty(countItemsmotauto('typeparts', 'autoaccparts', '%amacc%'))){

                                                                }
                                                                else { ?>
                                                                    <div class="col-lg-4">
                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="amacc" name="searchmakecars1">Apparel, Merchandise & Accessories<span style="color: black;">(<?php echo countItemsmotauto('typeparts', 'autoaccparts', '%amacc%'); ?>)</span> </button></a>
                                                                    </form>
                                                                </div>
                                                                <?php } ?>
                                                                
                                                                <?php if(empty(countItemsmotauto('typeparts', 'autoaccparts', '%moap%'))){

                                                                }
                                                                else { ?>
                                                                    <div class="col-lg-4">
                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="moap" name="searchmakecars1">Motorcycle Parts<span style="color: black;">(<?php echo countItemsmotauto('typeparts', 'autoaccparts', '%moap%'); ?>)</span> </button></a>
                                                                    </form>
                                                                </div>
                                                                <?php } ?>
                                                                
                                                                <?php if(empty(countItemsmotauto('typeparts', 'autoaccparts', '%autoo%'))){

                                                                }
                                                                else { ?>
                                                                    <div class="col-lg-4">
                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="autoo" name="searchmakecars1">Automotive Tools<span style="color: black;">(<?php echo countItemsmotauto('typeparts', 'autoaccparts', '%autoo%'); ?>)</span> </button></a>
                                                                    </form>
                                                                </div>
                                                                <?php } ?>
                                                                
                                                                <?php if(empty(countItemsmotauto('typeparts', 'autoaccparts', '%mtbp%'))){

                                                                }
                                                                else { ?>
                                                                    <div class="col-lg-4">
                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="mtbp" name="searchmakecars1">Boat Parts<span style="color: black;">(<?php echo countItemsmotauto('typeparts', 'autoaccparts', '%mtbp%'); ?>)</span> </button></a>
                                                                    </form>
                                                                </div>
                                                                <?php } ?>
                                                                
                                                                <?php if(empty(countItemsmotauto('typeparts', 'autoaccparts', '%Vrpt%'))){

                                                                }
                                                                else { ?>
                                                                    <div class="col-lg-4">
                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Vrpt" name="searchmakecars1">Other Vehicle Parts<span style="color: black;">(<?php echo countItemsmotauto('typeparts', 'autoaccparts', '%Vrpt%'); ?>)</span> </button></a>
                                                                    </form>
                                                                </div>
                                                                <?php } ?>
                                                            </div>    
                                                        ...
                                                        <div class="row">
                                                            <?php
                                                                            if($do == 'one'){
                                                                                ...
                                                                                $start = ($page - 1) * $limit;
                                                                                $result1 = $con->prepare("SELECT count(Id) AS Id FROM autoaccparts
                                                                                ...
                                                                                $allItems = getAllFrom('*', 'autoaccparts', "where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                                foreach($allItems as $item)
                                                                                {                                           
                                                                                    echo '<a href="infoparts.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                                            ...
                                                                                            echo '<div class="row">';
                                                                                                echo '<div class="col-lg-4">';
                                                                                                    ...
                                                                                                    for($i = 0; $i<$count; ++$i)
                                                                                                    {
                                                                                                        echo  "<img class='card-img-top imgindexcard' src='admin/Update_Imageparts/uploads/avatars/" . $res[$i] ."' alt='image' />";
                                                                                                        echo '<span class="countimgs">' . $countimages . ' images</span>';
                                                                                                    }                                                         
                                                                                                echo '</div>';
                                                                                                echo '<div class="col-lg-8">';
                                                                                                echo '<div class="row">';
                                                                                                echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> <p class="spanyyitli">' . $item["categoryy"] .'</p></div>';
                                                                                                echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><p class="dateitli">Posted on ' . TimeAgo($item["Add_date"], date("Y-m-d H:i:s")) .'</p></div>';
                                                                                                echo '</div>';
                                                                                                    echo '<div class="row">';
                                                                                                        echo '<div class="col-lg-12">Usage : ' . '<strong>' . $item["usageparts"] . '</strong>' . '</div>';
                                                                                                        echo '<div class="col-lg-12">Condition : ' . '<strong>' . $item['conditionparts']. '</strong>' . '</div>';
                                                                                                    echo '</div>';
                                                                                                echo '</div>';
                                                                                            echo '</div>';
                                                                                            echo '<div class="row">';
...
<span class="featured_span">Featured</span>
                                                                            ...
                                                                            elseif($do == 'orderprice1'){
                                                                                ...
                                                                                $allItems = getAllFrom('*', 'autoaccparts', "where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)", '', " Price DESC", "LIMIT 20");
                                                                                foreach($allItems as $item)
                                                                                {                                           
                                                                                    echo '<a href="infoparts.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                                        echo '<div class="borderstyl" style="padding:15px;">';
...
<span class="featured_span">Featured</span>
                                                                            ...
                                                                            elseif($do == 'orderprice2'){
                                                                                ...
                                                                                $allItems = getAllFrom('*', 'autoaccparts', "where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)", '', " Price ASC", "LIMIT 20");
                                                                                foreach($allItems as $item)
                                                                                {                                           
                                                                                    echo '<a href="infoparts.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                                        echo '<div class="borderstyl" style="padding:15px;">';
...
<span class="featured_span">Featured</span>
                                                                            ...
                                                                            elseif($do == 'resultsearch'){
                                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                                {
                                                                                    ...
                                                                                    $stmt = $con->prepare("SELECT * FROM autoaccparts where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars = '$locatecars' AND ((Price BETWEEN '$pricegte' AND '$pricelte') OR Location like '%$neighboarhood%' OR sellertypeparts like '%$sellertypeparts%' OR conditionparts like '%$conditionparts%' OR usageparts like '%$usageparts%')"); 
                                                                                    $stmt->execute();
                                                                                    $rows = $stmt->fetchAll(); 
                                                                                    if(!empty($rows)){
                                                                                        foreach($rows as $row)
                                                                                        {                                           
                                                                                            echo '<a href="infoparts.php?pageid=' . $row["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                                                                    echo '<div class="row">';
                                                                                                        // echo '<div class="col-lg-2">Featured</div>';
                                                                                                        // echo '<div class="col-lg-10">History Check</div>';
                                                                                                    ...
                                                                                                    echo '<div class="row">';
                                                                                                        ...
                                                                                                        echo '<div class="col-lg-8">';
                                                                                                            ...
                                                                                                            echo '<div class="row">';
                                                                                                                echo '<div class="col-lg-12">Usage : ' . '<strong>' . $row["usageparts"] . '</strong>' . '</div>';
                                                                                                                echo '<div class="col-lg-12">Condition : ' . '<strong>' . $row['conditionparts']. '</strong>' . '</div>';
                                                                                                            echo '</div>';
                                                                                                        echo '</div>';
                                                                                                    echo '</div>';
                                                                                                    echo '<div class="row">';
                                                                            ...
                                                                            elseif($do == 'search'){
                                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                                {
                                                                                    ...
                                                                                    $stmt = $con->prepare("SELECT * FROM autoaccparts where  (Name like '%$all%' AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1) OR (Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (locationcars = '$locatecars') AND ((Price BETWEEN '$pricegte' AND '$pricelte') OR Location like '%$all%' OR sellertypeparts like '%$sellertypeparts%' OR conditionparts like '%$all%' OR usageparts like '%$all%' OR typeparts like '%$typeparts%')) order by Id DESC"); 
                                                                                    $stmt->execute();
                                                                                    $rows = $stmt->fetchAll(); 
                                                                                    if(!empty($rows)){
                                                                                        foreach($rows as $row)
                                                                            ...
                                                                            elseif($do == 'searchlocationcars1'){
                                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                                {
                                                                                    ...
                                                                                    $stmt = $con->prepare("SELECT * FROM autoaccparts where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars like '%$locatecars%'"); 
                                                                                    $stmt->execute();
                                                                                    $rows = $stmt->fetchAll(); 
                                                                                    if(!empty($rows)){
                                                                                        foreach($rows as $row)
                                                                            ...
                                                                            elseif($do == 'searchmakecars1'){
                                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                                {
                                                                                    ...
                                                                                    $stmt = $con->prepare("SELECT * FROM autoaccparts where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeparts like '%$make%'"); 
                                                                                    $stmt->execute();
                                                                                    $rows = $stmt->fetchAll(); 
                                                                                    if(!empty($rows)){
                                                                                        foreach($rows as $row)
                                                            ...
                                                            ?>
                                                                                <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                                                    ...
                                                                                                    Auto Accessories & Parts in Ajman</button>
                                                                                </form>
                                                                                <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                                                    ...
                                                                                                    Auto Accessories & Parts in Dubai</button>
                                                                                </form>
                                                                                <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                                    ...
                                                                                                    Auto Accessories & Parts in Abu Dhabi</button>
                                                                                </form>
                                                                                <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                                    ...
                                                                                                    Auto Accessories & Parts in Ras al Khaimah</button>
                                                                                </form>
                                                                                <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                                    ...
                                                                                                    Auto Accessories & Parts in Sharjah</button>
                                                                                </form>
                                                                                <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                                    ...
                                                                                                    Auto Accessories & Parts in Fujairah</button>
                                                                                </form>
                                                                                <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                                    ...
                                                                                                    Auto Accessories & Parts in Umm al Quwain</button>
                                                                                </form>
                                                                                <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                                    ...
                                                                                                    Auto Accessories & Parts in Al Ain</button>
                                                                                </form>
                                                        </div>  
                                                    </div>  
                                                <!-- </div>  
