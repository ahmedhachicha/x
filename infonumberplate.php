    ...
    if($do == 'Add'){
                    if(isset($_GET['pageid']) && is_numeric($_GET['pageid'])){
                        $blog = intval($_GET['pageid']);                                 
                                $allItems = getAllFrom("*", "numberplates", "where Id = {$blog}", "AND Approve = 1", "Id", "");
                                    ...
                                    <div class="container">
                                        <div class="row content">
                                            <div class="col-lg-6 mb-3 style_navp d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">';
                                                ...
                                                echo '<div class="titlenava"><ion-icon name="location-outline"></ion-icon>' . $item['locationcars'] . '</div>';
                                            echo '</div>';
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                ...
                                                <div class="col-lg-4">';
                                                    ...
                                                    <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="infonumberplate.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="infonumberplate.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        ...
                        <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infonumberplate.php?do=Update&userid=' . $blog . '" >Favorite</a>
                        </span>
                        ...
                        ?>
                            <style>
                                .imgplate{width: 100%; height: 80%;}
                                h3.-\30 {    position: relative;    width: 10px;
                                        top: -335px;
                                        left: 500px;
                                        font-size: 35px;
                                        color: black;
                                        ...
                                        letter-spacing: 2px;
                                                                    ...
                                                                    h3.platetwo {position: relative;    width: 10px;
                                        top: -235px;
                                        left: 550px;
                                        font-size: 35px;
                                        color: black;
                                        ...
                                        letter-spacing: 2px;
                                                                    ...
                                                                    h3.platetree {letter-spacing: 2px;    width: 10px;
                                        position: relative;
                                        top: -265px;
                                        left: 410px;
                                        font-size: 35px;
                            ...
                            <?php
                                ...
                                ?>
                                        ...
                                        <?php    echo '<h3 class="code13">' . $item['platecode'] . '</h3>'; ?>
                                <?php
                                }
                                elseif($item['design'] == "-1"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code92">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] ==  "platetwo"){
                                    ?>
                                        <img src="layout/images/Dubai_Classic.png" alt="" class="imgplate">
                                        <?php    echo '<h3 class="platetreeplt">' . $item['platenumber'] . '</h3>'; ?>
                                        <?php    echo '<h3 class="code012">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "platetree"){
                                    ?>
                                        <img src="layout/images/Dubai_motorcycle.png" alt="" class="imgplate">
                                        <?php    echo '<h3 class="platetree platetwo">' . $item['platenumber'] . '</h3>'; ?>
                                        <?php    echo '<h3 class="code0012">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['design'] == "-3"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code02">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['design'] == "-4"){
                                    ?>
                                        <img src="layout/images/Abu_Dhabi_New.png" alt="" class="imgplate">
                                        <?php    echo '<h3 class="abudabfor">' . $item['platenumber'] . '</h3>'; ?>
                                        <?php    echo '<h3 class="abudabforcd">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "plate2motor"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code05">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "plate3one"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code04">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "plate3two"){
                                    ?>
                                        <img src="layout/images/Sharjah_Classic.png" alt="" class="imgplate">
                                        <?php    echo '<h3 class="plate3twoclassic">' . $item['platenumber'] . '</h3>'; ?>
                                        <?php    echo '<h3 class="code03classic">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "platetree3"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code01">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "plate4one"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code022">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "platetree4"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code1">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "plate5one"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code2">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "platetree5"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code3">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "plate6one"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code4">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "platetree6"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code5">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "plate7one"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code6">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                                elseif($item['typenpl'] == "platetree7"){
                                    ?>
                                        ...
                                        <?php    echo '<h3 class="code7">' . $item['platecode'] . '</h3>'; ?>
                                    <?php
                                }
                            ?>
                            </div>
                            ...
                            echo '<div class="row content">';
                                echo '<div class="col-lg-2">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> PLate Code </p>';   
                                        echo '<div class="itemdiv">' . $item["platecode"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                                echo '<div class="col-lg-2">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp"> Plate Number </p>';                    
                                        echo '<div class="itemdiv">' . $item["platenumber"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                                echo '<div class="col-lg-8">';
                                    echo '<div class="card cardstyl  initial">';
                                        echo '<p class="stylp">  </p>'; 
                                        echo '<div class="itemdiv">' . $item["categoryy"] . '</div>';                           
                                    echo '</div>';
                                echo '</div>';
                            echo '</div>';
                        echo '</div>';
                ...
                echo '<div class="container d-block d-sm-none">';
                    echo '<div class="row content  divitemover">';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Plate Code </span>';                        
                                echo '<span class="itemsqlcode">' . $item['platecode'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Plate Number </span>';                        
                                echo '<span class="itemsqlcode">' . $item['platenumber'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall">  </span>';                        
                                echo '<span class="itemsql">' . $item['categoryy'] . '</span>';                           
                            echo '</div>';
                        echo '</div>';                    
                echo '</div>';
                ...
                echo '<div class="row content  divitemover">';
                    ...
                    echo '<br><hr>';
                        echo '<div class="row content">';
                            ...
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<div type="large" ><ion-icon name="location-outline"></ion-icon>' . $item['locationcars'] . '</div>';
                            echo '</div>';
                        echo '</div>';
                    echo '</div>';
                echo '</div>';
    ...
    elseif($do == 'Update'){
        ...
        if(isset($_SESSION['uid']))
        {
          ...
          $useridd = $infoId['user_id'];
            ...
            $stmtitemadd = $con->prepare("INSERT INTO favorite(iditem, userid, favorite, nameitem) VALUES(:ziditem, :zuserid, 1, 'numberplates')");
