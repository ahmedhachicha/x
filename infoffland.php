    ...
    if($do == 'Add'){
                    if(isset($_GET['pageid']) && is_numeric($_GET['pageid'])){
                        $blog = intval($_GET['pageid']);                                 
                                $allItems = getAllFrom("*", "forsale", "where Id = {$blog}", "AND Approve = 1", "Id", "");
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        ...
                        <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infoffland.php?do=Update&userid=' . $blog . '" >Favorite</a>
                        </span>
                                      ...
                                      $i = '';
                                        ...
                                        for($i = 0; $i<$count; ++$i)
                                            {    
                                                ...
                                                <img style="height: 620px;" src="admin/Update_Imageforsale/uploads/avatars/' . $res[$i] .'" class="d-block w-100 " alt="...">
                                                ';
                                                echo wathmark_img();
                                                echo '</div>';
                                            }
                                            ...
                                            <div class="carousel clearfix">
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageforsale/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:165px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageforsale/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view clearfix">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageforsale/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:110px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageforsale/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageforsale/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:140px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageforsale/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                            ...
                            echo '<div class="col-lg-12">';
                                echo '<div class="card  initial">';
                                    echo '<div class="row content">';
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Zoned For </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['zonedfor'] . '</div>';                          
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Freehold </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            if(empty($item['extras'])){
                                                echo '<div class="itemsql">No</div>'; 
                                            }   
                                            else{
                                                echo '<div class="itemsql">Yes</div>'; 
                                            }   
                                        echo '</div>';
                                    echo '</div>';
                                echo '</div>';
                ...
                echo '<div class="row content  divitemover">';
                                    echo '<div class="row content">';
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Zoned For </span>';                        
                                            echo '<span class="itemsqll">' . $item['zonedfor'] . '</span>';  
                                            echo '<hr>';                            
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Freehold </span>';     
                                                if(empty($item['extras'])){
                                                    echo '<span class="itemsqll">No</span>'; 
                                                }   
                                                else{
                                                    echo '<span class="itemsqll">Yes</span>'; 
                                                }   
                                            echo '<hr>';                            
                                        echo '</div>';
    ...
    elseif($do == 'Update'){
        ...
        if(isset($_SESSION['uid']))
        {
          ...
          $useridd = $infoId['user_id'];
            ...
            $stmtitemadd = $con->prepare("INSERT INTO favorite(iditem, userid, favorite, nameitem) VALUES(:ziditem, :zuserid, 1, 'forsale')");
