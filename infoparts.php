    ...
    if($do == 'Add'){
                    if(isset($_GET['pageid']) && is_numeric($_GET['pageid'])){
                        $blog = intval($_GET['pageid']);                                 
                                $allItems = getAllFrom("*", "autoaccparts", "where Id = {$blog}", "AND Approve = 1", "Id", "");
                                        ...
                                        <div class="row content">
                                            ...
                                            echo '<div class="col-lg-6  d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block" dir="rtl">
                                                ...
                                                <div class="col-lg-4">';
                                                    ...
                                                    <div class="col-lg-4">';
                                                    echo '<button class="divfavorit btn"><a style="color:black; text-decoration:none;" href="infoparts.php?do=Update&userid=' . $blog . '" >Favorite</a><ion-icon name="heart-outline"></ion-icon></button>
                                                </div>';
                                                echo '</div>';
                                            echo '</div>';
                                            ...
                                            echo '<div class="col-lg-6  d-block d-sm-none" dir="rtl">';
                                                        ...
                                                        echo '<a style="color:black; text-decoration:none;" href="infoparts.php?do=Update&userid=' . $blog . '" ><ion-icon style="margin-left: 15px; cursor: pointer;" class="ioconnav"name="heart-outline"></ion-icon></a>';
                                            echo '</div>';
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        ...
                        <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infoparts.php?do=Update&userid=' . $blog . '" >Favorite</a>
                        </span>
                                      ...
                                      $i = '';
                                        ...
                                        for($i = 0; $i<$count; ++$i)
                                            {    
                                                ...
                                                <img style="height: 620px;" src="admin/Update_Imageparts/uploads/avatars/' . $res[$i] .'" class="d-block w-100 " alt="...">
                                                ';
                                                echo wathmark_img();
                                                echo '</div>';
                                            }
                                            ...
                                            <div class="carousel clearfix">
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageparts/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:165px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageparts/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view clearfix">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageparts/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:110px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageparts/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                                                ...
                                                <div class="carousel-view">
                                                    <?php
                                                        ...
                                                        for($i = 1; $i<$count; ++$i)
                                                            {
                                                                echo '<a class="example-image-link" href="admin/Update_Imageparts/uploads/avatars/' . $res[$i] .' " data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
                                                                <img title="click" style="width:140px;height: 130px;object-fit: cover;" class="example-image" src="admin/Update_Imageparts/uploads/avatars/' . $res[$i] .' " alt=""/>
                                                                    </a>';
                                                            }
                                                    ?>
                                                </div> 
                        ...
                        echo '<div class="row content">';
                            echo '<div class="col-lg-4">';
                                echo '<div class="card cardstyl  initial">';
                                    ...
                                    echo '<div class="itemdiv">' . $item["usageparts"] . '</div>';                           
                                echo '</div>';
                            echo '</div>';
                            echo '<div class="col-lg-4">';
                                echo '<div class="card cardstyl  initial">';
                                    echo '<p class="stylp"> CONDITION </p>';                    
                                    echo '<div class="itemdiv">' . $item["conditionparts"] . '</div>';                           
                                echo '</div>';
                            echo '</div>';
                            echo '<div class="col-lg-4">';
                                echo '<div class="card cardstyl  initial">';
                                    echo '<p class="stylp"> SELLER TYPE </p>';   
                                    echo '<div class="itemdiv">' . $item["sellertypeparts"] . '</div>';                           
                                echo '</div>';
                            echo '</div>';
                            // if(!empty($item["extrasparts"]))
                            // {
                            ...
                            echo '<div class="card cardstyl  initial">';
                                ...
                                echo '<div class="itemdiv">' . $item["extrasparts"] . '</div>';                           
                            echo '</div>';
                        echo '</div>';
                            }
                ...
                echo '<div class="container d-block d-sm-none">';
                    echo '<div class="row content  divitemover">';
                            echo '<div class="col-lg-12">';
                                ...
                                echo '<span class="itemsql">' . $item['usageparts'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Condition </span>';                        
                                echo '<span class="itemsql">' . $item['conditionparts'] . '</span>';                           
                            echo '</div>';
                            echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Seller Type </span>';                        
                                echo '<span class="itemsql">' . $item['sellertypeparts'] . '</span>';                           
                            echo '</div>';
                            if(!empty($item["extrasparts"]))
                            {
                                echo '<div class="col-lg-12">';
                                echo '<span class="itemall"> Extras </span>';                        
                                echo '<span class="itemsql">' . $item['extrasparts'] . '</span>';                           
                            echo '</div>';
                            }
    ...
    elseif($do == 'Update'){
        ...
        if(isset($_SESSION['uid']))
        {
          ...
          $useridd = $infoId['user_id'];
            ...
            $stmtitemadd = $con->prepare("INSERT INTO favorite(iditem, userid, favorite, nameitem) VALUES(:ziditem, :zuserid, 1, 'autoaccparts')");
