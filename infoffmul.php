    ...
    if($do == 'Add'){
                ...
                echo '<div class="container">';
                    echo '<div class="row content">';
                        ...
                        <ion-icon name="heart-outline" role="img" class="md hydrated" aria-label="heart outline" style="position: relative; left: -5px; top: 3px;"></ion-icon><a style="color:black; text-decoration:none;" href="infoffmul.php?do=Update&userid=' . $blog . '" >Favorite</a>
                        </span>
                            ...
                            echo '<div class="col-lg-12">';
                                echo '<div class="card  initial">';
                                    echo '<div class="row content">';
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                        echo '<div class="itemall"> Building </div>';                       
                                        echo '</div>';
                                        echo '<div class="col-lg-6">';
                                            echo '<div class="itemsql">' . $item['building'] . '</div>';                          
                                        echo '</div>';
                                    echo '</div>';
                                echo '</div>';
                            echo '</div>';
                ...
                echo '<div class="row content  divitemover">';
                                    echo '<div class="row content">';
                                        ...
                                        echo '</div>';
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Building </span>';                        
                                            echo '<span class="itemsqll">' . $item['building'] . '</span>';  
                                            echo '<hr>';                            
                                        echo '</div>';
                                    echo '</div>';
                echo '</div>'; 
