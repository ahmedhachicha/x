                                    ...
                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                        ...
                                        <div id="search-content">
                                                ...
                                                <input type="hidden" name="is_search" value="1">
                                                    <center><a href='eqbuclasslink.php?do=clear'>Clear Input</a></center>  
                            ...
                            <div class="container">    
                                <?php
                                                if($do == 'one'){
                                                    ...
                                                    where Approve = 1 AND typeclassifieds like '%eqbuclass%'");
                                                    $result1->execute();
                                                    ...
                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND typeclassifieds like '%eqbuclass%'", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                ...
                                                elseif($do == 'orderprice1'){
                                                    ...
                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND typeclassifieds like '%eqbuclass%'", '', "price DESC", "LIMIT 20");
                                                    foreach($allItems as $item)
                                                    {                                           
                                                        echo '<div class="col-lg-12 col-md-4 col-sm-12 col-xs-12" id="myList">';
                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                ...
                                                elseif($do == 'orderprice2'){
                                                    ...
                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND typeclassifieds like '%eqbuclass%'", '', "price ASC", "LIMIT 20");
                                                    foreach($allItems as $item)
                                                    {                                           
                                                        echo '<div class="col-lg-12 col-md-4 col-sm-12 col-xs-12" id="myList">';
                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                ...
                                                elseif($do == 'clear'){
                                                    header('Location:eqbuclasslink.php');
                                                    exit();                                                
                                                }     
                                                // location
                                                elseif($do == 'searchlocationcars1'){
                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                    {
                                                        ...
                                                        $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND typeclassifieds like '%eqbuclass%' AND locationcars like '%$locatecars%' order by Id DESC");
                                                        $stmt->execute();
                                                        $rows = $stmt->fetchAll(); 
                                                        if(!empty($rows)){
                                                            foreach($rows as $row)
