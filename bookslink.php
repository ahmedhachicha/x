<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Books online';
    include 'init.php';
?>
            <style>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Books </h1>
                                                <h2 class="div-pagecat"> Books on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                ...
                                                <div id="search-widget">
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                            <select id="site:swfield" name="type">
                                                                                <option value="Hardcover" selected>Type</option>
                                                                                <?php
                                                                                        $allUsers = getAllFrom("*", "type", "", "", "Id");
                                                                                        foreach($allUsers as $user){
                                                                                            echo "<option value='" . $user['Name'] . "'>" .$user['Name'] . "</option>";
                                                                                        }
                                                                                ?>
                                                                    ...
                                                                    <center><a href='bookslink.php?do=clear'>Clear Input</a></center>  
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Books</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%textbone%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="textbone" name="searchmakecars1">Textbooks<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%textbone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%textbtwo%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="textbtwo" name="searchmakecars1">Nonfiction<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%textbtwo%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%textbtree%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="textbtree" name="searchmakecars1">Fiction<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%textbtree%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%textbfor%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="textbfor" name="searchmakecars1">Children's Books<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%textbfor%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%textbfive%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="textbfive" name="searchmakecars1">Book Accessories<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%textbfive%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%textbsix%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="textbsix" name="searchmakecars1">Digital/E-books<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%textbsix%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%textbfin%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="textbfin" name="searchmakecars1">Audiobooks<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%textbfin%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%textbone%' OR typeclassifieds like '%textbtwo%' OR typeclassifieds like '%textbtree%' OR typeclassifieds like '%textbfor%' OR typeclassifieds like '%textbfive%' OR typeclassifieds like '%textbsix%' OR typeclassifieds like '%textbfin%')");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%textbone%' OR typeclassifieds like '%textbtwo%' OR typeclassifieds like '%textbtree%' OR typeclassifieds like '%textbfor%' OR typeclassifieds like '%textbfive%' OR typeclassifieds like '%textbsix%' OR typeclassifieds like '%textbfin%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%textbone%' OR typeclassifieds like '%textbtwo%' OR typeclassifieds like '%textbtree%' OR typeclassifieds like '%textbfor%' OR typeclassifieds like '%textbfive%' OR typeclassifieds like '%textbsix%' OR typeclassifieds like '%textbfin%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'resultsearch'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $type = $_POST['type'];
                                                                                ...
                                                                                $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND type like '%$type%' AND ((price BETWEEN '$pricegte' AND '$pricelte') OR locationcars = '$locatecars' OR location like '%$neighboarhood%')");
                                                                ...
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%textbone%' OR typeclassifieds like '%textbtwo%' OR typeclassifieds like '%textbtree%' OR typeclassifieds like '%textbfor%' OR typeclassifieds like '%textbfive%' OR typeclassifieds like '%textbsix%' OR typeclassifieds like '%textbfin%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Books in Ras al Khaimah</button>
                                                                    </form>
