<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Restoration & Repairs online';
    include 'init.php';
?>
            <style>
        ...
        <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
            <div class="container-fluid">
                <div class="row" style="padding-left:15px;">
                                    <center>
                                        <h1 class="h1-pagecat">Buy & sell any Restoration & Repairs </h1>
                                        <h2 class="div-pagecat"> Restoration & Repairs on Oh Yamal</h2>                    
                                    </center>
                    <div class="col-lg-2">
                                            ...
                                            <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                ...
                                                <div id="search-content">
                                                            ...
                                                            <div class="widget-dropdown" id="search-content-site">
                                                                <div class="search-dropdown">
                                                                    <select id="site:swfield" name="typecommunity">
                                                                        ...
                                                                        <option value="eltrcom" selected>Restoration & Repairs</option>
                                                        ...
                                                        <input type="hidden" name="is_search" value="1">
                                                            <center><a href='restorationlink.php?do=clear'>Clear Input</a></center>  
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="container" style="padding: 10px;">
                                <div class="row">
                                    <div class="col-lg-10">
                                        Browse results in: <a href="allcommunity.php">.. > Community > </a> <strong style="color: #626465;">Restoration & Repairs</strong>            
                                    </div>
                                    <div class="col-lg-2">
                            ...
                            <!-- <div class="container"> -->
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                                    ...
                                                    elseif($do == 'clear'){
                                                        header('Location:restorationlink.php');
                                                        exit();                                                
                                                    }     
                                                    // location
                                    ...
                                    ?>
                                                        <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                            ...
                                                                            Restoration & Repairs in Ajman</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                            ...
                                                                            Restoration & Repairs in Dubai</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                            ...
                                                                            Restoration & Repairs in Abu Dhabi</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                            ...
                                                                            Restoration & Repairs in Ras al Khaimah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                            ...
                                                                            Restoration & Repairs in Sharjah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                            ...
                                                                            Restoration & Repairs in Fujairah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                            ...
                                                                            Restoration & Repairs in Umm al Quwain</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                            ...
                                                                            Restoration & Repairs in Al Ain</button>
                                                        </form>
                                </div>  
                            <!-- </div>   -->
                            <!-- </div>   -->
