<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Heavy Vehicles online';
    include 'init.php';
?>
    ...
    <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
        <div class="container-fluid">
            <div class="row" style="padding-left:15px;">
                                <center>
                                    <h1 class="h1-pagecat">Buy & sell any Heavy Vehicles </h1>
                                    <h2 class="div-pagecat"> Heavy Vehicles on Oh Yamal</h2>                    
                                </center>
                <div class="col-lg-2">
                                            ...
                                            <div id="search-content">
                                                        ...
                                                        <div class="fields">
                                                                ...
                                                                <div class="widget-dropdown" id="search-content-site" style="margin-top: 15px;">
                                                                    <div class="search-dropdown">
                                                                        <select id="site:swfield" name="sellertypeheavy">
                                                    ...
                                                    <input type="hidden" name="is_search" value="1">
                                                        <center><a href='heavylink.php?do=clear'>Clear Input</a></center>  
                                            ...
                                            <div id="search-advanced">
                                                <div id="advanced-search-header" >
                                                    ...
                                                    <div id="" class="panel-body ppll">
                                                                ...
                                                                <div class="search-dropdown">
                                                                    <label class="heading">
                                                                        Model
                                                                            ...
                                                                            <input type="text" name="model" id="price__gte:swfield" autocomplete="off" class="as-input" placeholder="">
                                                                            <!-- <input type="hidden" class="as-values" name="places__id__in" id="as-values-id_places__id__in"></li></ul> -->
                                                                </div>

                                                                <div class="widget-dropdown" id="search-content-site">
                                                                    <div class="search-dropdown">
                                                                        <select id="site:swfield" name="cylindersheavy">
                                                                        <option selected value="4">No. of Cylinders</option>
                                                                        <?php
                                                                ...
                                                                <div class="widget-dropdown" id="search-content-site">
                                                                    <div class="search-dropdown">
                                                                        <select id="site:swfield" name="horsepower">
                                                                ...
                                                                <div class="widget-dropdown" id="search-content-site">
                                                                    <div class="search-dropdown">
                                                                        <select id="site:swfield" name="warrantyheavy">
                                                                ...
                                                                <div class="widget-dropdown" id="search-content-site">
                                                                    <div class="search-dropdown">
                                                                        <select id="site:swfield" name="fueltype">
                    ...
                    $sortt ='';
                            ...
                            <div class="card">
                                <div class="container" style="padding: 10px;">
                                    <div class="row">
                                        <div class="col-lg-10">
                                            Browse results in: <a href="allmotors.php">.. > Motors > </a> <strong style="color: #626465;">Heavy Vehicles</strong>            
                                        </div>
                                        <div class="col-lg-2">
                                                <span class="toggle-info pull-right">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <?php if(empty(countItemsmotheavy('typeheavy', 'heavyvzhicles', '%truchyvy%'))){}
                                                else{?>
                                                    <div class="col-lg-4">
                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="truchyvy" name="searchmakecars1">Trucks <span style="color: black;">(<?php echo countItemsmotheavy('typeheavy', 'heavyvzhicles', '%truchyvy%'); ?>)</span> </button></a>
                                                        </form>
                                                    </div>
                                                <?php } ?>

                                                <?php if(empty(countItemsmotheavy('typeheavy', 'heavyvzhicles', '%buseshyvy%'))){}
                                                else{?>
                                                    <div class="col-lg-4">
                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="buseshyvy" name="searchmakecars1">Buses<span style="color: black;">(<?php echo countItemsmotheavy('typeheavy', 'heavyvzhicles', '%buseshyvy%'); ?>)</span> </button></a>
                                                        </form>
                                                    </div>
                                                <?php } ?>

                                                <?php if(empty(countItemsmotheavy('typeheavy', 'heavyvzhicles', '%forklithyvy%'))){}
                                                else{?>
                                                    <div class="col-lg-4">
                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="forklithyvy" name="searchmakecars1">Forklifts<span style="color: black;">(<?php echo countItemsmotheavy('typeheavy', 'heavyvzhicles', '%forklithyvy%'); ?>)</span> </button></a>
                                                        </form>
                                                    </div>
                                                <?php } ?>

                                                <?php if(empty(countItemsmotheavy('typeheavy', 'heavyvzhicles', '%trailhyvy%'))){}
                                                else{?>
                                                    <div class="col-lg-4">
                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="trailhyvy" name="searchmakecars1">Trailers<span style="color: black;">(<?php echo countItemsmotheavy('typeheavy', 'heavyvzhicles', '%trailhyvy%'); ?>)</span> </button></a>
                                                        </form>
                                                    </div>
                                                <?php } ?>

                                                <?php if(empty(countItemsmotheavy('typeheavy', 'heavyvzhicles', '%craneshyvy%'))){}
                                                else{?>
                                                    <div class="col-lg-4">
                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="craneshyvy" name="searchmakecars1">Cranes<span style="color: black;">(<?php echo countItemsmotheavy('typeheavy', 'heavyvzhicles', '%craneshyvy%'); ?>)</span> </button></a>
                                                        </form>
                                                    </div>
                                                <?php } ?>

                                                <?php if(empty(countItemsmotheavy('typeheavy', 'heavyvzhicles', '%fiverhyvy%'))){}
                                                else{?>
                                                <div class="col-lg-4">
                                                    <form action="?do=searchmakecars1" method="POST">
                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="fiverhyvy" name="searchmakecars1">Tankers<span style="color: black;">(<?php echo countItemsmotheavy('typeheavy', 'heavyvzhicles', '%fiverhyvy%'); ?>)</span> </button></a>
                                                    </form>
                                                </div>
                                                <?php } ?>

                                                <?php if(empty(countItemsmotheavy('typeheavy', 'heavyvzhicles', '%parehyvy%'))){}
                                                else{?>
                                                    <div class="col-lg-4">
                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="parehyvy" name="searchmakecars1">Parts & Engines<span style="color: black;">(<?php echo countItemsmotheavy('typeheavy', 'heavyvzhicles', '%parehyvy%'); ?>)</span> </button></a>
                                                        </form>
                                                    </div>
                                                <?php } ?>

                                                <?php if(empty(countItemsmotheavy('typeheavy', 'heavyvzhicles', '%otherwinhyvy%'))){}
                                                else{?>
                                                    <div class="col-lg-4">
                                                        <form action="?do=searchmakecars1" method="POST">
                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="otherwinhyvy" name="searchmakecars1">Other Heavy Vehicles<span style="color: black;">(<?php echo countItemsmotheavy('typeheavy', 'heavyvzhicles', '%otherwinhyvy%'); ?>)</span> </button></a>
                                                        </form>
                                                    </div>
                                                <?php } ?>
                                                    </div>    
                                ...
                                <div class="container">    
                                    <?php
                                                    if($do == 'one'){
                                                        ...
                                                        $start = ($page - 1) * $limit;
                                                        $result1 = $con->prepare("SELECT count(Id) AS Id FROM heavyvzhicles
                                                        ...
                                                        $allItems = getAllFrom('*', 'heavyvzhicles', "where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                        foreach($allItems as $item)
                                                        {                                           
                                                            echo '<a href="infoheavy.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                                    ...
                                                                    echo '<div class="row">';
                                                                        echo '<div class="col-lg-4">';
                                                                            ...
                                                                            for($i = 0; $i<$count; ++$i)
                                                                            {
                                                                                echo  "<img class='card-img-top imgindexcard' src='admin/Update_Imageheavry/uploads/avatars/" . $res[$i] ."' alt='image' />";
                                                                        ...
                                                                        echo '<div class="col-lg-8">';
                                                                                        ...
                                                                                        echo '</div>';
                                                                            echo '<div class="row">';
                                                                                echo '<div class="col-lg-12">Year:' . '<strong>' . $item["Year"] . '</strong>' . '</div>';
                                                                                echo '<div class="col-lg-12">Kilometers:' . '<strong>' . $item['k_mi']. '</strong>' . '</div>';
                                                                            echo '</div>';
                                                                        echo '</div>';
                                                                    echo '</div>';
                                                                    echo '<div class="row">';
                                                    ...
                                                    if($do == 'orderprice1'){
                                                        ...
                                                        $allItems = getAllFrom('*', 'heavyvzhicles', "where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH)", '', " Price DESC", "LIMIT 20");
                                                        foreach($allItems as $item)
                                                        {                                           
                                                            echo '<a href="infoheavy.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                    ...
                                                    if($do == 'orderprice2'){
                                                        ...
                                                        $allItems = getAllFrom('*', 'heavyvzhicles', "where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) ", '', " Price ASC", "LIMIT 20");
                                                        foreach($allItems as $item)
                                                        {                                           
                                                            echo '<a href="infoheavy.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                echo '<div class="borderstyl" style="padding:15px;">';
                                                    ...
                                                    elseif($do == 'resultsearch'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM heavyvzhicles where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars like '%$locatecars%' AND (model like '%$model%' OR (Price BETWEEN '$pricegte' AND '$pricelte') OR (Year BETWEEN '$yeargte' AND '$yearlte') OR (k_mi  BETWEEN '$kilometersgte' AND '$kilometerslte') OR Location like '%$neighboarhood%' OR sellertypeheavy like '%$sellertypeheavy%' OR cylindersheavy like '%$cylindersheavy%' AND horsepower like '%$horsepower%' OR warrantyheavy like '%$warrantyheavy%' OR fueltype like '%$fueltype%')"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row)
                                                                {                                           
                                                                    echo '<a href="infoheavy.php?pageid=' . $row["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                            echo '<div class="row">';
                                                                                // echo '<div class="col-lg-2">Featured</div>';
                                                                                // echo '<div class="col-lg-10">History Check</div>';
                                                                            ...
                                                                            echo '<div class="row">';
                                                                                ...
                                                                                echo '<div class="col-lg-8">';
                                                                                                ...
                                                                                                echo '</div>';
                                                                                    echo '<div class="row">';
                                                                                        echo '<div class="col-lg-12">Year:' . '<strong>' . $row["Year"] . '</strong>' . '</div>';
                                                                                        echo '<div class="col-lg-12">Kilometers:' . '<strong>' . $row['k_mi']. '</strong>' . '</div>';
                                                                                    echo '</div>';
                                                                                echo '</div>';
                                                                            echo '</div>';
                                                                            echo '<div class="row">';
                                                    ...
                                                    elseif($do == 'search'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM heavyvzhicles where (Name like '%$all%' AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND Approve = 1) OR (Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND ((locationcars like '%$locatecars%') OR model like '%$all%' OR (Price BETWEEN '$pricegte' AND '$pricelte') OR (Year BETWEEN '$all' AND '$all') OR (k_mi  BETWEEN '$all' AND '$all') OR Location like '%$all%' OR sellertypeheavy like '%$sellertypeheavy%' OR cylindersheavy like '%$all%' AND horsepower like '%$all%' OR warrantyheavy like '%$all%' OR fueltype like '%$all%' OR typeheavy like '%$typeheavy%')) order by Id DESC"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row)
                                                    ...
                                                    elseif($do == 'searchlocationcars1'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM heavyvzhicles where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND locationcars like '%$locatecars%'"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row)
                                                    ...
                                                    elseif($do == 'searchmakecars1'){
                                                        if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                        {
                                                            ...
                                                            $stmt = $con->prepare("SELECT * FROM heavyvzhicles where Approve = 1 AND Add_date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeheavy like '%$make%'"); 
                                                            $stmt->execute();
                                                            $rows = $stmt->fetchAll(); 
                                                            if(!empty($rows)){
                                                                foreach($rows as $row)
                                    ...
                                    ?>
                                                        <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                            ...
                                                                            Heavy Vehicles in Ajman</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                            ...
                                                                            Heavy Vehicles in Dubai</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                            ...
                                                                            Heavy Vehicles in Abu Dhabi</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                            ...
                                                                            Heavy Vehicles in Ras al Khaimah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                            ...
                                                                            Heavy Vehicles in Sharjah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                            ...
                                                                            Heavy Vehicles in Fujairah</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                            ...
                                                                            Heavy Vehicles in Umm al Quwain</button>
                                                        </form>
                                                        <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                            ...
                                                                            Heavy Vehicles in Al Ain</button>
                                                        </form>
                                </div>  
                            </div>  
                </div>
                                                                                                    ...
                                                                                                    <div class="search-dropdown" style="margin-top: 15px;">
                                                                                                        <label class="heading">
                                                                                                            Model
                                                                                                                ...
                                                                                                                <input type="text" name="model" id="price__gte:swfield" autocomplete="off" class="as-input" placeholder="" style="width: 90%;margin-top: 10px;">
                                                                                                                <!-- <input type="hidden" class="as-values" name="places__id__in" id="as-values-id_places__id__in"></li></ul> -->
                                                                                                    </div>
