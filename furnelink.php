<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Furniture, Home & Garden online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Furniture, Home & Garden </h1>
                                                <h2 class="div-pagecat"> Furniture, Home & Garden on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='furnelink.php?do=clear'>Clear Input</a></center>  
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%furclss%'");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%furclss%'", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%furclss%'", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%furclss%'", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%furclss%' AND locationcars like '%$locatecars%' order by Id DESC");
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                                        ...
                                                                                        Furniture, Home & Garden in UAE</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                                        ...
                                                                                        Furniture, Home & Garden in Dubai</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        Furniture, Home & Garden in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Furniture, Home & Garden in Ras al Khaimah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                        ...
                                                                                        Furniture, Home & Garden in Sharjah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        Furniture, Home & Garden in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        Furniture, Home & Garden in Umm al Quwain</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                        ...
                                                                                        Furniture, Home & Garden in Al Ain</button>
                                                                    </form>
                                            </div>  
                                        </div>  
                            </div>
