<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Computers & Networking online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Computers & Networking </h1>
                                                <h2 class="div-pagecat"> Computers & Networking on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                            <select id="site:swfield" name="typeclassifieds">
                                                                                <option value="Comscll" selected>Computers</option>
                                                                                <option value="comjl">Computer Components</option>
                                                                                <option value="accsbg">Accessories</option>
                                                                                <option value="ntrko">Networking & Communication</option>
                                                                                <option value="softcm">Software</option>
                                                                                <option value="monitcm">Monitors, Printers & Other Peripherals</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='compnetlink.php?do=clear'>Clear Input</a></center>  
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Computers & Networking</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                            <span class="toggle-info pull-right">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Comscll%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Comscll" name="searchmakecars1">Computers<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Comscll%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%comjl%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="comjl" name="searchmakecars1">Computer Components<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%comjl%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%accsbg%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="accsbg" name="searchmakecars1">Accessories<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%accsbg%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%ntrko%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="ntrko" name="searchmakecars1">Networking & Communication<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%ntrko%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%softcm%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="softcm" name="searchmakecars1">Software<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%softcm%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%monitcm%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="monitcm" name="searchmakecars1">Monitors, Printers & Other Peripherals<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%monitcm%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%Comscll%' OR typeclassifieds like '%comjl%'  OR typeclassifieds like '%accsbg%' OR typeclassifieds like '%ntrko%' OR typeclassifieds like '%softcm%' OR typeclassifieds like '%monitcm%')");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%Comscll%' OR typeclassifieds like '%comjl%'  OR typeclassifieds like '%accsbg%' OR typeclassifieds like '%ntrko%' OR typeclassifieds like '%softcm%' OR typeclassifieds like '%monitcm%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                            ...
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                                ...
                                                                                echo '<div class="row">';
                                                                                    ...
                                                                                    echo '<div class="col-lg-8">';
                                                                                        ...
                                                                                        echo '</div>';
                                                                                        echo '<div class="row">';
                                                                                            echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Age :' . '<strong>' . $item["ageclassifieds"] . '</strong>' . '</div>';
                                                                                            echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Condition :' . '<strong>' . $item['conditionclassifieds']. '</strong>' . '</div>';
                                                                                            echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Usage :' . '<strong>' . $item['usageclassifieds']. '</strong>' . '</div>';
                                                                                            if(empty($item['brandclassifieds'])){
                                                                                                
                                                                                            }   
                                                                                            else{
                                                                                                echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Brand :' . '<strong>' . $item['brandclassifieds']. '</strong>' . '</div>';
                                                                                            }  
                                                                                        echo '</div>';
                                                                                    echo '</div>';
                                                                                echo '</div>';
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%Comscll%' OR typeclassifieds like '%comjl%'  OR typeclassifieds like '%accsbg%' OR typeclassifieds like '%ntrko%' OR typeclassifieds like '%softcm%' OR typeclassifieds like '%monitcm%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%Comscll%' OR typeclassifieds like '%comjl%'  OR typeclassifieds like '%accsbg%' OR typeclassifieds like '%ntrko%' OR typeclassifieds like '%softcm%' OR typeclassifieds like '%monitcm%')", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                                            ...
                                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                                                ...
                                                                                                echo '<div class="row">';
                                                                                                    ...
                                                                                                    echo '<div class="col-lg-8">';
                                                                                                        ...
                                                                                                        echo '</div>';
                                                                                                        echo '<div class="row">';
                                                                                                            echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Age :' . '<strong>' . $row["ageclassifieds"] . '</strong>' . '</div>';
                                                                                                            echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Condition :' . '<strong>' . $row['conditionclassifieds']. '</strong>' . '</div>';
                                                                                                            echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Usage :' . '<strong>' . $row['usageclassifieds']. '</strong>' . '</div>';
                                                                                                            if(empty($row['brandclassifieds'])){
                                                                                                                
                                                                                                            }   
                                                                                                            else{
                                                                                                                echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Brand :' . '<strong>' . $row['brandclassifieds']. '</strong>' . '</div>';
                                                                                                            }  
                                                                                                        echo '</div>';
                                                                                                    echo '</div>';
                                                                                                echo '</div>';
                                                                ...
                                                                elseif($do == 'clear'){
                                                                    header('Location:compnetlink.php');
                                                                    exit();                                                
                                                                }     
                                                                // location
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%Comscll%' OR typeclassifieds like '%comjl%'  OR typeclassifieds like '%accsbg%' OR typeclassifieds like '%ntrko%' OR typeclassifieds like '%softcm%' OR typeclassifieds like '%monitcm%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        Classifieds in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Classifieds in Ras al Khaimah</button>
                                                                    </form>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        Classifieds in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        Classifieds in Umm al Quwain</button>
                                                                    </form>
