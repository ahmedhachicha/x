<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Commercial for Sale online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                                <center>
                                                    <h1 class="h1-pagecat">Buy & sell any Commercial for Sale </h1>
                                                    <h2 class="div-pagecat"> Commercial for Sale on Oh Yamal</h2>                    
                                                </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                            ...
                                                                            <div class="widget-dropdown no-arrow" id="search-content-c1">
                                                                                <div class="search-dropdown">
                                                                                    <select id="site:swfield" name="typeforsale">
                                                                                        <option value="Office for Sale comrl" selected>Office for Sale</option>
                                                                                        <option value="Retail for Sale comrl">Retail for Sale</option>
                                                                                        <option value="Industrial for Sale comrl">Industrial for Sale</option>
                                                                                        <option value="Staff Accomm for Sale comrl">Staff Accomm for Sale</option>
                                                                                        <option value="Shop comrl">Shop</option>
                                                                                        <option value="Warehouse comrl">Warehouse</option>
                                                                                        <option value="Commercial Floor comrl">Commercial Floor</option>
                                                                                        <option value="Commercial Building comrl">Commercial Building</option>
                                                                                        <option value="Commercial Villa comrl">Commercial Villa</option>
                                                                                        <option value="Factory comrl">Factory</option>
                                                                                        <option value="Other comrl">Other</option>
                                                                                        <option value="Showroom comrl">Showroom</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="widget-dropdown no-arrow" id="search-content-c1">
                                                                                <div class="search-dropdown">
                                                                                    <select id="site:swfield" name="extrasforsale">
                                                                                        <option value="Available Furnished" selected> Extras For Sale</option>
                                                                                        <option value="Available Furnished"> Available Furnished</option>
                                                                                        <option value="Available Networked">Available Networked</option>
                                                                                        <option value="Conference Room">Conference Room</option>
                                                                                        <option value="Covered Parking">Covered Parking</option>
                                                                                        <option value="Dining in Building">Dining in Building</option>
                                                                                        <option value="Retail in Building">Retail in Building</option>
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='comffsale.php?do=clear'>Clear Input</a></center>  
                                                        ...
                                                        <div id="search-advanced">
                                                            <div id="advanced-search-header" >
                                                                ...
                                                                <div id="" class="panel-body ppll">
                                                                            ...
                                                                            <center><a href='rescomffsale.php?do=clear'>Clear Input</a></center>      
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                            <div class="col-lg-10">
                                                                Browse results in: <a href="allforsale.php">.. > Properties for Sale > </a> <strong style="color: #626465;"> Commercial for Sale</strong>            
                                                            </div>
                                                            <div class="col-lg-2">
                                                                    <span class="toggle-info pull-right">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Apartment for Sale comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Apartment for Sale comrl" name="searchmakecars1">Apartment for Sale <span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Apartment for Sale comrl%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php } ?>

                                                                        <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Office for Sale comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Office for Sale comrl" name="searchmakecars1">Office for Sale<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Office for Sale comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Retail for Sale comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Retail for Sale comrl" name="searchmakecars1">Retail for Sale<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Retail for Sale comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Industrial for Sale comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Industrial for Sale comrl" name="searchmakecars1">Industrial for Sale<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Industrial for Sale comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Staff Accomm for Sale comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Staff Accomm for Sale comrl" name="searchmakecars1">Staff Accomm for Sale<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Staff Accomm for Sale comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Shop comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Shop comrl" name="searchmakecars1">Shop<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Shop comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Warehouse comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Warehouse comrl" name="searchmakecars1">Warehouse<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Warehouse comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Commercial Floor comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Commercial Floor comrl" name="searchmakecars1">Commercial Floor<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Commercial Floor comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Commercial Building comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Commercial Building comrl" name="searchmakecars1">Commercial Building<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Commercial Building comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Commercial Villa comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Commercial Villa comrl" name="searchmakecars1">Commercial Villa<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Commercial Villa comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Factory comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Factory comrl" name="searchmakecars1">Factory<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Factory comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Other comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Other comrl" name="searchmakecars1">Other<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Other comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>

                                                                    <?php if(empty(countItemsmotforsale('typeforsale', 'forsale', '%Showroom comrl%'))){}  
                                                                    
                                                                    else{ ?>
                                                                    <div class="col-lg-4">
                                                                        <form action="?do=searchmakecars1" method="POST">
                                                                                            <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Showroom comrl" name="searchmakecars1"> Showroom<span style="color: black;">(<?php echo countItemsmotforsale('typeforsale', 'forsale', '%Showroom comrl%'); ?>)</span> </button></a>
                                                                        </form>
                                                                    </div>
                                                                    <?php } ?>
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%comrl%'");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'forsale', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%comrl%'", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'forsale', 'where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like "%comrl%"', '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoforsale.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'forsale', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%comrl%'", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoforsale.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM forsale where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeforsale like '%comrl%' AND locationcars like '%$locatecars%'"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
