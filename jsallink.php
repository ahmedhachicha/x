<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Sales online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Sales </h1>
                                                <h2 class="div-pagecat"> Sales on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        ...
                                                                        <select id="site:swfield" name="typejobs">
                                                                                ...
                                                                                <option value="cctslj" selected>Sales</option>
                                            ...
                                            <div class="container">    
                                                ...
                                                ?>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Sales in Ras al Khaimah</button>
                                                                    </form>
