<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Clothing & Accessories online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Clothing & Accessories </h1>
                                                <h2 class="div-pagecat"> Clothing & Accessories on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                            <select id="site:swfield" name="typeclassifieds">
                                                                                <option value="shoesfclss" selected>Shoes/Footwear</option>
                                                                                <option value="clthclss">Clothing</option>
                                                                                <option value="handbclss">Handbags, Bags & Wallets</option>
                                                                                <option value="menaeiclss">Men's Accessories</option>
                                                                                <option value="womeiclss">Women's Accessories</option>
                                                                                <option value="luggageclss">Luggage</option>
                                                                                <option value="frgclss">Fragrances</option>
                                                                                <option value="weddapclss">Wedding Apparel</option>
                                                                                <option value="costhclss">Costumes & Uniforms</option>
                                                                                <option value="vinthclss">Vintage & Highend Clothing</option>
                                                                                <option value="mkupclss">Make up & Skin Care</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='cltingacclink.php?do=clear'>Clear Input</a></center>  
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Clothing & Accessories</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                            <span class="toggle-info pull-right">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%shoesfclss%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="shoesfclss" name="searchmakecars1">Shoes/Footwear<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%shoesfclss%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%clthclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="clthclss" name="searchmakecars1">Clothing<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%clthclss%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%handbclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="handbclss" name="searchmakecars1">Handbags, Bags & Wallets<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%handbclss%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%menaeiclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                                <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="menaeiclss" name="searchmakecars1">Men's Accessories<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%menaeiclss%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%womeiclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="womeiclss" name="searchmakecars1">Women's Accessories<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%womeiclss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 

                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%luggageclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="luggageclss" name="searchmakecars1">Luggage<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%luggageclss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?> 
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%frgclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="frgclss" name="searchmakecars1">Fragrances<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%frgclss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%weddapclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="weddapclss" name="searchmakecars1">Wedding Apparel<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%weddapclss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%costhclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="costhclss" name="searchmakecars1">Costumes & Uniforms<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%costhclss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%vinthclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="vinthclss" name="searchmakecars1">Vintage & Highend Clothing<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%vinthclss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%mkupclss%');
                                                                        if($var != 0){
                                                                            ?> 
                                                                            <div class="col-lg-4">
                                                                                <form action="?do=searchmakecars1" method="POST">
                                                                                                    <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="mkupclss" name="searchmakecars1">Make up & Skin Care<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%mkupclss%'); ?>)</span> </button></a>
                                                                                </form>
                                                                            </div>
                                                                    <?php }
                                                                    ?>
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%shoesfclss%' OR typeclassifieds like '%clthclss%'  OR typeclassifieds like '%handbclss%' OR typeclassifieds like '%menaeiclss%' OR typeclassifieds like '%womeiclss%' OR typeclassifieds like '%luggageclss%' OR typeclassifieds like '%frgclss%' OR typeclassifieds like '%weddapclss%' OR typeclassifieds like '%costhclss%' OR typeclassifieds like '%vinthclss%' OR typeclassifieds like '%mkupclss%')");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%shoesfclss%' OR typeclassifieds like '%clthclss%'  OR typeclassifieds like '%handbclss%' OR typeclassifieds like '%menaeiclss%' OR typeclassifieds like '%womeiclss%' OR typeclassifieds like '%luggageclss%' OR typeclassifieds like '%frgclss%' OR typeclassifieds like '%weddapclss%' OR typeclassifieds like '%costhclss%' OR typeclassifieds like '%vinthclss%' OR typeclassifieds like '%mkupclss%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                                ...
                                                                                echo '<div class="row">';
                                                                                    ...
                                                                                    echo '<div class="col-lg-8">';
                                                                                        ...
                                                                                        echo '<div class="row">';
                                                                                            ...
                                                                                            if(empty($item['brandclassifieds'])){
                                                                                                
                                                                                            }   
                                                                                            else{
                                                                                                echo '<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">Brand :' . '<strong>' . $item['brandclassifieds']. '</strong>' . '</div>';
                                                                                            }  
                                                                                        echo '</div>';
                                                                                    echo '</div>';
                                                                                echo '</div>';
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%shoesfclss%' OR typeclassifieds like '%clthclss%'  OR typeclassifieds like '%handbclss%' OR typeclassifieds like '%menaeiclss%' OR typeclassifieds like '%womeiclss%' OR typeclassifieds like '%luggageclss%' OR typeclassifieds like '%frgclss%' OR typeclassifieds like '%weddapclss%' OR typeclassifieds like '%costhclss%' OR typeclassifieds like '%vinthclss%' OR typeclassifieds like '%mkupclss%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%shoesfclss%' OR typeclassifieds like '%clthclss%'  OR typeclassifieds like '%handbclss%' OR typeclassifieds like '%menaeiclss%' OR typeclassifieds like '%womeiclss%' OR typeclassifieds like '%luggageclss%' OR typeclassifieds like '%frgclss%' OR typeclassifieds like '%weddapclss%' OR typeclassifieds like '%costhclss%' OR typeclassifieds like '%vinthclss%' OR typeclassifieds like '%mkupclss%')", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
                                                                                                    ...
                                                                                                    echo '<div class="col-lg-8">';
                                                                                                        ...
                                                                                                        echo '<div class="row">';
                                                                                                            ...
                                                                                                            if(empty($row['brandclassifieds'])){
                                                                                                                ...
                                                                                                                echo '<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">Brand :' . '<strong>' . $row['brandclassifieds']. '</strong>' . '</div>';
                                                                                                            }  
                                                                                                        echo '</div>';
                                                                                                    echo '</div>';
                                                                                                echo '</div>';
                                                                ...
                                                                elseif($do == 'clear'){
                                                                    header('Location:cltingacclink.php');
                                                                    exit();                                                
                                                                }     
                                                                // location
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%shoesfclss%' OR typeclassifieds like '%clthclss%'  OR typeclassifieds like '%handbclss%' OR typeclassifieds like '%menaeiclss%' OR typeclassifieds like '%womeiclss%' OR typeclassifieds like '%luggageclss%' OR typeclassifieds like '%frgclss%' OR typeclassifieds like '%weddapclss%' OR typeclassifieds like '%costhclss%' OR typeclassifieds like '%vinthclss%' OR typeclassifieds like '%mkupclss%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars1" method="POST">
                                                                                        ...
                                                                                        Clothing & Accessories in Ajman</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars2" method="POST">
                                                                                        ...
                                                                                        Clothing & Accessories in Dubai</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        Clothing & Accessories in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Clothing & Accessories in Ras al Khaimah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                        ...
                                                                                        Clothing & Accessories in Sharjah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        Clothing & Accessories in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        Clothing & Accessories in Umm al Quwain</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                        ...
                                                                                        Clothing & Accessories in Al Ain</button>
                                                                    </form>
                                            </div>  
                                        </div>  
                            </div>
