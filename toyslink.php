<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Toys online';
    include 'init.php';
?>
            ...
            <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                <div class="container-fluid">
                    <div class="row" style="padding-left:15px;">
                                        <center>
                                            <h1 class="h1-pagecat">Buy & sell any Toys </h1>
                                            <h2 class="div-pagecat"> Toys on Oh Yamal</h2>                    
                                        </center>
                        <div class="col-lg-2">
                                                ...
                                                <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                    ...
                                                    <div id="search-content">
                                                                ...
                                                                <div class="widget-dropdown" id="search-content-site">
                                                                    <div class="search-dropdown">
                                                                        <select id="site:swfield" name="typeclassifieds">
                                                                            <option value="Electronic & Remote Control Toys tyss" selected>Electronic & Remote Control Toys</option>
                                                                            <option value="Action Figures & Toy Vehicles tyss">Action Figures & Toy Vehicles</option>
                                                                            <option value="Outdoor Toys & Structures tyss">Outdoor Toys & Structures</option>
                                                                            <option value="Hobbies">Hobbies</option>
                                                                            <option value="Pretend Play & Preschool Toys tyss">Pretend Play & Preschool Toys</option>
                                                                            <option value="Educational Toys tyss">Educational Toys</option>
                                                                            <option value="Dolls & Stuffed Animals tyss">Dolls & Stuffed Animals</option>
                                                                            <option value="Games & Puzzles tyss">Games & Puzzles</option>
                                                                            <option value="Classic & Vintage Toys tyss">Classic & Vintage Toys</option>
                                                                            <option value="Building Toys tyss">Building Toys</option>
                                                                            <option value="Other tyss">Other</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <input type="hidden" name="is_search" value="1">
                                                                <center><a href='toyslink.php?do=clear'>Clear Input</a></center>  
                                        ...
                                        <div class="container">    
                                            <?php
                                                            if($do == 'one'){
                                                                ...
                                                                where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%tyss%'");
                                                                $result1->execute();
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%tyss%'", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                            ...
                                                            elseif($do == 'orderprice1'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%tyss%'", '', "price DESC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                            ...
                                                            elseif($do == 'orderprice2'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%tyss%'", '', "price ASC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                            ...
                                                            elseif($do == 'searchlocationcars1'){
                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                {
                                                                    ...
                                                                    $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%tyss%' AND locationcars like '%$locatecars%' order by Id DESC"); 
                                                                    $stmt->execute();
                                                                    $rows = $stmt->fetchAll(); 
                                                                    if(!empty($rows)){
                                                                        foreach($rows as $row)
