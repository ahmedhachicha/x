<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Construction online';
    include 'init.php';
?>
            <style>
                button.flame-button.flame-button--tertiary.flame-button--medium.btnshar { margin-top: 20px;}
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    ...
                    <center>
                                            <h1 class="h1-pagecat">Buy & sell any Construction </h1>
                                            <h2 class="div-pagecat"> Construction on Oh Yamal</h2>                    
                                        </center>
                        <div class="col-lg-2">
                                                ...
                                                <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                    ...
                                                    <div id="search-content">
                                                                ...
                                                                <div class="widget-dropdown" id="search-content-site">
                                                                    <div class="search-dropdown">
                                                                        <select id="site:swfield" name="typeclassifieds">
                                                                            ...
                                                                            <option value="Constructionn" selected>Construction</option>
                                                            ...
                                                            <input type="hidden" name="is_search" value="1">
                                                                <center><a href='foodbvlink.php?do=clear'>Clear Input</a></center>  
                            ...
                            $sortt ='';
                                    ...
                                    <div class="card">
                                        <div class="container" style="padding: 10px;">
                                            <div class="row">
                                                <div class="col-lg-10">
                                                    Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Construction</strong>            
                                                </div>
                                                <div class="col-lg-2">
                                                        <span class="toggle-info pull-right">
                                        ...
                                        <div class="container">    
                                            <?php
                                                            if($do == 'one'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND typeclassifieds like '%Constructionn%'", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                            ...
                                                            elseif($do == 'orderprice1'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND typeclassifieds like '%Constructionn%'", '', "price DESC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                            ...
                                                            elseif($do == 'orderprice2'){
                                                                ...
                                                                $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND typeclassifieds like '%Constructionn%'", '', "price ASC", "LIMIT 20");
                                                                foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                            ...
                                                            elseif($do == 'clear'){
                                                                header('Location:foodbvlink.php');
                                                                exit();                                                
                                                            }     
                                                            // location
                                                            elseif($do == 'searchlocationcars1'){
                                                                if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                {
                                                                    ...
                                                                    $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND typeclassifieds like '%Constructionn%' AND locationcars like '%$locatecars%' order by Id DESC");
                                                                    $stmt->execute();
                                                                    $rows = $stmt->fetchAll(); 
                                                                    if(!empty($rows)){
                                                                        foreach($rows as $row)
                                            ...
                                            ?>
                                                                ...
                                                                <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                    ...
                                                                                    Construction in Abu Dhabi</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                    ...
                                                                                    Construction in Ras al Khaimah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                    ...
                                                                                    Construction in Sharjah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                    ...
                                                                                    Construction in Fujairah</button>
                                                                </form>
                                                                <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                    ...
                                                                                    Construction in Umm al Quwain</button>
                                                                </form>
