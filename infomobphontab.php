                            ...
                            if(empty($item["modelclassifieds"])){
                                ...
                                echo '<div class="col-lg-2 ">';
                                    echo '<div class="card cardstyl  initial">';
                                        ...
                                        echo '<div class="itemdiv">' . $item["modelclassifieds"] . '</div>';                            
                                    echo '</div>';
                                echo '</div>';                                
                            }
                ...
                echo '<div class="row content  divitemover">';
                                    ...
                                    if(empty($item['modelclassifieds'])){
                                        ...
                                        echo '<div class="col-lg-12">';
                                            echo '<span class="itemalll"> Model </span>';                        
                                            echo '<span class="itemsqll">' . $item['modelclassifieds'] . '</span>';
                                            echo '<hr>';                         
                                        echo '</div>';
                                    }
                ...
                echo '<div class="container">';
                    echo '<div class="row content  divitemover">';
                        echo '<div class="col-lg-9">';echo '<br><hr>';
                            echo '<div class="row content">';
                                echo '<div class="col-lg-12">';
                                    // echo '<h5 style="width: 40ch; overflow: hidden;
                                    // white-space: nowrap;
                                    // text-overflow: ellipsis;">Description</h5>';
