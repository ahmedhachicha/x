<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Baby Items online';
    include 'init.php';
?>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Baby Items </h1>
                                                <h2 class="div-pagecat"> Baby Items on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                            <select id="site:swfield" name="typeclassifieds">
                                                                                <option value="strllby" selected>Strollers & Car Seats</option>
                                                                                <option value="nuryby">Nursery Furniture & Accessories</option>
                                                                                <option value="gearby">Baby Gear</option>
                                                                                <option value="toysby">Baby Toys</option>
                                                                                <option value="feedingby">Feeding</option>
                                                                                <option value="sfthby">Safety & Health</option>
                                                                                <option value="bathdby">Bath & Diapers</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='babyitemlink.php?do=clear'>Clear Input</a></center>  
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allclassifieds.php">.. > Classifieds > </a> <strong style="color: #626465;">Baby Items</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                            <span class="toggle-info pull-right">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%strllby%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="strllby" name="searchmakecars1">Strollers & Car Seats<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%strllby%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%nuryby%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="nuryby" name="searchmakecars1">Nursery Furniture & Accessories<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%nuryby%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%gearby%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="gearby" name="searchmakecars1">Baby Gear<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%gearby%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%toysby%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="toysby" name="searchmakecars1">Baby Toys<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%toysby%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%feedingby%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="feedingby" name="searchmakecars1">Feeding<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%feedingby%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%sfthby%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="sfthby" name="searchmakecars1">safety & Health<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%sfthby%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%bathdby%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="bathdby" name="searchmakecars1">Bath & Diapers<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%bathdby%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%strllby%' OR typeclassifieds like '%nuryby%'  OR typeclassifieds like '%gearby%' OR typeclassifieds like '%toysby%' OR typeclassifieds like '%feedingby%' OR typeclassifieds like '%sfthby%' OR typeclassifieds like '%bathdby%')");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%strllby%' OR typeclassifieds like '%nuryby%'  OR typeclassifieds like '%gearby%' OR typeclassifieds like '%toysby%' OR typeclassifieds like '%feedingby%' OR typeclassifieds like '%sfthby%' OR typeclassifieds like '%bathdby%')", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                                                            </div>';
                                                                                echo '</div>';
                                                                            echo '</div>';
                                                                            echo '<hr>';
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%strllby%' OR typeclassifieds like '%nuryby%'  OR typeclassifieds like '%gearby%' OR typeclassifieds like '%toysby%' OR typeclassifieds like '%feedingby%' OR typeclassifieds like '%sfthby%' OR typeclassifieds like '%bathdby%')", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND (typeclassifieds like '%strllby%' OR typeclassifieds like '%nuryby%'  OR typeclassifieds like '%gearby%' OR typeclassifieds like '%toysby%' OR typeclassifieds like '%feedingby%' OR typeclassifieds like '%sfthby%' OR typeclassifieds like '%bathdby%')", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                    {                                           
                                                                        echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                            echo '<div class="borderstyl" style="padding:15px;">';
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                                ...
                                                                elseif($do == 'clear'){
                                                                    header('Location:babyitemlink.php');
                                                                    exit();                                                
                                                                }     
                                                                // location
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where (Approve = 1) AND (typeclassifieds like '%strllby%' OR typeclassifieds like '%nuryby%'  OR typeclassifieds like '%gearby%' OR typeclassifieds like '%toysby%' OR typeclassifieds like '%feedingby%' OR typeclassifieds like '%sfthby%' OR typeclassifieds like '%bathdby%') AND (locationcars like '%$locatecars%') order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
 ...
 style="margin-top:10px;" ><span class="featured_span">Featured</span>
                                                ...
                                                ?>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        Baby Items in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Baby Items in Ras al Khaimah</button>
                                                                    </form>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        Baby Items in Umm al Quwain</button>
                                                                    </form>
