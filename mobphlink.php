<?php 
    ...
    session_start();
    $Navbar = '';
    $pageTitle = 'Buy & sell any Mobile Phones online';
    include 'init.php';
?>
            <style>
                ...
                <div class="d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block">
                    <div class="container-fluid">
                        <div class="row" style="padding-left:15px;">
                                            <center>
                                                <h1 class="h1-pagecat">Buy & sell any Mobile Phones </h1>
                                                <h2 class="div-pagecat"> Mobile Phones on Oh Yamal</h2>                    
                                            </center>
                            <div class="col-lg-2">
                                                    ...
                                                    <form id="search-widget-form" action="?do=resultsearch" method="POST">
                                                        ...
                                                        <div id="search-content">
                                                                    ...
                                                                    <div class="widget-dropdown" id="search-content-site">
                                                                        <div class="search-dropdown">
                                                                            <select id="site:swfield" name="typeclassifieds">
                                                                                <option value="MobPhone" selected>Mobile Phones</option>
                                                                                <option value="MPTAccess">Mobile Phone & Tablet Accessories</option>
                                                                                <option value="Tablls">Tablets</option>
                                                                                <option value="MPTfin">Other Mobile Phones & Tablets</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <input type="hidden" name="is_search" value="1">
                                                                    <center><a href='mobphlink.php?do=clear'>Clear Input</a></center>  
                                                        ...
                                                        <div id="search-advanced">
                                                            <div id="advanced-search-header" >
                                                                ...
                                                                <div id="" class="panel-body ppll">
                                                                            ...
                                                                            <div class="widget-dropdown" id="search-content-site">
                                                                                <div class="search-dropdown">
                                                                                    <select id="site:swfield" name="warrantyclassifieds">
                                                                            ...
                                                                            <div class="widget-dropdown" id="search-content-site">
                                                                                <div class="search-dropdown">
                                                                                    <select id="site:swfield" name="colorclassifieds">
                                                                                    <option selected value="Black">Color</option>
                                                                                    <?php
                                                                            ...
                                                                            <div class="widget-dropdown" id="search-content-site">
                                                                                <div class="search-dropdown">
                                                                                    <select id="site:swfield" name="memoryclassifieds">
                                                                                    <option selected value="8 GB and more">Memory</option>
                                                                                    <?php
                                ...
                                $sortt ='';
                                        ...
                                        <div class="card">
                                            <div class="container" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        Browse results in: <a href="allmob.php">.. > Classifieds > Mobile Phones & Tablets > </a> <strong style="color: #626465;">Mobile Phones</strong>            
                                                    </div>
                                                    <div class="col-lg-2">
                                                            <span class="toggle-info pull-right">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Acer MobPhone%');
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Acer MobPhone" name="searchmakecars1">Acer<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Acer MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Alcatel MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Alcatel MobPhone" name="searchmakecars1">Alcatel<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Alcatel MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Apple iPhone MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Apple iPhone MobPhone" name="searchmakecars1">Apple iPhone<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Apple iPhone MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Asus MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Asus MobPhone" name="searchmakecars1">Asus<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Asus MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Blackberry MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Blackberry MobPhone" name="searchmakecars1">Blackberry<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Blackberry MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%CAT MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="CAT MobPhone" name="searchmakecars1">CAT<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%CAT MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%CECT MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="CECT MobPhone" name="searchmakecars1">CECT<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%CECT MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Google MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Google MobPhone" name="searchmakecars1">Google<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Google MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%HTC MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="HTC MobPhone" name="searchmakecars1">HTC<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%HTC MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Hewlett Packard MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Hewlett Packard MobPhone" name="searchmakecars1">Hewlett Packard<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Hewlett Packard MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Huawei MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Huawei MobPhone" name="searchmakecars1">Huawei<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Huawei MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                                    <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%LG MobPhone%');    
                                                                        if($var != 0){
                                                                            ?> <div class="col-lg-4">
                                                                                    <form action="?do=searchmakecars1" method="POST">
                                                                                        <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="LG MobPhone" name="searchmakecars1">LG<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%LG MobPhone%'); ?>)</span> </button></a>
                                                                                    </form>
                                                                                </div>

                                                                    <?php }
                                                                    ?>
                                                            <!-- if(empty(countItemsclassifieds('typeclassifieds', 'classifieds', ' typeclassifieds like "%Other MobPhone%" OR typeclassifieds like "%iMate MobPhone%" OR typeclassifieds like "%Yota MobPhone%" OR typeclassifieds like "%Xiaomi MobPhone%" OR typeclassifieds like "%Vivo MobPhone%" OR typeclassifieds like "%Vertu MobPhone%" OR typeclassifieds like "%Sony Ericsson MobPhone%" OR typeclassifieds like "%Sidekick MobPhone%" OR typeclassifieds like "%Sanyo MobPhone%" OR typeclassifieds like "%Samsung MobPhone%" OR typeclassifieds like "%Realme MobPhone%" OR typeclassifieds like "%Palm MobPhone%" OR typeclassifieds like "%Oppo MobPhone%" OR typeclassifieds like "%OnePlus MobPhone%" OR typeclassifieds like "%Nokia MobPhone%" OR typeclassifieds like "%Motorola MobPhone%" OR typeclassifieds like "%Meizu MobPhone%" OR typeclassifieds like "%Lenovo MobPhone%" OR typeclassifieds like "%Lava MobPhone%"'))) -->
                                                                    <div class="container">
                                                                            <center>
                                                                        ...
                                                                        <div class="row panel-bodyy pplll">
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Lava MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Lava MobPhone" name="searchmakecars1">Lava<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Lava MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Lenovo MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Lenovo MobPhone" name="searchmakecars1">Lenovo<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Lenovo MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Meizu MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Meizu MobPhone" name="searchmakecars1">Meizu<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Meizu MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Motorola MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Motorola MobPhone" name="searchmakecars1">Motorola<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Motorola MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Nokia MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Nokia MobPhone" name="searchmakecars1">Nokia<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Nokia MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%OnePlus MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="OnePlus MobPhone" name="searchmakecars1">OnePlus<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%OnePlus MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Oppo MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Oppo MobPhone" name="searchmakecars1">Oppo<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Oppo MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Palm MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Palm MobPhone" name="searchmakecars1">Palm<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Palm MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Realme MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Realme MobPhone" name="searchmakecars1">Realme<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Realme MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Samsung MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Samsung MobPhone" name="searchmakecars1">Samsung<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Samsung MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Sanyo MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Sanyo MobPhone" name="searchmakecars1">Sanyo<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Sanyo MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Sidekick MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Sidekick MobPhone" name="searchmakecars1">Sidekick<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Sidekick MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Sony Ericsson MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Sony Ericsson MobPhone" name="searchmakecars1">Sony Ericsson<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Sony Ericsson MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Vertu MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Vertu MobPhone" name="searchmakecars1">Vertu<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Vertu MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Vivo MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Vivo MobPhone" name="searchmakecars1">Vivo<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Vivo MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Xiaomi MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Xiaomi MobPhone" name="searchmakecars1">Xiaomi<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Xiaomi MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Yota MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Yota MobPhone" name="searchmakecars1">Yota<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Yota MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%iMate MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="iMate MobPhone" name="searchmakecars1">iMate<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%iMate MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>

                                                                            <?php }
                                                                            ?>
                                                                            <?php $var = countItemsclassifieds('typeclassifieds', 'classifieds', '%Other MobPhone%');    
                                                                                if($var != 0){
                                                                                    ?> <div class="col-lg-4">
                                                                                            <form action="?do=searchmakecars1" method="POST">
                                                                                                <a href="" class="ashwhide"><button class="footer-widgets-links-url" type="submit"><input type="hidden" value="Other MobPhone" name="searchmakecars1">Other<span style="color: black;">(<?php echo countItemsclassifieds('typeclassifieds', 'classifieds', '%Other MobPhone%'); ?>)</span> </button></a>
                                                                                            </form>
                                                                                        </div>
                                            ...
                                            <div class="container">    
                                                <?php
                                                                if($do == 'one'){
                                                                    ...
                                                                    where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%MobPhone%'");
                                                                    $result1->execute();
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%MobPhone%'", '', "Id {$sort}", "LIMIT {$start},{$limit} ");
                                                                            ...
                                                                            echo '<div class="row">';
                                                                                ...
                                                                                echo '<div class="col-lg-8">';
                                                                                    ...
                                                                                    echo '<div class="row">';
                                                                                        ...
                                                                                        echo '<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">Color :' . '<strong>' . $item['colorclassifieds']. '</strong>' . '</div>';
                                                                                        echo '<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">Memory :' . '<strong>' . $item['memoryclassifieds']. '</strong>' . '</div>';   
                                                                                        if(empty($item['modelclassifieds'])){
                                                                                            
                                                                                        }   
                                                                                        else{
                                                                                            echo '<div class="col-lg-6">Model :' . '<strong>' . $item['modelclassifieds']. '</strong>' . '</div>';
                                                                                        } 
                                                                ...
                                                                elseif($do == 'orderprice1'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%MobPhone%'", '', "price DESC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'orderprice2'){
                                                                    ...
                                                                    $allItems = getAllFrom('*', 'classifieds', "where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%MobPhone%'", '', "price ASC", "LIMIT 20");
                                                                    foreach($allItems as $item)
                                                                {                                           
                                                                    echo '<a href="infoclasselec.php?pageid=' . $item["Id"] .'" style="text-decoration: none; color:#2B2D2E;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myList">';
                                                                        echo '<div class="borderstyl" style="padding:15px;">';
                                                                ...
                                                                elseif($do == 'resultsearch'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $warrantyclassifieds = $_POST['warrantyclassifieds'];
                                                                                ...
                                                                                $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND ((price BETWEEN '$pricegte' AND '$pricelte') OR locationcars = '$locatecars' OR location like '%$neighboarhood%' OR typeclassifieds like '%$typeclassifieds%' OR conditionclassifieds like '%$conditionclassifieds%' OR colorclassifieds like '%$colorclassifieds%' OR memoryclassifieds like '%$memoryclassifieds%' OR warrantyclassifieds like '%$warrantyclassifieds%')");
                                                                                                ...
                                                                                                echo '<div class="row">';
                                                                                                    ...
                                                                                                    echo '<div class="col-lg-8">';
                                                                                                        ...
                                                                                                        echo '<div class="row">';
                                                                                                            ...
                                                                                                            if(!empty($row['colorclassifieds'])){
                                                                                                            echo '<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">Color :' . '<strong>' . $row['colorclassifieds']. '</strong>' . '</div>'; 
                                                                                                            }   
                                                                                                            else{

                                                                                                            }
                                                                                                            if(empty($row['modelclassifieds'])){
                                                                                                                
                                                                                                            }   
                                                                                                            else{
                                                                                                                echo '<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">Model :' . '<strong>' . $row['modelclassifieds']. '</strong>' . '</div>';
                                                                                                            } 
                                                                                                            if(empty($row['memoryclassifieds'])){
                                                                                                                
                                                                                                            }   
                                                                                                            else{
                                                                                                                echo '<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">Memory :' . '<strong>' . $row['memoryclassifieds']. '</strong>' . '</div>';
                                                                                                            }   
                                                                                                        echo '</div>';
                                                                                                    echo '</div>';
                                                                                                echo '</div>';
                                                                ...
                                                                elseif($do == 'searchlocationcars1'){
                                                                    if($_SERVER['REQUEST_METHOD'] == 'POST')
                                                                    {
                                                                        ...
                                                                        $stmt = $con->prepare("SELECT * FROM classifieds where Approve = 1 AND date > DATE_ADD(NOW(), INTERVAL -1 MONTH) AND typeclassifieds like '%MobPhone%' AND locationcars like '%$locatecars%' order by Id DESC"); 
                                                                        $stmt->execute();
                                                                        $rows = $stmt->fetchAll(); 
                                                                        if(!empty($rows)){
                                                                            foreach($rows as $row)
                                                ...
                                                ?>
                                                                    ...
                                                                    <form id="search-widget-form" action="?do=searchlocationcars3" method="POST">
                                                                                        ...
                                                                                        Mobile Phones in Abu Dhabi</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars4" method="POST">
                                                                                        ...
                                                                                        Mobile Phones in Ras al Khaimah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars5" method="POST">
                                                                                        ...
                                                                                        Mobile Phones in Sharjah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars6" method="POST">
                                                                                        ...
                                                                                        Mobile Phones in Fujairah</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars7" method="POST">
                                                                                        ...
                                                                                        Mobile Phones in Umm al Quwain</button>
                                                                    </form>
                                                                    <form id="search-widget-form" action="?do=searchlocationcars8" method="POST">
                                                                                        ...
                                                                                        Mobile Phones in Al Ain</button>
                                                                    </form>
                                            </div>  
                                        </div>  
                            </div>
